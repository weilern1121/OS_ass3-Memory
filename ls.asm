 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 64 0b 00 00 	movzbl 0xb64(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb 5a 0b 00 00       	mov    $0xb5a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 28 0f 00 00       	mov    0xf28,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 28 0f 00 00       	mov    %eax,0xf28
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 28 0f 00 00       	mov    %eax,0xf28
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 93c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 941:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 944:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 94b:	50                   	push   %eax
 94c:	e8 b9 fc ff ff       	call   60a <sbrk>
  if(p == (char*)-1)
 951:	83 c4 10             	add    $0x10,%esp
 954:	83 f8 ff             	cmp    $0xffffffff,%eax
 957:	74 1f                	je     978 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 962:	50                   	push   %eax
 963:	e8 38 ff ff ff       	call   8a0 <free>
  return freep;
 968:	a1 28 0f 00 00       	mov    0xf28,%eax
 96d:	83 c4 10             	add    $0x10,%esp
}
 970:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 973:	c9                   	leave  
 974:	c3                   	ret    
 975:	8d 76 00             	lea    0x0(%esi),%esi
    return 0;
 978:	31 c0                	xor    %eax,%eax
 97a:	eb f4                	jmp    970 <morecore+0x40>
...
malloc(uint nbytes)
{
 ...
 98a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 98d:	a1 28 0f 00 00       	mov    0xf28,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 992:	c1 eb 03             	shr    $0x3,%ebx
 995:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
 998:	85 c0                	test   %eax,%eax
 99a:	74 54                	je     9f0 <malloc+0x70>
 ...
 9a7:	73 27                	jae    9d0 <malloc+0x50>
        ...
        if(p == freep)
 9a9:	39 15 28 0f 00 00    	cmp    %edx,0xf28
 9af:	89 d0                	mov    %edx,%eax
 9b1:	75 ed                	jne    9a0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 9b3:	89 d8                	mov    %ebx,%eax
 9b5:	e8 76 ff ff ff       	call   930 <morecore>
 9ba:	85 c0                	test   %eax,%eax
 9bc:	75 e2                	jne    9a0 <malloc+0x20>
                return 0;
    }
}
 ...
 9c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits)
 9d0:	39 cb                	cmp    %ecx,%ebx
 9d2:	74 44                	je     a18 <malloc+0x98>
                p->s.size -= nunits;
 9d4:	29 d9                	sub    %ebx,%ecx
 9d6:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 9d9:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 9dc:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 9df:	a3 28 0f 00 00       	mov    %eax,0xf28
}
 9e4:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
 9e7:	8d 42 08             	lea    0x8(%edx),%eax
}
 9ea:	5b                   	pop    %ebx
 9eb:	5d                   	pop    %ebp
 9ec:	c3                   	ret    
 9ed:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 28 0f 00 00 2c 	movl   $0xf2c,0xf28
 9f7:	0f 00 00 
 9fa:	c7 05 2c 0f 00 00 2c 	movl   $0xf2c,0xf2c
 a01:	0f 00 00 
        base.s.size = 0;
 a04:	ba 2c 0f 00 00       	mov    $0xf2c,%edx
 a09:	c7 05 30 0f 00 00 00 	movl   $0x0,0xf30
 a10:	00 00 00 
 a13:	eb 94                	jmp    9a9 <malloc+0x29>
 a15:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
 a18:	8b 0a                	mov    (%edx),%ecx
 a1a:	89 08                	mov    %ecx,(%eax)
 a1c:	eb c1                	jmp    9df <malloc+0x5f>
...
pmalloc()
{
 ...
 a23:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 a26:	8b 0d 28 0f 00 00    	mov    0xf28,%ecx
 a2c:	85 c9                	test   %ecx,%ecx
 a2e:	74 58                	je     a88 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a30:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
 a32:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
 a39:	75 18                	jne    a53 <pmalloc+0x33>
 a3b:	eb 2c                	jmp    a69 <pmalloc+0x49>
 a3d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a40:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 a42:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 a49:	74 22                	je     a6d <pmalloc+0x4d>
 a4b:	8b 0d 28 0f 00 00    	mov    0xf28,%ecx
 ...
 a55:	75 e9                	jne    a40 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
 a57:	b8 01 02 00 00       	mov    $0x201,%eax
 a5c:	e8 cf fe ff ff       	call   930 <morecore>
 a61:	85 c0                	test   %eax,%eax
 a63:	75 db                	jne    a40 <pmalloc+0x20>
                return 0;
 ...
 a6b:	89 c8                	mov    %ecx,%eax
            prevp->s.ptr = p->s.ptr;
 a6d:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 a6f:	a3 28 0f 00 00       	mov    %eax,0xf28
            prevp->s.ptr = p->s.ptr;
 a74:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
 a76:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 a7d:	8d 42 08             	lea    0x8(%edx),%eax
}
 a80:	c9                   	leave  
 a81:	c3                   	ret    
 a82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 a88:	b9 2c 0f 00 00       	mov    $0xf2c,%ecx
        base.s.ptr = freep = prevp = &base;
 a8d:	c7 05 28 0f 00 00 2c 	movl   $0xf2c,0xf28
 a94:	0f 00 00 
 a97:	c7 05 2c 0f 00 00 2c 	movl   $0xf2c,0xf2c
 a9e:	0f 00 00 
        base.s.size = 0;
 aa1:	c7 05 30 0f 00 00 00 	movl   $0x0,0xf30
 aa8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aab:	89 c8                	mov    %ecx,%eax
 aad:	eb a4                	jmp    a53 <pmalloc+0x33>
 aaf:	90                   	nop

00000ab0 <protect_page>:
...
int protect_page(void* ap)
{
 ...
 ab8:	74 1e                	je     ad8 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 aba:	a9 ff 0f 00 00       	test   $0xfff,%eax
 abf:	75 17                	jne    ad8 <protect_page+0x28>
            return -1;
 ...
 ac5:	74 11                	je     ad8 <protect_page+0x28>
            return -1;

        p->protected = 1;
 ac7:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
 acd:	b8 01 00 00 00       	mov    $0x1,%eax
    }
    else
        return -1;
}
...
int pfree(void* ap) {
 ...
 ae8:	74 1e                	je     b08 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 aea:	a9 ff 0f 00 00       	test   $0xfff,%eax
 aef:	75 17                	jne    b08 <pfree+0x28>
            return -1;

        p = ap;
        if (p->protected) {
 af1:	8b 10                	mov    (%eax),%edx
 af3:	85 d2                	test   %edx,%edx
 af5:	74 11                	je     b08 <pfree+0x28>
            free(ap);
 af7:	50                   	push   %eax
 af8:	e8 a3 fd ff ff       	call   8a0 <free>
            return 1;
 afd:	58                   	pop    %eax
