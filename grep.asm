 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 60 12 00 00    	lea    0x1260(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 60 12 00 00       	mov    $0x1260,%ebx
    buf[m] = '\0';
 26c:	c6 86 60 12 00 00 00 	movb   $0x0,0x1260(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 60 12 00 00    	cmp    $0x1260,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 60 12 00 00       	sub    $0x1260,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 60 12 00 00       	push   $0x1260
 ...
 669:	85 d2                	test   %edx,%edx
{
 ...
 697:	f7 f1                	div    %ecx
 699:	0f b6 92 88 0d 00 00 	movzbl 0xd88(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 8b4:	e9 8f fe ff ff       	jmp    748 <printf+0x48>
          s = "(null)";
 8b9:	bb 7e 0d 00 00       	mov    $0xd7e,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 8d1:	a1 4c 12 00 00       	mov    0x124c,%eax
free(void *ap) {
 ...
 90d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 90f:	a3 4c 12 00 00       	mov    %eax,0x124c
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 914:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 94a:	a3 4c 12 00 00       	mov    %eax,0x124c
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 96c:	8b 15 4c 12 00 00    	mov    0x124c,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9af:	73 47                	jae    9f8 <malloc+0x98>
        ...
        if (p == freep)
 9b1:	39 05 4c 12 00 00    	cmp    %eax,0x124c
 ...
 9d6:	e8 f5 fe ff ff       	call   8d0 <free>
    return freep;
 9db:	8b 15 4c 12 00 00    	mov    0x124c,%edx
 ...
 a04:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 a07:	89 15 4c 12 00 00    	mov    %edx,0x124c
}
 ...
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a20:	c7 05 4c 12 00 00 50 	movl   $0x1250,0x124c
 a27:	12 00 00 
 a2a:	c7 05 50 12 00 00 50 	movl   $0x1250,0x1250
 a31:	12 00 00 
        base.s.size = 0;
 a34:	b8 50 12 00 00       	mov    $0x1250,%eax
 a39:	c7 05 54 12 00 00 00 	movl   $0x0,0x1254
 a40:	00 00 00 
...
pmalloc(void) {
 ...
 a8c:	a1 34 12 00 00       	mov    0x1234,%eax
    nh->PMnext = 0;
 ...
 aa5:	89 15 34 12 00 00    	mov    %edx,0x1234
 aab:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 aad:	8b 15 40 12 00 00    	mov    0x1240,%edx
 ...
 ab5:	74 39                	je     af0 <pmalloc+0x90>
        ...
        tail->PMnext = nh;
 ab7:	a1 44 12 00 00       	mov    0x1244,%eax
        tail = tail->PMnext;
 abc:	89 1d 44 12 00 00    	mov    %ebx,0x1244
        tail->PMnext = nh;
 ...
 ada:	e8 6b fb ff ff       	call   64a <updatePTE>
    PMcounter++;
 adf:	83 05 40 12 00 00 01 	addl   $0x1,0x1240
    if (DEBUGMODE == 3)
 ...
 aef:	90                   	nop
        PMinit = nh; //set PMinit link
 af0:	89 1d 48 12 00 00    	mov    %ebx,0x1248
        tail = nh;
 af6:	89 1d 44 12 00 00    	mov    %ebx,0x1244
    char *tmpAdr = sbrk(4096); //point to the first free place
...
protect_page(void *ap) {
 ...
 b40:	a1 48 12 00 00       	mov    0x1248,%eax
...
checkIfPM(void *p) {
 ...
 c10:	8b 15 40 12 00 00    	mov    0x1240,%edx
    struct PMHeader *tmp = PMinit;
 c16:	a1 48 12 00 00       	mov    0x1248,%eax
    for (int i = 0; i < PMcounter; i++) {
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 c40:	a1 40 12 00 00       	mov    0x1240,%eax
pfree(void *ap) {
 c45:	55                   	push   %ebp
...
pfree(void *ap) {
 ...
 c55:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 c5b:	8b 1d 48 12 00 00    	mov    0x1248,%ebx
        if ((int) ap % 4096 != 0) {
 ...
 c91:	e8 b4 f9 ff ff       	call   64a <updatePTE>
            PMcounter--;
 c96:	a1 40 12 00 00       	mov    0x1240,%eax
 ...
 ca1:	85 c0                	test   %eax,%eax
            PMcounter--;
 ca3:	a3 40 12 00 00       	mov    %eax,0x1240
            if (PMcounter == 0) {//if true ->reset PMlist
 ...
 ce9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 cf0:	c7 05 48 12 00 00 00 	movl   $0x0,0x1248
 cf7:	00 00 00 
                tail = 0;
 cfa:	c7 05 44 12 00 00 00 	movl   $0x0,0x1244
 d01:	00 00 00 
}
 ...
 d10:	a1 48 12 00 00       	mov    0x1248,%eax
 d15:	8b 40 08             	mov    0x8(%eax),%eax
 d18:	a3 48 12 00 00       	mov    %eax,0x1248
}
