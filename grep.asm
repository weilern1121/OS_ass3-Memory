 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 a0 0f 00 00    	lea    0xfa0(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb a0 0f 00 00       	mov    $0xfa0,%ebx
    buf[m] = '\0';
 26c:	c6 86 a0 0f 00 00 00 	movb   $0x0,0xfa0(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb a0 0f 00 00    	cmp    $0xfa0,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d a0 0f 00 00       	sub    $0xfa0,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 a0 0f 00 00       	push   $0xfa0
 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 50 0b 00 00 	movzbl 0xb50(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb 46 0b 00 00       	mov    $0xb46,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 80 0f 00 00       	mov    0xf80,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 80 0f 00 00       	mov    %eax,0xf80
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 80 0f 00 00       	mov    %eax,0xf80
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 963:	e8 38 ff ff ff       	call   8a0 <free>
  return freep;
 968:	a1 80 0f 00 00       	mov    0xf80,%eax
...
malloc(uint nbytes)
{
 ...
 98a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 98d:	a1 80 0f 00 00       	mov    0xf80,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9a7:	73 27                	jae    9d0 <malloc+0x50>
        ...
        if(p == freep)
 9a9:	39 15 80 0f 00 00    	cmp    %edx,0xf80
 ...
 9dc:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 9df:	a3 80 0f 00 00       	mov    %eax,0xf80
}
 ...
 9ed:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 80 0f 00 00 84 	movl   $0xf84,0xf80
 9f7:	0f 00 00 
 9fa:	c7 05 84 0f 00 00 84 	movl   $0xf84,0xf84
 a01:	0f 00 00 
        base.s.size = 0;
 a04:	ba 84 0f 00 00       	mov    $0xf84,%edx
 a09:	c7 05 88 0f 00 00 00 	movl   $0x0,0xf88
 a10:	00 00 00 
...
pmalloc()
{
 ...
 a23:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 a26:	8b 0d 80 0f 00 00    	mov    0xf80,%ecx
 ...
 a4b:	8b 0d 80 0f 00 00    	mov    0xf80,%ecx
 ...
 a6d:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 a6f:	a3 80 0f 00 00       	mov    %eax,0xf80
            prevp->s.ptr = p->s.ptr;
 ...
 a82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 a88:	b9 84 0f 00 00       	mov    $0xf84,%ecx
        base.s.ptr = freep = prevp = &base;
 a8d:	c7 05 80 0f 00 00 84 	movl   $0xf84,0xf80
 a94:	0f 00 00 
 a97:	c7 05 84 0f 00 00 84 	movl   $0xf84,0xf84
 a9e:	0f 00 00 
        base.s.size = 0;
 aa1:	c7 05 88 0f 00 00 00 	movl   $0x0,0xf88
 aa8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
