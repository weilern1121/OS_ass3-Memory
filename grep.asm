...
grep(char *pattern, int fd)
{
 ...
 245:	50                   	push   %eax
 246:	8d 81 a0 0f 00 00    	lea    0xfa0(%ecx),%eax
 24c:	50                   	push   %eax
 ...
 260:	01 45 e4             	add    %eax,-0x1c(%ebp)
    buf[m] = '\0';
    p = buf;
 263:	bb a0 0f 00 00       	mov    $0xfa0,%ebx
  int n, m;
  char *p, *q;
 ...
 268:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    buf[m] = '\0';
 26b:	c6 82 a0 0f 00 00 00 	movb   $0x0,0xfa0(%edx)
 ...
 2c5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if(p == buf)
 2c8:	81 fb a0 0f 00 00    	cmp    $0xfa0,%ebx
 ...
 2dd:	83 ec 04             	sub    $0x4,%esp
    ...
    if(m > 0){
      m -= p - buf;
 2e0:	2d a0 0f 00 00       	sub    $0xfa0,%eax
 2e5:	29 45 e4             	sub    %eax,-0x1c(%ebp)
 2e8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
      memmove(buf, p, m);
 2eb:	51                   	push   %ecx
 2ec:	53                   	push   %ebx
 2ed:	68 a0 0f 00 00       	push   $0xfa0
...
0000060a <checkOnPM>:
SYSCALL(checkOnPM)
 60a:	b8 18 00 00 00       	mov    $0x18,%eax
 60f:	cd 40                	int    $0x40
 611:	c3                   	ret    

00000612 <turnOffW>:
SYSCALL(turnOffW)
 612:	b8 19 00 00 00       	mov    $0x19,%eax
 617:	cd 40                	int    $0x40
 619:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 65f:	f7 f6                	div    %esi
 661:	0f b6 92 3c 0b 00 00 	movzbl 0xb3c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 7d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 7db:	b8 32 0b 00 00       	mov    $0xb32,%eax
...
free(void *ap)
{
 ...
 861:	a1 80 0f 00 00       	mov    0xf80,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8b9:	a3 80 0f 00 00       	mov    %eax,0xf80
}
 8be:	5b                   	pop    %ebx
 8bf:	5e                   	pop    %esi
 8c0:	5f                   	pop    %edi
 ...
 8da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 8dd:	a3 80 0f 00 00       	mov    %eax,0xf80
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 90a:	50                   	push   %eax
 90b:	e8 da fc ff ff       	call   5ea <sbrk>
  if(p == (char*)-1)
 ...
 922:	e8 39 ff ff ff       	call   860 <free>
  return freep;
 927:	a1 80 0f 00 00       	mov    0xf80,%eax
...
malloc(uint nbytes)
{
 ...
 95a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 95d:	a1 80 0f 00 00       	mov    0xf80,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 977:	76 1f                	jbe    998 <malloc+0x48>
        ...
        if(p == freep)
 979:	39 15 80 0f 00 00    	cmp    %edx,0xf80
 ...
 9a4:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 9a7:	a3 80 0f 00 00       	mov    %eax,0xf80
            return (void*)(p + 1);
 ...
 9bc:	eb e9                	jmp    9a7 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 9be:	c7 05 80 0f 00 00 84 	movl   $0xf84,0xf80
 9c5:	0f 00 00 
 9c8:	c7 05 84 0f 00 00 84 	movl   $0xf84,0xf84
 9cf:	0f 00 00 
        base.s.size = 0;
 9d2:	ba 84 0f 00 00       	mov    $0xf84,%edx
 9d7:	c7 05 88 0f 00 00 00 	movl   $0x0,0xf88
 9de:	00 00 00 
...
pmalloc()
{
 ...
 9f4:	83 ec 04             	sub    $0x4,%esp
    ...
    if((prevp = freep) == 0){
 9f7:	a1 80 0f 00 00       	mov    0xf80,%eax
 9fc:	85 c0                	test   %eax,%eax
 9fe:	74 56                	je     a56 <pmalloc+0x66>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 a09:	74 25                	je     a30 <pmalloc+0x40>
        ...
        if(p == freep)
 a0b:	39 15 80 0f 00 00    	cmp    %edx,0xf80
 ...
 a21:	75 dd                	jne    a00 <pmalloc+0x10>
                return 0;
 a23:	31 db                	xor    %ebx,%ebx
 a25:	eb 28                	jmp    a4f <pmalloc+0x5f>
 ...
 a35:	83 ec 0c             	sub    $0xc,%esp
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
            freep = prevp;
 a38:	a3 80 0f 00 00       	mov    %eax,0xf80
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 a3d:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 a3f:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            turnOnPM( (void *)( p + 1 ) );
 a46:	53                   	push   %ebx
 a47:	e8 b6 fb ff ff       	call   602 <turnOnPM>
            return (void*)(p + 1);
 ...
 a55:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 a56:	c7 05 80 0f 00 00 84 	movl   $0xf84,0xf80
 a5d:	0f 00 00 
 a60:	c7 05 84 0f 00 00 84 	movl   $0xf84,0xf84
 a67:	0f 00 00 
        base.s.size = 0;
 a6a:	ba 84 0f 00 00       	mov    $0xf84,%edx
 a6f:	c7 05 88 0f 00 00 00 	movl   $0x0,0xf88
 a76:	00 00 00 
 a79:	eb 90                	jmp    a0b <pmalloc+0x1b>
 a7b:	90                   	nop
...
protect_page(void* ap)
{
 ...
 a88:	74 16                	je     aa0 <protect_page+0x20>
    {
        if( (uint)ap % 4096 != 0 )
 a8a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 a8f:	75 0f                	jne    aa0 <protect_page+0x20>
        p = ap;
        return turnOffW( p );
    }
    else
 ...
 a91:	5d                   	pop    %ebp
        ...
        p = ap;
        return turnOffW( p );
 a92:	e9 7b fb ff ff       	jmp    612 <turnOffW>
...
pfree(void* ap) {
 ...
 abc:	74 32                	je     af0 <pfree+0x40>
        if ((uint) ap % 4096 != 0)
 abe:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 ac4:	75 2a                	jne    af0 <pfree+0x40>
            return -1;
 ...
 ac9:	53                   	push   %ebx
 aca:	e8 3b fb ff ff       	call   60a <checkOnPM>
 acf:	83 c4 10             	add    $0x10,%esp
 ad2:	85 c0                	test   %eax,%eax
 ad4:	74 1a                	je     af0 <pfree+0x40>
            free(ap);
 ad6:	83 ec 0c             	sub    $0xc,%esp
 ad9:	53                   	push   %ebx
 ada:	e8 81 fd ff ff       	call   860 <free>
            return 1;
