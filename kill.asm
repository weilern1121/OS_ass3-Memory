...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 44 07 00 00 	movzbl 0x744(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 3c 07 00 00       	mov    $0x73c,%eax
...
000005a0 <free>:
 5a0:	55                   	push   %ebp
 5a1:	a1 f4 09 00 00       	mov    0x9f4,%eax
 ...
 5df:	a3 f4 09 00 00       	mov    %eax,0x9f4
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 61a:	a3 f4 09 00 00       	mov    %eax,0x9f4
...
00000630 <malloc>:
 ...
 63c:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
 ...
 6ab:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
 ...
 6d7:	89 15 f4 09 00 00    	mov    %edx,0x9f4
 ...
 6f0:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 6f7:	09 00 00 
 6fa:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 701:	09 00 00 
 704:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 709:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 710:	00 00 00 
