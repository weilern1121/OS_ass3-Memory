 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb 97 09 00 00       	mov    $0x997,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 20 0d 00 00       	mov    %eax,0xd20
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 783:	53                   	push   %ebx
 784:	bb 00 10 00 00       	mov    $0x1000,%ebx
 789:	83 ec 10             	sub    $0x10,%esp
 78c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 791:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 794:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 79b:	50                   	push   %eax
 79c:	e8 b9 fc ff ff       	call   45a <sbrk>
  if(p == (char*)-1)
 7a1:	83 c4 10             	add    $0x10,%esp
 7a4:	83 f8 ff             	cmp    $0xffffffff,%eax
 7a7:	74 1f                	je     7c8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 7a9:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 7ac:	83 ec 0c             	sub    $0xc,%esp
 7af:	83 c0 08             	add    $0x8,%eax
 7b2:	50                   	push   %eax
 7b3:	e8 38 ff ff ff       	call   6f0 <free>
  return freep;
 7b8:	a1 20 0d 00 00       	mov    0xd20,%eax
 ...
 7ca:	eb f4                	jmp    7c0 <morecore+0x40>
...
malloc(uint nbytes)
{
 ...
 7f5:	39 d9                	cmp    %ebx,%ecx
 7f7:	73 27                	jae    820 <malloc+0x50>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
 7f9:	39 15 20 0d 00 00    	cmp    %edx,0xd20
 7ff:	89 d0                	mov    %edx,%eax
 801:	75 ed                	jne    7f0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 803:	89 d8                	mov    %ebx,%eax
 805:	e8 76 ff ff ff       	call   780 <morecore>
 80a:	85 c0                	test   %eax,%eax
 80c:	75 e2                	jne    7f0 <malloc+0x20>
                return 0;
    }
}
 80e:	83 c4 04             	add    $0x4,%esp
                return 0;
 ...
 822:	74 44                	je     868 <malloc+0x98>
                p->s.size -= nunits;
 824:	29 d9                	sub    %ebx,%ecx
 826:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 829:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 82c:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 82f:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 834:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
 ...
 83d:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 840:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 847:	0d 00 00 
 84a:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 851:	0d 00 00 
        base.s.size = 0;
 854:	ba 24 0d 00 00       	mov    $0xd24,%edx
 859:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 860:	00 00 00 
 863:	eb 94                	jmp    7f9 <malloc+0x29>
 865:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
 868:	8b 0a                	mov    (%edx),%ecx
 86a:	89 08                	mov    %ecx,(%eax)
 86c:	eb c1                	jmp    82f <malloc+0x5f>
...
pmalloc()
{
 ...
 873:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 876:	8b 0d 20 0d 00 00    	mov    0xd20,%ecx
 87c:	85 c9                	test   %ecx,%ecx
 87e:	74 58                	je     8d8 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 880:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
 882:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
 889:	75 18                	jne    8a3 <pmalloc+0x33>
 88b:	eb 2c                	jmp    8b9 <pmalloc+0x49>
 88d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 890:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 892:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 899:	74 22                	je     8bd <pmalloc+0x4d>
 89b:	8b 0d 20 0d 00 00    	mov    0xd20,%ecx
 8a1:	89 d0                	mov    %edx,%eax
        ...
        if(p == freep)
 8a3:	39 c1                	cmp    %eax,%ecx
 8a5:	75 e9                	jne    890 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
 8a7:	b8 01 02 00 00       	mov    $0x201,%eax
 8ac:	e8 cf fe ff ff       	call   780 <morecore>
 8b1:	85 c0                	test   %eax,%eax
 8b3:	75 db                	jne    890 <pmalloc+0x20>
                return 0;
 ...
 8bb:	89 c8                	mov    %ecx,%eax
            prevp->s.ptr = p->s.ptr;
 8bd:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 8bf:	a3 20 0d 00 00       	mov    %eax,0xd20
            prevp->s.ptr = p->s.ptr;
 8c4:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
 8c6:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 8cd:	8d 42 08             	lea    0x8(%edx),%eax
}
 8d0:	c9                   	leave  
 8d1:	c3                   	ret    
 8d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 8d8:	b9 24 0d 00 00       	mov    $0xd24,%ecx
        base.s.ptr = freep = prevp = &base;
 8dd:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 8e4:	0d 00 00 
 8e7:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 8ee:	0d 00 00 
        base.s.size = 0;
 8f1:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 8f8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8fb:	89 c8                	mov    %ecx,%eax
 8fd:	eb a4                	jmp    8a3 <pmalloc+0x33>
 8ff:	90                   	nop

00000900 <protect_page>:
...
int protect_page(void* ap)
{
 ...
 908:	74 1e                	je     928 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 90a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 90f:	75 17                	jne    928 <protect_page+0x28>
            return -1;
 ...
 915:	74 11                	je     928 <protect_page+0x28>
            return -1;

        p->protected = 1;
 917:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
 91d:	b8 01 00 00 00       	mov    $0x1,%eax
    }
    else
        return -1;
}
...
int pfree(void* ap) {
 ...
 938:	74 1e                	je     958 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 93a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 93f:	75 17                	jne    958 <pfree+0x28>
            return -1;
 ...
 945:	74 11                	je     958 <pfree+0x28>
            free(ap);
 947:	50                   	push   %eax
 948:	e8 a3 fd ff ff       	call   6f0 <free>
            return 1;
 94d:	58                   	pop    %eax
 94e:	b8 01 00 00 00       	mov    $0x1,%eax
        }
    }
    return -1;
}
