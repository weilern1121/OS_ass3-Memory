 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 68 0b 00 00 	movzbl 0xb68(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 60 0b 00 00       	mov    $0xb60,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 6b1:	a1 6c 0f 00 00       	mov    0xf6c,%eax
free(void *ap) {
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
    freep = p;
 6ef:	a3 6c 0f 00 00       	mov    %eax,0xf6c
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 6f4:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 72a:	a3 6c 0f 00 00       	mov    %eax,0xf6c
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 74c:	8b 15 6c 0f 00 00    	mov    0xf6c,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
        ...
        if (p == freep)
 791:	39 05 6c 0f 00 00    	cmp    %eax,0xf6c
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
    return freep;
 7bb:	8b 15 6c 0f 00 00    	mov    0xf6c,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 7e7:	89 15 6c 0f 00 00    	mov    %edx,0xf6c
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 800:	c7 05 6c 0f 00 00 70 	movl   $0xf70,0xf6c
 807:	0f 00 00 
 80a:	c7 05 70 0f 00 00 70 	movl   $0xf70,0xf70
 811:	0f 00 00 
        base.s.size = 0;
 814:	b8 70 0f 00 00       	mov    $0xf70,%eax
 819:	c7 05 74 0f 00 00 00 	movl   $0x0,0xf74
 820:	00 00 00 
...
pmalloc(void) {
 ...
 848:	6a 10                	push   $0x10
 84a:	e8 f1 fe ff ff       	call   740 <malloc>
    char *tmpAdr = sbrk(4096); //point to the first free place
 84f:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    struct PMHeader *nh = malloc(sizeof(struct PMHeader));
 856:	89 c3                	mov    %eax,%ebx
    char *tmpAdr = sbrk(4096); //point to the first free place
 858:	e8 8d fb ff ff       	call   3ea <sbrk>
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 85d:	83 c4 10             	add    $0x10,%esp
 860:	a9 ff 0f 00 00       	test   $0xfff,%eax
    char *tmpAdr = sbrk(4096); //point to the first free place
 865:	89 c6                	mov    %eax,%esi
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 867:	74 03                	je     86c <pmalloc+0x2c>
        *tmpAdr = (char) PGROUNDUP((int) tmpAdr);
 869:	c6 00 00             	movb   $0x0,(%eax)

    //init PMHeader
    nh->PMheaderID = nextID++;
 86c:	a1 58 0f 00 00       	mov    0xf58,%eax
    nh->PMnext = 0;
 871:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nh->PMadress = tmpAdr;
 878:	89 73 04             	mov    %esi,0x4(%ebx)
    nh->PMprotectedPage = 0;
 87b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    nh->PMheaderID = nextID++;
 882:	8d 50 01             	lea    0x1(%eax),%edx
 885:	89 15 58 0f 00 00    	mov    %edx,0xf58
 88b:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 88d:	8b 15 60 0f 00 00    	mov    0xf60,%edx
 893:	85 d2                	test   %edx,%edx
 895:	74 39                	je     8d0 <pmalloc+0x90>
        PMinit = nh; //set PMinit link
        tail = nh;
    } else { //else- add new page to the end of PMlist
        tail->PMnext = nh;
 897:	a1 64 0f 00 00       	mov    0xf64,%eax
        tail = tail->PMnext;
 89c:	89 1d 64 0f 00 00    	mov    %ebx,0xf64
        tail->PMnext = nh;
 8a2:	89 58 08             	mov    %ebx,0x8(%eax)
 8a5:	8b 43 04             	mov    0x4(%ebx),%eax
    }
    //turn PMflag on and W flag off
    turnOnW(nh->PMadress);//TODO
 8a8:	83 ec 0c             	sub    $0xc,%esp
 8ab:	50                   	push   %eax
 8ac:	e8 69 fb ff ff       	call   41a <turnOnW>
    turnOnPM(nh->PMadress);
 8b1:	58                   	pop    %eax
 8b2:	ff 73 04             	pushl  0x4(%ebx)
 8b5:	e8 48 fb ff ff       	call   402 <turnOnPM>
    //fresh PTE
    updatePTE();
 8ba:	e8 6b fb ff ff       	call   42a <updatePTE>
    PMcounter++;
 8bf:	83 05 60 0f 00 00 01 	addl   $0x1,0xf60
    if (DEBUGMODE == 3)
        printf(1, ">PMALLOC-DONE!\n");
    return tmpAdr;
}
 8c6:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ...
 8cf:	90                   	nop
        PMinit = nh; //set PMinit link
 8d0:	89 1d 68 0f 00 00    	mov    %ebx,0xf68
        tail = nh;
 8d6:	89 1d 64 0f 00 00    	mov    %ebx,0xf64
    char *tmpAdr = sbrk(4096); //point to the first free place
 8dc:	89 f0                	mov    %esi,%eax
 8de:	eb c8                	jmp    8a8 <pmalloc+0x68>

000008e0 <protect_page>:
...
protect_page(void *ap) {
 ...
 8e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    if (ap) {
 8ea:	85 db                	test   %ebx,%ebx
 8ec:	74 7a                	je     968 <protect_page+0x88>
        if ((int) ap % 4096 != 0) {
 8ee:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 8f4:	75 72                	jne    968 <protect_page+0x88>
            if (DEBUGMODE == 3)
 ...
 8f9:	53                   	push   %ebx
 8fa:	e8 0b fb ff ff       	call   40a <checkOnPM>
 8ff:	83 c4 10             	add    $0x10,%esp
 902:	85 c0                	test   %eax,%eax
 904:	74 62                	je     968 <protect_page+0x88>
            turnOffW(ap);
 906:	83 ec 0c             	sub    $0xc,%esp
 909:	53                   	push   %ebx
 90a:	e8 03 fb ff ff       	call   412 <turnOffW>
            updatePTE();
 90f:	e8 16 fb ff ff       	call   42a <updatePTE>
            updateProc(1); // protectedPages++
 914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 91b:	e8 12 fb ff ff       	call   432 <updateProc>
            //turn on flag
            struct PMHeader *PMap = PMinit;
 920:	a1 68 0f 00 00       	mov    0xf68,%eax
            while (PMap->PMnext != 0 && PMap->PMadress != ap)
 925:	83 c4 10             	add    $0x10,%esp
 928:	eb 0c                	jmp    936 <protect_page+0x56>
 92a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 930:	39 cb                	cmp    %ecx,%ebx
 932:	74 10                	je     944 <protect_page+0x64>
 934:	89 d0                	mov    %edx,%eax
 936:	8b 50 08             	mov    0x8(%eax),%edx
 939:	8b 48 04             	mov    0x4(%eax),%ecx
 93c:	85 d2                	test   %edx,%edx
 93e:	75 f0                	jne    930 <protect_page+0x50>
                PMap = PMap->PMnext;
            if (PMap->PMadress != ap) {
 940:	39 cb                	cmp    %ecx,%ebx
 942:	75 11                	jne    955 <protect_page+0x75>
                printf(2, "PROBLEM with ap:%d\n", ap);
                return -1;
            }
            //got here ->MPap points the protected link
            PMap->PMprotectedPage = 1;//turn on FLAG
 944:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
            if (DEBUGMODE == 3)
                printf(1, ">PROTECT_PAGE-DONE!\n");
            return 1;
 94b:	b8 01 00 00 00       	mov    $0x1,%eax
        }
    }
    if (DEBUGMODE == 3)
 ...
 958:	53                   	push   %ebx
 959:	68 79 0b 00 00       	push   $0xb79
 95e:	6a 02                	push   $0x2
 960:	e8 7b fb ff ff       	call   4e0 <printf>
 965:	83 c4 10             	add    $0x10,%esp
 968:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 96d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 970:	c9                   	leave  
 971:	c3                   	ret    
 972:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 979:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000980 <printPMList>:
...
printPMList(void) {
 ...
 985:	8b 1d 68 0f 00 00    	mov    0xf68,%ebx
    printf(1, "\nPMlist:\t");
 98b:	83 ec 08             	sub    $0x8,%esp
 98e:	68 8d 0b 00 00       	push   $0xb8d
 993:	6a 01                	push   $0x1
 995:	e8 46 fb ff ff       	call   4e0 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 99a:	a1 60 0f 00 00       	mov    0xf60,%eax
 99f:	83 c4 10             	add    $0x10,%esp
 9a2:	85 c0                	test   %eax,%eax
 9a4:	7e 2d                	jle    9d3 <printPMList+0x53>
 ...
 9b6:	83 c6 01             	add    $0x1,%esi
        printf(2, "%d\t", tmp2->PMadress);
 9b9:	68 97 0b 00 00       	push   $0xb97
 9be:	6a 02                	push   $0x2
 9c0:	e8 1b fb ff ff       	call   4e0 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 9c5:	83 c4 10             	add    $0x10,%esp
 9c8:	39 35 60 0f 00 00    	cmp    %esi,0xf60
 9ce:	8b 5b 08             	mov    0x8(%ebx),%ebx
 9d1:	7f dd                	jg     9b0 <printPMList+0x30>
    printf(1, "\n\n");
 9d3:	83 ec 08             	sub    $0x8,%esp
 9d6:	68 9b 0b 00 00       	push   $0xb9b
 9db:	6a 01                	push   $0x1
 9dd:	e8 fe fa ff ff       	call   4e0 <printf>
}
 9e2:	83 c4 10             	add    $0x10,%esp
 9e5:	8d 65 f8             	lea    -0x8(%ebp),%esp
 9e8:	5b                   	pop    %ebx
 9e9:	5e                   	pop    %esi
 9ea:	5d                   	pop    %ebp
 9eb:	c3                   	ret    
...
checkIfPM(void *p) {
 ...
 9f0:	8b 15 60 0f 00 00    	mov    0xf60,%edx
    struct PMHeader *tmp = PMinit;
 9f6:	a1 68 0f 00 00       	mov    0xf68,%eax
    for (int i = 0; i < PMcounter; i++) {
 9fb:	85 d2                	test   %edx,%edx
 9fd:	7e 11                	jle    a10 <checkIfPM+0x20>
checkIfPM(void *p) {
 9ff:	55                   	push   %ebp
 a00:	89 e5                	mov    %esp,%ebp
        if (tmp->PMadress == p)
 a02:	8b 55 08             	mov    0x8(%ebp),%edx
 a05:	39 50 04             	cmp    %edx,0x4(%eax)
            return 1;
    }
    return 0;
}
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 a20:	a1 60 0f 00 00       	mov    0xf60,%eax
pfree(void *ap) {
 a25:	55                   	push   %ebp
...
pfree(void *ap) {
 a2c:	8b 75 08             	mov    0x8(%ebp),%esi
    if (ap) {
 a2f:	74 1b                	je     a4c <pfree+0x2c>
 a31:	85 f6                	test   %esi,%esi
 a33:	74 17                	je     a4c <pfree+0x2c>
        struct PMHeader *PMap = PMinit;
        struct PMHeader *tmp = PMinit;
        //check aligned
        if ((int) ap % 4096 != 0) {
 a35:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 a3b:	8b 1d 68 0f 00 00    	mov    0xf68,%ebx
        if ((int) ap % 4096 != 0) {
 a41:	75 09                	jne    a4c <pfree+0x2c>
    for (int i = 0; i < PMcounter; i++) {
 a43:	85 c0                	test   %eax,%eax
 a45:	7e 05                	jle    a4c <pfree+0x2c>
        if (tmp->PMadress == p)
 a47:	3b 73 04             	cmp    0x4(%ebx),%esi
 a4a:	74 14                	je     a60 <pfree+0x40>
            return -1;
        }
    }
    if (DEBUGMODE == 3)
 ...
 a63:	53                   	push   %ebx
 a64:	e8 a9 f9 ff ff       	call   412 <turnOffW>
            turnOffPM(PMap);
 a69:	89 1c 24             	mov    %ebx,(%esp)
 a6c:	e8 b1 f9 ff ff       	call   422 <turnOffPM>
            updatePTE();
 a71:	e8 b4 f9 ff ff       	call   42a <updatePTE>
            PMcounter--;
 a76:	a1 60 0f 00 00       	mov    0xf60,%eax
            if (PMcounter == 0) {//if true ->reset PMlist
 a7b:	83 c4 10             	add    $0x10,%esp
            PMcounter--;
 a7e:	83 e8 01             	sub    $0x1,%eax
            if (PMcounter == 0) {//if true ->reset PMlist
 a81:	85 c0                	test   %eax,%eax
            PMcounter--;
 a83:	a3 60 0f 00 00       	mov    %eax,0xf60
            if (PMcounter == 0) {//if true ->reset PMlist
 a88:	74 46                	je     ad0 <pfree+0xb0>
 a8a:	89 d8                	mov    %ebx,%eax
 a8c:	eb 08                	jmp    a96 <pfree+0x76>
 a8e:	66 90                	xchg   %ax,%ax
                while (PMap->PMnext != 0 && PMap->PMadress != ap)
 a90:	39 ce                	cmp    %ecx,%esi
 a92:	74 10                	je     aa4 <pfree+0x84>
 a94:	89 d0                	mov    %edx,%eax
 a96:	8b 50 08             	mov    0x8(%eax),%edx
 a99:	8b 48 04             	mov    0x4(%eax),%ecx
 a9c:	85 d2                	test   %edx,%edx
 a9e:	75 f0                	jne    a90 <pfree+0x70>
                if (PMap->PMadress != ap) {
 aa0:	39 ce                	cmp    %ecx,%esi
 aa2:	75 65                	jne    b09 <pfree+0xe9>
                if (tmp->PMheaderID == PMap->PMheaderID) {//happens when both point on the first link
 aa4:	8b 08                	mov    (%eax),%ecx
 aa6:	39 0b                	cmp    %ecx,(%ebx)
 aa8:	75 08                	jne    ab2 <pfree+0x92>
 aaa:	eb 44                	jmp    af0 <pfree+0xd0>
 aac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 ab0:	89 c3                	mov    %eax,%ebx
                    while (tmp->PMnext->PMheaderID != PMap->PMheaderID)
 ab2:	8b 43 08             	mov    0x8(%ebx),%eax
 ab5:	3b 08                	cmp    (%eax),%ecx
 ab7:	75 f7                	jne    ab0 <pfree+0x90>
                    tmp->PMnext = PMap->PMnext;
 ab9:	89 53 08             	mov    %edx,0x8(%ebx)
}
 abc:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 ac9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 ad0:	c7 05 68 0f 00 00 00 	movl   $0x0,0xf68
 ad7:	00 00 00 
                tail = 0;
 ada:	c7 05 64 0f 00 00 00 	movl   $0x0,0xf64
 ae1:	00 00 00 
}
 ae4:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 af0:	a1 68 0f 00 00       	mov    0xf68,%eax
 af5:	8b 40 08             	mov    0x8(%eax),%eax
 af8:	a3 68 0f 00 00       	mov    %eax,0xf68
}
 afd:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 b0c:	56                   	push   %esi
 b0d:	68 79 0b 00 00       	push   $0xb79
 b12:	6a 02                	push   $0x2
 b14:	e8 c7 f9 ff ff       	call   4e0 <printf>
                    return -1;
 b19:	83 c4 10             	add    $0x10,%esp
 b1c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 b21:	e9 2b ff ff ff       	jmp    a51 <pfree+0x31>
