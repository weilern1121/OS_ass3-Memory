 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 28 09 00 00       	mov    $0x928,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 a0 0c 00 00       	mov    0xca0,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 a0 0c 00 00       	mov    %eax,0xca0
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 713:	53                   	push   %ebx
 714:	bb 00 10 00 00       	mov    $0x1000,%ebx
 719:	83 ec 10             	sub    $0x10,%esp
 71c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 ...
 724:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 72b:	50                   	push   %eax
 72c:	e8 b9 fc ff ff       	call   3ea <sbrk>
  if(p == (char*)-1)
 731:	83 c4 10             	add    $0x10,%esp
 734:	83 f8 ff             	cmp    $0xffffffff,%eax
 737:	74 1f                	je     758 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 739:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 73c:	83 ec 0c             	sub    $0xc,%esp
 73f:	83 c0 08             	add    $0x8,%eax
 742:	50                   	push   %eax
 743:	e8 38 ff ff ff       	call   680 <free>
  return freep;
 748:	a1 a0 0c 00 00       	mov    0xca0,%eax
 74d:	83 c4 10             	add    $0x10,%esp
}
 750:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 753:	c9                   	leave  
 754:	c3                   	ret    
 755:	8d 76 00             	lea    0x0(%esi),%esi
    return 0;
 758:	31 c0                	xor    %eax,%eax
 75a:	eb f4                	jmp    750 <morecore+0x40>
...
malloc(uint nbytes)
{
 ...
 76a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 76d:	a1 a0 0c 00 00       	mov    0xca0,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 772:	c1 eb 03             	shr    $0x3,%ebx
 775:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
 778:	85 c0                	test   %eax,%eax
 77a:	74 54                	je     7d0 <malloc+0x70>
 ...
 785:	39 d9                	cmp    %ebx,%ecx
 787:	73 27                	jae    7b0 <malloc+0x50>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
 789:	39 15 a0 0c 00 00    	cmp    %edx,0xca0
 78f:	89 d0                	mov    %edx,%eax
 791:	75 ed                	jne    780 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 793:	89 d8                	mov    %ebx,%eax
 795:	e8 76 ff ff ff       	call   710 <morecore>
 79a:	85 c0                	test   %eax,%eax
 79c:	75 e2                	jne    780 <malloc+0x20>
                return 0;
    }
}
 79e:	83 c4 04             	add    $0x4,%esp
                return 0;
 ...
 7b2:	74 44                	je     7f8 <malloc+0x98>
                p->s.size -= nunits;
 7b4:	29 d9                	sub    %ebx,%ecx
 7b6:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 7b9:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 7bc:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 7bf:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 7c4:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
 7c7:	8d 42 08             	lea    0x8(%edx),%eax
}
 7ca:	5b                   	pop    %ebx
 7cb:	5d                   	pop    %ebp
 7cc:	c3                   	ret    
 7cd:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 7d7:	0c 00 00 
 7da:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 7e1:	0c 00 00 
        base.s.size = 0;
 7e4:	ba a4 0c 00 00       	mov    $0xca4,%edx
 7e9:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 7f0:	00 00 00 
 7f3:	eb 94                	jmp    789 <malloc+0x29>
 7f5:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
 7f8:	8b 0a                	mov    (%edx),%ecx
 7fa:	89 08                	mov    %ecx,(%eax)
 7fc:	eb c1                	jmp    7bf <malloc+0x5f>
...
pmalloc()
{
 ...
 803:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 806:	8b 0d a0 0c 00 00    	mov    0xca0,%ecx
 80c:	85 c9                	test   %ecx,%ecx
 80e:	74 58                	je     868 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 810:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
 812:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
 819:	75 18                	jne    833 <pmalloc+0x33>
 81b:	eb 2c                	jmp    849 <pmalloc+0x49>
 81d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 820:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 822:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 829:	74 22                	je     84d <pmalloc+0x4d>
 82b:	8b 0d a0 0c 00 00    	mov    0xca0,%ecx
 831:	89 d0                	mov    %edx,%eax
        ...
        if(p == freep)
 833:	39 c1                	cmp    %eax,%ecx
 835:	75 e9                	jne    820 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
 837:	b8 01 02 00 00       	mov    $0x201,%eax
 83c:	e8 cf fe ff ff       	call   710 <morecore>
 841:	85 c0                	test   %eax,%eax
 843:	75 db                	jne    820 <pmalloc+0x20>
                return 0;
 ...
 84b:	89 c8                	mov    %ecx,%eax
            prevp->s.ptr = p->s.ptr;
 84d:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 84f:	a3 a0 0c 00 00       	mov    %eax,0xca0
            prevp->s.ptr = p->s.ptr;
 854:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
 856:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 85d:	8d 42 08             	lea    0x8(%edx),%eax
}
 860:	c9                   	leave  
 861:	c3                   	ret    
 862:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 868:	b9 a4 0c 00 00       	mov    $0xca4,%ecx
        base.s.ptr = freep = prevp = &base;
 86d:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 874:	0c 00 00 
 877:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 87e:	0c 00 00 
        base.s.size = 0;
 881:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 888:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 88b:	89 c8                	mov    %ecx,%eax
 88d:	eb a4                	jmp    833 <pmalloc+0x33>
 88f:	90                   	nop

00000890 <protect_page>:
...
int protect_page(void* ap)
{
 ...
 898:	74 1e                	je     8b8 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 89a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 89f:	75 17                	jne    8b8 <protect_page+0x28>
            return -1;
 ...
 8a5:	74 11                	je     8b8 <protect_page+0x28>
            return -1;

        p->protected = 1;
 8a7:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
 8ad:	b8 01 00 00 00       	mov    $0x1,%eax
    }
    else
        return -1;
}
...
int pfree(void* ap) {
 ...
 8c8:	74 1e                	je     8e8 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 8ca:	a9 ff 0f 00 00       	test   $0xfff,%eax
 8cf:	75 17                	jne    8e8 <pfree+0x28>
            return -1;
 ...
 8d5:	74 11                	je     8e8 <pfree+0x28>
            free(ap);
 8d7:	50                   	push   %eax
 8d8:	e8 a3 fd ff ff       	call   680 <free>
            return 1;
 8dd:	58                   	pop    %eax
 ...
 8e5:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
 8e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 8ed:	c9                   	leave  
 8ee:	c3                   	ret    
