...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 53 08 00 00       	mov    $0x853,%eax
...
morecore(uint nu)
{
 ...
 65a:	50                   	push   %eax
 65b:	e8 ea fc ff ff       	call   34a <sbrk>
  if(p == (char*)-1)
...
pmalloc()
{
 ...
 743:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 746:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 74b:	85 c0                	test   %eax,%eax
 74d:	74 46                	je     795 <pmalloc+0x55>
 74f:	90                   	nop
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
 ...
 780:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 782:	a3 9c 0b 00 00       	mov    %eax,0xb9c
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 787:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 789:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 790:	8d 42 08             	lea    0x8(%edx),%eax
 ...
 794:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 795:	c7 05 9c 0b 00 00 a0 	movl   $0xba0,0xb9c
 79c:	0b 00 00 
 79f:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 7a6:	0b 00 00 
        base.s.size = 0;
 7a9:	ba a0 0b 00 00       	mov    $0xba0,%edx
 7ae:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 7b5:	00 00 00 
 7b8:	eb a1                	jmp    75b <pmalloc+0x1b>
 7ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000007c0 <protect_page>:
    }
}
...
int protect_page(void* ap)
{
 ...
 7c8:	74 1e                	je     7e8 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 7ca:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7cf:	75 17                	jne    7e8 <protect_page+0x28>
            return -1;
 ...
 7d5:	74 11                	je     7e8 <protect_page+0x28>
            return -1;

        p->protected = 1;
 7d7:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
...
int pfree(void* ap) {
 ...
 7f8:	74 1e                	je     818 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 7fa:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7ff:	75 17                	jne    818 <pfree+0x28>
            return -1;
 ...
 805:	74 11                	je     818 <pfree+0x28>
            free(ap);
 807:	50                   	push   %eax
 808:	e8 a3 fd ff ff       	call   5b0 <free>
            return 1;
 80d:	58                   	pop    %eax
