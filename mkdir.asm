...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 8f 08 00 00       	mov    $0x88f,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 d8 0b 00 00       	mov    0xbd8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 66a:	50                   	push   %eax
 66b:	e8 da fc ff ff       	call   34a <sbrk>
  if(p == (char*)-1)
 ...
 682:	e8 39 ff ff ff       	call   5c0 <free>
  return freep;
 687:	a1 d8 0b 00 00       	mov    0xbd8,%eax
...
malloc(uint nbytes)
{
 ...
 6ba:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6bd:	a1 d8 0b 00 00       	mov    0xbd8,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 6d7:	76 1f                	jbe    6f8 <malloc+0x48>
        ...
        if(p == freep)
 6d9:	39 15 d8 0b 00 00    	cmp    %edx,0xbd8
 ...
 704:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 707:	a3 d8 0b 00 00       	mov    %eax,0xbd8
            return (void*)(p + 1);
 ...
 71c:	eb e9                	jmp    707 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 71e:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 725:	0b 00 00 
 728:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 72f:	0b 00 00 
        base.s.size = 0;
 732:	ba dc 0b 00 00       	mov    $0xbdc,%edx
 737:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 73e:	00 00 00 
...
pmalloc()
{
 ...
 754:	83 ec 04             	sub    $0x4,%esp
    ...
    if((prevp = freep) == 0){
 757:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 75c:	85 c0                	test   %eax,%eax
 75e:	74 56                	je     7b6 <pmalloc+0x66>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 769:	74 25                	je     790 <pmalloc+0x40>
        ...
        if(p == freep)
 76b:	39 15 d8 0b 00 00    	cmp    %edx,0xbd8
 ...
 781:	75 dd                	jne    760 <pmalloc+0x10>
                return 0;
 783:	31 db                	xor    %ebx,%ebx
 785:	eb 28                	jmp    7af <pmalloc+0x5f>
 ...
 795:	83 ec 0c             	sub    $0xc,%esp
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
            freep = prevp;
 798:	a3 d8 0b 00 00       	mov    %eax,0xbd8
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 79d:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 79f:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            turnOnPM( (void *)( p + 1 ) );
 7a6:	53                   	push   %ebx
 7a7:	e8 b6 fb ff ff       	call   362 <turnOnPM>
            return (void*)(p + 1);
 ...
 7b5:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 7bd:	0b 00 00 
 7c0:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 7c7:	0b 00 00 
        base.s.size = 0;
 7ca:	ba dc 0b 00 00       	mov    $0xbdc,%edx
 7cf:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 7d6:	00 00 00 
 7d9:	eb 90                	jmp    76b <pmalloc+0x1b>
 7db:	90                   	nop
...
protect_page(void* ap)
{
 ...
 7e8:	74 16                	je     800 <protect_page+0x20>
    {
        if( (uint)ap % 4096 != 0 )
 7ea:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7ef:	75 0f                	jne    800 <protect_page+0x20>
        p = ap;
        return turnOffW( p );
    }
    else
 ...
 7f1:	5d                   	pop    %ebp
        ...
        p = ap;
        return turnOffW( p );
 7f2:	e9 7b fb ff ff       	jmp    372 <turnOffW>
...
pfree(void* ap) {
 ...
 81c:	74 32                	je     850 <pfree+0x40>
        if ((uint) ap % 4096 != 0)
 81e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 824:	75 2a                	jne    850 <pfree+0x40>
            return -1;
 ...
 829:	53                   	push   %ebx
 82a:	e8 3b fb ff ff       	call   36a <checkOnPM>
 82f:	83 c4 10             	add    $0x10,%esp
 832:	85 c0                	test   %eax,%eax
 834:	74 1a                	je     850 <pfree+0x40>
            free(ap);
 836:	83 ec 0c             	sub    $0xc,%esp
 839:	53                   	push   %ebx
 83a:	e8 81 fd ff ff       	call   5c0 <free>
            return 1;
 ...
 84c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    return -1;
 850:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
