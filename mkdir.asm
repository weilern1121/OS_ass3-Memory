 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 93 08 00 00       	mov    $0x893,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 e0 0b 00 00       	mov    %eax,0xbe0
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 e0 0b 00 00       	mov    %eax,0xbe0
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 6b3:	e8 38 ff ff ff       	call   5f0 <free>
  return freep;
 6b8:	a1 e0 0b 00 00       	mov    0xbe0,%eax
...
malloc(uint nbytes)
{
 ...
 6da:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6dd:	a1 e0 0b 00 00       	mov    0xbe0,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f7:	73 27                	jae    720 <malloc+0x50>
        ...
        if(p == freep)
 6f9:	39 15 e0 0b 00 00    	cmp    %edx,0xbe0
 ...
 73d:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 740:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 747:	0b 00 00 
 74a:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 751:	0b 00 00 
        base.s.size = 0;
 754:	ba e4 0b 00 00       	mov    $0xbe4,%edx
 759:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 760:	00 00 00 
...
pmalloc()
{
 ...
 773:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 776:	8b 0d e0 0b 00 00    	mov    0xbe0,%ecx
 ...
 79b:	8b 0d e0 0b 00 00    	mov    0xbe0,%ecx
 ...
 7bd:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 7bf:	a3 e0 0b 00 00       	mov    %eax,0xbe0
            prevp->s.ptr = p->s.ptr;
 ...
 7d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 7d8:	b9 e4 0b 00 00       	mov    $0xbe4,%ecx
        base.s.ptr = freep = prevp = &base;
 7dd:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 7e4:	0b 00 00 
 7e7:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 7ee:	0b 00 00 
        base.s.size = 0;
 7f1:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 7f8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
