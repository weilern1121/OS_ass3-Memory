 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 d4 0a 00 00 	movzbl 0xad4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb cb 0a 00 00       	mov    $0xacb,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 621:	a1 a8 0e 00 00       	mov    0xea8,%eax
free(void *ap) {
 ...
 65d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 65f:	a3 a8 0e 00 00       	mov    %eax,0xea8
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 664:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 69a:	a3 a8 0e 00 00       	mov    %eax,0xea8
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6bc:	8b 15 a8 0e 00 00    	mov    0xea8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
        ...
        if (p == freep)
 701:	39 05 a8 0e 00 00    	cmp    %eax,0xea8
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
    return freep;
 72b:	8b 15 a8 0e 00 00    	mov    0xea8,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 757:	89 15 a8 0e 00 00    	mov    %edx,0xea8
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 770:	c7 05 a8 0e 00 00 ac 	movl   $0xeac,0xea8
 777:	0e 00 00 
 77a:	c7 05 ac 0e 00 00 ac 	movl   $0xeac,0xeac
 781:	0e 00 00 
        base.s.size = 0;
 784:	b8 ac 0e 00 00       	mov    $0xeac,%eax
 789:	c7 05 b0 0e 00 00 00 	movl   $0x0,0xeb0
 790:	00 00 00 
...
pmalloc(void) {
 ...
 7dc:	a1 98 0e 00 00       	mov    0xe98,%eax
    nh->PMnext = 0;
 ...
 7f5:	89 15 98 0e 00 00    	mov    %edx,0xe98
 7fb:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 7fd:	8b 15 9c 0e 00 00    	mov    0xe9c,%edx
 ...
 805:	74 39                	je     840 <pmalloc+0x90>
        ...
        tail->PMnext = nh;
 807:	a1 a0 0e 00 00       	mov    0xea0,%eax
        tail = tail->PMnext;
 80c:	89 1d a0 0e 00 00    	mov    %ebx,0xea0
        tail->PMnext = nh;
 ...
 82a:	e8 6b fb ff ff       	call   39a <updatePTE>
    PMcounter++;
 82f:	83 05 9c 0e 00 00 01 	addl   $0x1,0xe9c
    if (DEBUGMODE == 3)
 ...
 83f:	90                   	nop
        PMinit = nh; //set PMinit link
 840:	89 1d a4 0e 00 00    	mov    %ebx,0xea4
        tail = nh;
 846:	89 1d a0 0e 00 00    	mov    %ebx,0xea0
    char *tmpAdr = sbrk(4096); //point to the first free place
...
protect_page(void *ap) {
 ...
 890:	a1 a4 0e 00 00       	mov    0xea4,%eax
...
checkIfPM(void *p) {
 ...
 960:	8b 15 9c 0e 00 00    	mov    0xe9c,%edx
    struct PMHeader *tmp = PMinit;
 966:	a1 a4 0e 00 00       	mov    0xea4,%eax
    for (int i = 0; i < PMcounter; i++) {
...
pfree(void *ap) {
 ...
 9a5:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 9ab:	8b 1d a4 0e 00 00    	mov    0xea4,%ebx
        if ((int) ap % 4096 != 0) {
 ...
 9e1:	e8 b4 f9 ff ff       	call   39a <updatePTE>
            PMcounter--;
 9e6:	a1 9c 0e 00 00       	mov    0xe9c,%eax
 ...
 9f1:	85 c0                	test   %eax,%eax
            PMcounter--;
 9f3:	a3 9c 0e 00 00       	mov    %eax,0xe9c
            if (PMcounter == 0) {//if true ->reset PMlist
 ...
 a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 a40:	c7 05 a4 0e 00 00 00 	movl   $0x0,0xea4
 a47:	00 00 00 
                tail = 0;
 a4a:	c7 05 a0 0e 00 00 00 	movl   $0x0,0xea0
 a51:	00 00 00 
}
 ...
 a60:	a1 a4 0e 00 00       	mov    0xea4,%eax
 a65:	8b 40 08             	mov    0x8(%eax),%eax
 a68:	a3 a4 0e 00 00       	mov    %eax,0xea4
}
