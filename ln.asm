...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 37 08 00 00       	mov    $0x837,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 74 0b 00 00       	mov    0xb74,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 74 0b 00 00       	mov    %eax,0xb74
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 662:	e8 39 ff ff ff       	call   5a0 <free>
  return freep;
 667:	a1 74 0b 00 00       	mov    0xb74,%eax
...
malloc(uint nbytes)
{
 ...
 6b7:	76 1f                	jbe    6d8 <malloc+0x48>
        ...
        if(p == freep)
 6b9:	39 15 74 0b 00 00    	cmp    %edx,0xb74
 ...
 6e4:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 6e7:	a3 74 0b 00 00       	mov    %eax,0xb74
            return (void*)(p + 1);
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 74 0b 00 00 78 	movl   $0xb78,0xb74
 705:	0b 00 00 
 708:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 70f:	0b 00 00 
        base.s.size = 0;
 712:	ba 78 0b 00 00       	mov    $0xb78,%edx
 717:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 71e:	00 00 00 
...
pmalloc()
{
 ...
 749:	74 25                	je     770 <pmalloc+0x40>
        ...
        if(p == freep)
 74b:	39 15 74 0b 00 00    	cmp    %edx,0xb74
 ...
 770:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 772:	a3 74 0b 00 00       	mov    %eax,0xb74
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 784:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 785:	c7 05 74 0b 00 00 78 	movl   $0xb78,0xb74
 78c:	0b 00 00 
 78f:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 796:	0b 00 00 
        base.s.size = 0;
 799:	ba 78 0b 00 00       	mov    $0xb78,%edx
 79e:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 7a5:	00 00 00 
