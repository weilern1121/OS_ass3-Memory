...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 27 08 00 00       	mov    $0x827,%eax
...
free(void *ap)
{
 ...
 591:	a1 68 0b 00 00       	mov    0xb68,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 68 0b 00 00       	mov    %eax,0xb68
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 624:	83 ec 04             	sub    $0x4,%esp
  ...
  if(nu < 4096)
 627:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 62c:	76 3a                	jbe    668 <morecore+0x48>
 62e:	89 c3                	mov    %eax,%ebx
 630:	8d 04 c5 00 00 00 00 	lea    0x0(,%eax,8),%eax
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
 637:	83 ec 0c             	sub    $0xc,%esp
 63a:	50                   	push   %eax
 63b:	e8 ea fc ff ff       	call   32a <sbrk>
  if(p == (char*)-1)
 640:	83 c4 10             	add    $0x10,%esp
 643:	83 f8 ff             	cmp    $0xffffffff,%eax
 646:	74 30                	je     678 <morecore+0x58>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 651:	50                   	push   %eax
 652:	e8 39 ff ff ff       	call   590 <free>
  return freep;
 657:	a1 68 0b 00 00       	mov    0xb68,%eax
 ...
 668:	b8 00 80 00 00       	mov    $0x8000,%eax
{
 ...
 672:	eb c3                	jmp    637 <morecore+0x17>
 674:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  p = sbrk(nu * sizeof(Header));
  if(p == (char*)-1)
    return 0;
 678:	31 c0                	xor    %eax,%eax
 67a:	eb e3                	jmp    65f <morecore+0x3f>
...
malloc(uint nbytes)
{
 ...
 6c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size >= nunits){
            if(p->s.size == nunits)
 6c8:	39 cb                	cmp    %ecx,%ebx
 6ca:	74 1c                	je     6e8 <malloc+0x68>
                prevp->s.ptr = p->s.ptr;
            else {
                p->s.size -= nunits;
 6cc:	29 d9                	sub    %ebx,%ecx
 6ce:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 6d1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 6d4:	89 5a 04             	mov    %ebx,0x4(%edx)
            }
            freep = prevp;
 6d7:	a3 68 0b 00 00       	mov    %eax,0xb68
            return (void*)(p + 1);
 6dc:	8d 42 08             	lea    0x8(%edx),%eax
        }
        if(p == freep)
            if((p = morecore(nunits)) == 0)
                return 0;
 ...
 6ec:	eb e9                	jmp    6d7 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 6f5:	0b 00 00 
 6f8:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 6ff:	0b 00 00 
        base.s.size = 0;
 702:	ba 6c 0b 00 00       	mov    $0xb6c,%edx
 707:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 70e:	00 00 00 
 711:	eb 96                	jmp    6a9 <malloc+0x29>
...
pmalloc()
{
 ...
 723:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 726:	a1 68 0b 00 00       	mov    0xb68,%eax
 72b:	85 c0                	test   %eax,%eax
 72d:	74 46                	je     775 <pmalloc+0x55>
 72f:	90                   	nop
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
 ...
 730:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 732:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 739:	74 25                	je     760 <pmalloc+0x40>
            freep = prevp;
            (p+1)->x = 1;
            return (void*)(p + 1);
        }
        ...
        if(p == freep)
 73b:	39 15 68 0b 00 00    	cmp    %edx,0xb68
 741:	89 d0                	mov    %edx,%eax
 743:	75 eb                	jne    730 <pmalloc+0x10>
            if((p = morecore(nunits)) == 0)
 745:	b8 01 02 00 00       	mov    $0x201,%eax
 74a:	e8 d1 fe ff ff       	call   620 <morecore>
 74f:	85 c0                	test   %eax,%eax
 751:	75 dd                	jne    730 <pmalloc+0x10>
                return 0;
 ...
 760:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 762:	a3 68 0b 00 00       	mov    %eax,0xb68
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 767:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 769:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 770:	8d 42 08             	lea    0x8(%edx),%eax
 ...
 774:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 775:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 77c:	0b 00 00 
 77f:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 786:	0b 00 00 
        base.s.size = 0;
 789:	ba 6c 0b 00 00       	mov    $0xb6c,%edx
 78e:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 795:	00 00 00 
 798:	eb a1                	jmp    73b <pmalloc+0x1b>
 79a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000007a0 <protect_page>:
    }
}
...
int protect_page(void* ap)
{
 ...
 7a8:	74 1e                	je     7c8 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 7aa:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7af:	75 17                	jne    7c8 <protect_page+0x28>
            return -1;
 ...
 7b5:	74 11                	je     7c8 <protect_page+0x28>
            return -1;

        p->protected = 1;
 7b7:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
...
int pfree(void* ap) {
 ...
 7d8:	74 1e                	je     7f8 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 7da:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7df:	75 17                	jne    7f8 <pfree+0x28>
            return -1;
 ...
 7e5:	74 11                	je     7f8 <pfree+0x28>
            free(ap);
 7e7:	50                   	push   %eax
 7e8:	e8 a3 fd ff ff       	call   590 <free>
            return 1;
 7ed:	58                   	pop    %eax
