 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 a8 0a 00 00 	movzbl 0xaa8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 9f 0a 00 00       	mov    $0xa9f,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 601:	a1 74 0e 00 00       	mov    0xe74,%eax
free(void *ap) {
 ...
 63d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 63f:	a3 74 0e 00 00       	mov    %eax,0xe74
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 644:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 67a:	a3 74 0e 00 00       	mov    %eax,0xe74
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 69c:	8b 15 74 0e 00 00    	mov    0xe74,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
        ...
        if (p == freep)
 6e1:	39 05 74 0e 00 00    	cmp    %eax,0xe74
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
    return freep;
 70b:	8b 15 74 0e 00 00    	mov    0xe74,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 737:	89 15 74 0e 00 00    	mov    %edx,0xe74
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 750:	c7 05 74 0e 00 00 78 	movl   $0xe78,0xe74
 757:	0e 00 00 
 75a:	c7 05 78 0e 00 00 78 	movl   $0xe78,0xe78
 761:	0e 00 00 
        base.s.size = 0;
 764:	b8 78 0e 00 00       	mov    $0xe78,%eax
 769:	c7 05 7c 0e 00 00 00 	movl   $0x0,0xe7c
 770:	00 00 00 
...
pmalloc(void) {
 ...
 7bc:	a1 64 0e 00 00       	mov    0xe64,%eax
    nh->PMnext = 0;
 ...
 7d5:	89 15 64 0e 00 00    	mov    %edx,0xe64
 7db:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 7dd:	8b 15 68 0e 00 00    	mov    0xe68,%edx
 ...
 7e5:	74 39                	je     820 <pmalloc+0x90>
        ...
        tail->PMnext = nh;
 7e7:	a1 6c 0e 00 00       	mov    0xe6c,%eax
        tail = tail->PMnext;
 7ec:	89 1d 6c 0e 00 00    	mov    %ebx,0xe6c
        tail->PMnext = nh;
 ...
 80a:	e8 6b fb ff ff       	call   37a <updatePTE>
    PMcounter++;
 80f:	83 05 68 0e 00 00 01 	addl   $0x1,0xe68
    if (DEBUGMODE == 3)
 ...
 81f:	90                   	nop
        PMinit = nh; //set PMinit link
 820:	89 1d 70 0e 00 00    	mov    %ebx,0xe70
        tail = nh;
 826:	89 1d 6c 0e 00 00    	mov    %ebx,0xe6c
    char *tmpAdr = sbrk(4096); //point to the first free place
...
protect_page(void *ap) {
 ...
 870:	a1 70 0e 00 00       	mov    0xe70,%eax
...
checkIfPM(void *p) {
 ...
 940:	8b 15 68 0e 00 00    	mov    0xe68,%edx
    struct PMHeader *tmp = PMinit;
 946:	a1 70 0e 00 00       	mov    0xe70,%eax
    for (int i = 0; i < PMcounter; i++) {
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 970:	a1 68 0e 00 00       	mov    0xe68,%eax
pfree(void *ap) {
 975:	55                   	push   %ebp
...
pfree(void *ap) {
 ...
 985:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 98b:	8b 1d 70 0e 00 00    	mov    0xe70,%ebx
        if ((int) ap % 4096 != 0) {
 ...
 9c1:	e8 b4 f9 ff ff       	call   37a <updatePTE>
            PMcounter--;
 9c6:	a1 68 0e 00 00       	mov    0xe68,%eax
 ...
 9d1:	85 c0                	test   %eax,%eax
            PMcounter--;
 9d3:	a3 68 0e 00 00       	mov    %eax,0xe68
            if (PMcounter == 0) {//if true ->reset PMlist
 ...
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 a20:	c7 05 70 0e 00 00 00 	movl   $0x0,0xe70
 a27:	00 00 00 
                tail = 0;
 a2a:	c7 05 6c 0e 00 00 00 	movl   $0x0,0xe6c
 a31:	00 00 00 
}
 ...
 a40:	a1 70 0e 00 00       	mov    0xe70,%eax
 a45:	8b 40 08             	mov    0x8(%eax),%eax
 a48:	a3 70 0e 00 00       	mov    %eax,0xe70
}
