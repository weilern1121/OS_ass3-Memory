...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 6c 08 00 00 	movzbl 0x86c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 63 08 00 00       	mov    $0x863,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 a4 0b 00 00       	mov    0xba4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 a4 0b 00 00       	mov    %eax,0xba4
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 a4 0b 00 00       	mov    %eax,0xba4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 64a:	50                   	push   %eax
 64b:	e8 da fc ff ff       	call   32a <sbrk>
  if(p == (char*)-1)
 ...
 662:	e8 39 ff ff ff       	call   5a0 <free>
  return freep;
 667:	a1 a4 0b 00 00       	mov    0xba4,%eax
...
malloc(uint nbytes)
{
 ...
 69a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 69d:	a1 a4 0b 00 00       	mov    0xba4,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 6b7:	76 1f                	jbe    6d8 <malloc+0x48>
        ...
        if(p == freep)
 6b9:	39 15 a4 0b 00 00    	cmp    %edx,0xba4
 ...
 6e4:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 6e7:	a3 a4 0b 00 00       	mov    %eax,0xba4
            return (void*)(p + 1);
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 705:	0b 00 00 
 708:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 70f:	0b 00 00 
        base.s.size = 0;
 712:	ba a8 0b 00 00       	mov    $0xba8,%edx
 717:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 71e:	00 00 00 
...
pmalloc()
{
 ...
 734:	83 ec 04             	sub    $0x4,%esp
    ...
    if((prevp = freep) == 0){
 737:	a1 a4 0b 00 00       	mov    0xba4,%eax
 73c:	85 c0                	test   %eax,%eax
 73e:	74 56                	je     796 <pmalloc+0x66>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 749:	74 25                	je     770 <pmalloc+0x40>
        ...
        if(p == freep)
 74b:	39 15 a4 0b 00 00    	cmp    %edx,0xba4
 ...
 761:	75 dd                	jne    740 <pmalloc+0x10>
                return 0;
 763:	31 db                	xor    %ebx,%ebx
 765:	eb 28                	jmp    78f <pmalloc+0x5f>
 ...
 775:	83 ec 0c             	sub    $0xc,%esp
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
            freep = prevp;
 778:	a3 a4 0b 00 00       	mov    %eax,0xba4
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 77d:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 77f:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            turnOnPM( (void *)( p + 1 ) );
 786:	53                   	push   %ebx
 787:	e8 b6 fb ff ff       	call   342 <turnOnPM>
            return (void*)(p + 1);
 ...
 795:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 796:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 79d:	0b 00 00 
 7a0:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7a7:	0b 00 00 
        base.s.size = 0;
 7aa:	ba a8 0b 00 00       	mov    $0xba8,%edx
 7af:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 7b6:	00 00 00 
 7b9:	eb 90                	jmp    74b <pmalloc+0x1b>
 7bb:	90                   	nop
...
protect_page(void* ap)
{
 ...
 7c8:	74 16                	je     7e0 <protect_page+0x20>
    {
        if( (uint)ap % 4096 != 0 )
 7ca:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7cf:	75 0f                	jne    7e0 <protect_page+0x20>
        p = ap;
        return turnOffW( p );
    }
    else
 ...
 7d1:	5d                   	pop    %ebp
        ...
        p = ap;
        return turnOffW( p );
 7d2:	e9 7b fb ff ff       	jmp    352 <turnOffW>
...
pfree(void* ap) {
 ...
 7f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
    Header *p;
    if (ap) {
 7fa:	85 db                	test   %ebx,%ebx
 7fc:	74 32                	je     830 <pfree+0x40>
        if ((uint) ap % 4096 != 0)
 7fe:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 804:	75 2a                	jne    830 <pfree+0x40>
            return -1;
 ...
 809:	53                   	push   %ebx
 80a:	e8 3b fb ff ff       	call   34a <checkOnPM>
 80f:	83 c4 10             	add    $0x10,%esp
 812:	85 c0                	test   %eax,%eax
 814:	74 1a                	je     830 <pfree+0x40>
            free(ap);
 816:	83 ec 0c             	sub    $0xc,%esp
 819:	53                   	push   %ebx
 81a:	e8 81 fd ff ff       	call   5a0 <free>
            return 1;
