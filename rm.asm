...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 4d 08 00 00       	mov    $0x84d,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 94 0b 00 00       	mov    0xb94,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 94 0b 00 00       	mov    %eax,0xb94
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 94 0b 00 00       	mov    %eax,0xb94
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 672:	e8 39 ff ff ff       	call   5b0 <free>
  return freep;
 677:	a1 94 0b 00 00       	mov    0xb94,%eax
...
malloc(uint nbytes)
{
 ...
 6aa:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6ad:	a1 94 0b 00 00       	mov    0xb94,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 6c7:	76 1f                	jbe    6e8 <malloc+0x48>
        ...
        if(p == freep)
 6c9:	39 15 94 0b 00 00    	cmp    %edx,0xb94
 ...
 6f4:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 6f7:	a3 94 0b 00 00       	mov    %eax,0xb94
            return (void*)(p + 1);
 ...
 70c:	eb e9                	jmp    6f7 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 70e:	c7 05 94 0b 00 00 98 	movl   $0xb98,0xb94
 715:	0b 00 00 
 718:	c7 05 98 0b 00 00 98 	movl   $0xb98,0xb98
 71f:	0b 00 00 
        base.s.size = 0;
 722:	ba 98 0b 00 00       	mov    $0xb98,%edx
 727:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 72e:	00 00 00 
...
pmalloc()
{
 ...
 743:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 746:	a1 94 0b 00 00       	mov    0xb94,%eax
 ...
 759:	74 25                	je     780 <pmalloc+0x40>
        ...
        if(p == freep)
 75b:	39 15 94 0b 00 00    	cmp    %edx,0xb94
 ...
 780:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 782:	a3 94 0b 00 00       	mov    %eax,0xb94
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 794:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 795:	c7 05 94 0b 00 00 98 	movl   $0xb98,0xb94
 79c:	0b 00 00 
 79f:	c7 05 98 0b 00 00 98 	movl   $0xb98,0xb98
 7a6:	0b 00 00 
        base.s.size = 0;
 7a9:	ba 98 0b 00 00       	mov    $0xb98,%edx
 7ae:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 7b5:	00 00 00 
