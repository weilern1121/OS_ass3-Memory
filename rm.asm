...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 89 08 00 00       	mov    $0x889,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 d0 0b 00 00       	mov    0xbd0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 d0 0b 00 00       	mov    %eax,0xbd0
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 682:	e8 39 ff ff ff       	call   5c0 <free>
  return freep;
 687:	a1 d0 0b 00 00       	mov    0xbd0,%eax
...
malloc(uint nbytes)
{
 ...
 6ba:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6bd:	a1 d0 0b 00 00       	mov    0xbd0,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 6d7:	76 1f                	jbe    6f8 <malloc+0x48>
        ...
        if(p == freep)
 6d9:	39 15 d0 0b 00 00    	cmp    %edx,0xbd0
 ...
 704:	89 5a 04             	mov    %ebx,0x4(%edx)
            ...
            freep = prevp;
 707:	a3 d0 0b 00 00       	mov    %eax,0xbd0
            return (void*)(p + 1);
 ...
 71c:	eb e9                	jmp    707 <malloc+0x57>
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 71e:	c7 05 d0 0b 00 00 d4 	movl   $0xbd4,0xbd0
 725:	0b 00 00 
 728:	c7 05 d4 0b 00 00 d4 	movl   $0xbd4,0xbd4
 72f:	0b 00 00 
        base.s.size = 0;
 732:	ba d4 0b 00 00       	mov    $0xbd4,%edx
 737:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 73e:	00 00 00 
...
pmalloc()
{
 ...
 754:	83 ec 04             	sub    $0x4,%esp
    ...
    if((prevp = freep) == 0){
 757:	a1 d0 0b 00 00       	mov    0xbd0,%eax
 ...
 769:	74 25                	je     790 <pmalloc+0x40>
        ...
        if(p == freep)
 76b:	39 15 d0 0b 00 00    	cmp    %edx,0xbd0
 ...
 795:	83 ec 0c             	sub    $0xc,%esp
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
            freep = prevp;
 798:	a3 d0 0b 00 00       	mov    %eax,0xbd0
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 7b5:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 d0 0b 00 00 d4 	movl   $0xbd4,0xbd0
 7bd:	0b 00 00 
 7c0:	c7 05 d4 0b 00 00 d4 	movl   $0xbd4,0xbd4
 7c7:	0b 00 00 
        base.s.size = 0;
 7ca:	ba d4 0b 00 00       	mov    $0xbd4,%edx
 7cf:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 7d6:	00 00 00 
