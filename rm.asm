 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 cc 0a 00 00 	movzbl 0xacc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c5 0a 00 00       	mov    $0xac5,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 621:	a1 a0 0e 00 00       	mov    0xea0,%eax
free(void *ap) {
 ...
 65d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 65f:	a3 a0 0e 00 00       	mov    %eax,0xea0
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 664:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 69a:	a3 a0 0e 00 00       	mov    %eax,0xea0
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6bc:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
        ...
        if (p == freep)
 701:	39 05 a0 0e 00 00    	cmp    %eax,0xea0
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
    return freep;
 72b:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 757:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 770:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 777:	0e 00 00 
 77a:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 781:	0e 00 00 
        base.s.size = 0;
 784:	b8 a4 0e 00 00       	mov    $0xea4,%eax
 789:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 790:	00 00 00 
...
pmalloc(void) {
 ...
 7b8:	6a 10                	push   $0x10
 7ba:	e8 f1 fe ff ff       	call   6b0 <malloc>
    char *tmpAdr = sbrk(4096); //point to the first free place
 7bf:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    struct PMHeader *nh = malloc(sizeof(struct PMHeader));
 7c6:	89 c3                	mov    %eax,%ebx
    char *tmpAdr = sbrk(4096); //point to the first free place
 7c8:	e8 8d fb ff ff       	call   35a <sbrk>
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 7cd:	83 c4 10             	add    $0x10,%esp
 7d0:	a9 ff 0f 00 00       	test   $0xfff,%eax
    char *tmpAdr = sbrk(4096); //point to the first free place
 7d5:	89 c6                	mov    %eax,%esi
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 7d7:	74 03                	je     7dc <pmalloc+0x2c>
        *tmpAdr = (char) PGROUNDUP((int) tmpAdr);
 7d9:	c6 00 00             	movb   $0x0,(%eax)

    //init PMHeader
    nh->PMheaderID = nextID++;
 7dc:	a1 90 0e 00 00       	mov    0xe90,%eax
    nh->PMnext = 0;
 7e1:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nh->PMadress = tmpAdr;
 7e8:	89 73 04             	mov    %esi,0x4(%ebx)
    nh->PMprotectedPage = 0;
 7eb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    nh->PMheaderID = nextID++;
 7f2:	8d 50 01             	lea    0x1(%eax),%edx
 7f5:	89 15 90 0e 00 00    	mov    %edx,0xe90
 7fb:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 7fd:	8b 15 94 0e 00 00    	mov    0xe94,%edx
 803:	85 d2                	test   %edx,%edx
 805:	74 39                	je     840 <pmalloc+0x90>
        PMinit = nh; //set PMinit link
        tail = nh;
    } else { //else- add new page to the end of PMlist
        tail->PMnext = nh;
 807:	a1 98 0e 00 00       	mov    0xe98,%eax
        tail = tail->PMnext;
 80c:	89 1d 98 0e 00 00    	mov    %ebx,0xe98
        tail->PMnext = nh;
 812:	89 58 08             	mov    %ebx,0x8(%eax)
 815:	8b 43 04             	mov    0x4(%ebx),%eax
    }
    //turn PMflag on and W flag off
    turnOnW(nh->PMadress);//TODO
 818:	83 ec 0c             	sub    $0xc,%esp
 81b:	50                   	push   %eax
 81c:	e8 69 fb ff ff       	call   38a <turnOnW>
    turnOnPM(nh->PMadress);
 821:	58                   	pop    %eax
 822:	ff 73 04             	pushl  0x4(%ebx)
 825:	e8 48 fb ff ff       	call   372 <turnOnPM>
    //fresh PTE
    updatePTE();
 82a:	e8 6b fb ff ff       	call   39a <updatePTE>
    PMcounter++;
 82f:	83 05 94 0e 00 00 01 	addl   $0x1,0xe94
    if (DEBUGMODE == 3)
 ...
 83f:	90                   	nop
        PMinit = nh; //set PMinit link
 840:	89 1d 9c 0e 00 00    	mov    %ebx,0xe9c
        tail = nh;
 846:	89 1d 98 0e 00 00    	mov    %ebx,0xe98
    char *tmpAdr = sbrk(4096); //point to the first free place
 84c:	89 f0                	mov    %esi,%eax
 84e:	eb c8                	jmp    818 <pmalloc+0x68>

00000850 <protect_page>:
...
protect_page(void *ap) {
 ...
 85c:	74 7a                	je     8d8 <protect_page+0x88>
        if ((int) ap % 4096 != 0) {
 85e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 864:	75 72                	jne    8d8 <protect_page+0x88>
            if (DEBUGMODE == 3)
 ...
 869:	53                   	push   %ebx
 86a:	e8 0b fb ff ff       	call   37a <checkOnPM>
 86f:	83 c4 10             	add    $0x10,%esp
 872:	85 c0                	test   %eax,%eax
 874:	74 62                	je     8d8 <protect_page+0x88>
            turnOffW(ap);
 876:	83 ec 0c             	sub    $0xc,%esp
 879:	53                   	push   %ebx
 87a:	e8 03 fb ff ff       	call   382 <turnOffW>
            updatePTE();
 87f:	e8 16 fb ff ff       	call   39a <updatePTE>
            updateProc(1); // protectedPages++
 884:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 88b:	e8 12 fb ff ff       	call   3a2 <updateProc>
            //turn on flag
            struct PMHeader *PMap = PMinit;
 890:	a1 9c 0e 00 00       	mov    0xe9c,%eax
            while (PMap->PMnext != 0 && PMap->PMadress != ap)
 895:	83 c4 10             	add    $0x10,%esp
 898:	eb 0c                	jmp    8a6 <protect_page+0x56>
 89a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 8a0:	39 cb                	cmp    %ecx,%ebx
 8a2:	74 10                	je     8b4 <protect_page+0x64>
 8a4:	89 d0                	mov    %edx,%eax
 8a6:	8b 50 08             	mov    0x8(%eax),%edx
 8a9:	8b 48 04             	mov    0x4(%eax),%ecx
 8ac:	85 d2                	test   %edx,%edx
 8ae:	75 f0                	jne    8a0 <protect_page+0x50>
                PMap = PMap->PMnext;
            if (PMap->PMadress != ap) {
 8b0:	39 cb                	cmp    %ecx,%ebx
 8b2:	75 11                	jne    8c5 <protect_page+0x75>
                printf(2, "PROBLEM with ap:%d\n", ap);
                return -1;
            }
            //got here ->MPap points the protected link
            PMap->PMprotectedPage = 1;//turn on FLAG
 8b4:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
            if (DEBUGMODE == 3)
                printf(1, ">PROTECT_PAGE-DONE!\n");
            return 1;
 8bb:	b8 01 00 00 00       	mov    $0x1,%eax
        }
    }
    if (DEBUGMODE == 3)
 ...
 8c8:	53                   	push   %ebx
 8c9:	68 dd 0a 00 00       	push   $0xadd
 8ce:	6a 02                	push   $0x2
 8d0:	e8 7b fb ff ff       	call   450 <printf>
...
printPMList(void) {
 ...
 8f5:	8b 1d 9c 0e 00 00    	mov    0xe9c,%ebx
    printf(1, "\nPMlist:\t");
 8fb:	83 ec 08             	sub    $0x8,%esp
 8fe:	68 f1 0a 00 00       	push   $0xaf1
 903:	6a 01                	push   $0x1
 905:	e8 46 fb ff ff       	call   450 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 90a:	a1 94 0e 00 00       	mov    0xe94,%eax
 90f:	83 c4 10             	add    $0x10,%esp
 912:	85 c0                	test   %eax,%eax
 914:	7e 2d                	jle    943 <printPMList+0x53>
 916:	31 f6                	xor    %esi,%esi
 918:	90                   	nop
 919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(2, "%d\t", tmp2->PMadress);
 920:	83 ec 04             	sub    $0x4,%esp
 923:	ff 73 04             	pushl  0x4(%ebx)
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 926:	83 c6 01             	add    $0x1,%esi
        printf(2, "%d\t", tmp2->PMadress);
 929:	68 fb 0a 00 00       	push   $0xafb
 92e:	6a 02                	push   $0x2
 930:	e8 1b fb ff ff       	call   450 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 935:	83 c4 10             	add    $0x10,%esp
 938:	39 35 94 0e 00 00    	cmp    %esi,0xe94
 93e:	8b 5b 08             	mov    0x8(%ebx),%ebx
 941:	7f dd                	jg     920 <printPMList+0x30>
    printf(1, "\n\n");
 943:	83 ec 08             	sub    $0x8,%esp
 946:	68 ff 0a 00 00       	push   $0xaff
 94b:	6a 01                	push   $0x1
 94d:	e8 fe fa ff ff       	call   450 <printf>
}
...
checkIfPM(void *p) {
 ...
 960:	8b 15 94 0e 00 00    	mov    0xe94,%edx
    struct PMHeader *tmp = PMinit;
 966:	a1 9c 0e 00 00       	mov    0xe9c,%eax
    for (int i = 0; i < PMcounter; i++) {
 96b:	85 d2                	test   %edx,%edx
 96d:	7e 11                	jle    980 <checkIfPM+0x20>
checkIfPM(void *p) {
 96f:	55                   	push   %ebp
 970:	89 e5                	mov    %esp,%ebp
        if (tmp->PMadress == p)
 972:	8b 55 08             	mov    0x8(%ebp),%edx
 975:	39 50 04             	cmp    %edx,0x4(%eax)
            return 1;
    }
    return 0;
}
 978:	5d                   	pop    %ebp
        if (tmp->PMadress == p)
 979:	0f 94 c0             	sete   %al
 97c:	0f b6 c0             	movzbl %al,%eax
}
 97f:	c3                   	ret    
    return 0;
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 990:	a1 94 0e 00 00       	mov    0xe94,%eax
pfree(void *ap) {
 995:	55                   	push   %ebp
...
pfree(void *ap) {
 99c:	8b 75 08             	mov    0x8(%ebp),%esi
    if (ap) {
 99f:	74 1b                	je     9bc <pfree+0x2c>
 9a1:	85 f6                	test   %esi,%esi
 9a3:	74 17                	je     9bc <pfree+0x2c>
        struct PMHeader *PMap = PMinit;
        struct PMHeader *tmp = PMinit;
        //check aligned
        if ((int) ap % 4096 != 0) {
 9a5:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 9ab:	8b 1d 9c 0e 00 00    	mov    0xe9c,%ebx
        if ((int) ap % 4096 != 0) {
 9b1:	75 09                	jne    9bc <pfree+0x2c>
    for (int i = 0; i < PMcounter; i++) {
 9b3:	85 c0                	test   %eax,%eax
 9b5:	7e 05                	jle    9bc <pfree+0x2c>
        if (tmp->PMadress == p)
 9b7:	3b 73 04             	cmp    0x4(%ebx),%esi
 9ba:	74 14                	je     9d0 <pfree+0x40>
            return -1;
        }
    }
    if (DEBUGMODE == 3)
 ...
 9d3:	53                   	push   %ebx
 9d4:	e8 a9 f9 ff ff       	call   382 <turnOffW>
            turnOffPM(PMap);
 9d9:	89 1c 24             	mov    %ebx,(%esp)
 9dc:	e8 b1 f9 ff ff       	call   392 <turnOffPM>
            updatePTE();
 9e1:	e8 b4 f9 ff ff       	call   39a <updatePTE>
            PMcounter--;
 9e6:	a1 94 0e 00 00       	mov    0xe94,%eax
 ...
 9f1:	85 c0                	test   %eax,%eax
            PMcounter--;
 9f3:	a3 94 0e 00 00       	mov    %eax,0xe94
            if (PMcounter == 0) {//if true ->reset PMlist
 9f8:	74 46                	je     a40 <pfree+0xb0>
 9fa:	89 d8                	mov    %ebx,%eax
 9fc:	eb 08                	jmp    a06 <pfree+0x76>
 9fe:	66 90                	xchg   %ax,%ax
                while (PMap->PMnext != 0 && PMap->PMadress != ap)
 a00:	39 ce                	cmp    %ecx,%esi
 a02:	74 10                	je     a14 <pfree+0x84>
 a04:	89 d0                	mov    %edx,%eax
 a06:	8b 50 08             	mov    0x8(%eax),%edx
 a09:	8b 48 04             	mov    0x4(%eax),%ecx
 a0c:	85 d2                	test   %edx,%edx
 a0e:	75 f0                	jne    a00 <pfree+0x70>
                if (PMap->PMadress != ap) {
 a10:	39 ce                	cmp    %ecx,%esi
 a12:	75 65                	jne    a79 <pfree+0xe9>
                if (tmp->PMheaderID == PMap->PMheaderID) {//happens when both point on the first link
 a14:	8b 08                	mov    (%eax),%ecx
 a16:	39 0b                	cmp    %ecx,(%ebx)
 a18:	75 08                	jne    a22 <pfree+0x92>
 a1a:	eb 44                	jmp    a60 <pfree+0xd0>
 a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 a20:	89 c3                	mov    %eax,%ebx
                    while (tmp->PMnext->PMheaderID != PMap->PMheaderID)
 a22:	8b 43 08             	mov    0x8(%ebx),%eax
 a25:	3b 08                	cmp    (%eax),%ecx
 a27:	75 f7                	jne    a20 <pfree+0x90>
                    tmp->PMnext = PMap->PMnext;
 a29:	89 53 08             	mov    %edx,0x8(%ebx)
}
 a2c:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 a40:	c7 05 9c 0e 00 00 00 	movl   $0x0,0xe9c
 a47:	00 00 00 
                tail = 0;
 a4a:	c7 05 98 0e 00 00 00 	movl   $0x0,0xe98
 a51:	00 00 00 
}
 ...
 a60:	a1 9c 0e 00 00       	mov    0xe9c,%eax
 a65:	8b 40 08             	mov    0x8(%eax),%eax
 a68:	a3 9c 0e 00 00       	mov    %eax,0xe9c
}
 a6d:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 a70:	b8 01 00 00 00       	mov    $0x1,%eax
}
 a75:	5b                   	pop    %ebx
 a76:	5e                   	pop    %esi
 a77:	5d                   	pop    %ebp
 ...
 a7c:	56                   	push   %esi
 a7d:	68 dd 0a 00 00       	push   $0xadd
 a82:	6a 02                	push   $0x2
 a84:	e8 c7 f9 ff ff       	call   450 <printf>
                    return -1;
 a89:	83 c4 10             	add    $0x10,%esp
 a8c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a91:	e9 2b ff ff ff       	jmp    9c1 <pfree+0x31>
