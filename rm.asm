 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 8d 08 00 00       	mov    $0x88d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 68c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 691:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 69b:	50                   	push   %eax
 69c:	e8 b9 fc ff ff       	call   35a <sbrk>
  if(p == (char*)-1)
 6a1:	83 c4 10             	add    $0x10,%esp
 6a4:	83 f8 ff             	cmp    $0xffffffff,%eax
 6a7:	74 1f                	je     6c8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 6b2:	50                   	push   %eax
 6b3:	e8 38 ff ff ff       	call   5f0 <free>
  return freep;
 6b8:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 ...
 6ca:	eb f4                	jmp    6c0 <morecore+0x40>
...
malloc(uint nbytes)
{
 ...
 6da:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6dd:	a1 d8 0b 00 00       	mov    0xbd8,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 6e2:	c1 eb 03             	shr    $0x3,%ebx
 6e5:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
 6e8:	85 c0                	test   %eax,%eax
 6ea:	74 54                	je     740 <malloc+0x70>
 ...
 6f5:	39 d9                	cmp    %ebx,%ecx
 6f7:	73 27                	jae    720 <malloc+0x50>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
 6f9:	39 15 d8 0b 00 00    	cmp    %edx,0xbd8
 6ff:	89 d0                	mov    %edx,%eax
 701:	75 ed                	jne    6f0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 703:	89 d8                	mov    %ebx,%eax
 705:	e8 76 ff ff ff       	call   680 <morecore>
 70a:	85 c0                	test   %eax,%eax
 70c:	75 e2                	jne    6f0 <malloc+0x20>
                return 0;
    }
}
 ...
 719:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits)
 720:	39 cb                	cmp    %ecx,%ebx
 722:	74 44                	je     768 <malloc+0x98>
                p->s.size -= nunits;
 724:	29 d9                	sub    %ebx,%ecx
 726:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 729:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 72c:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 72f:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 734:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
 737:	8d 42 08             	lea    0x8(%edx),%eax
}
 73a:	5b                   	pop    %ebx
 73b:	5d                   	pop    %ebp
 73c:	c3                   	ret    
 73d:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 740:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 747:	0b 00 00 
 74a:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 751:	0b 00 00 
        base.s.size = 0;
 754:	ba dc 0b 00 00       	mov    $0xbdc,%edx
 759:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 760:	00 00 00 
 763:	eb 94                	jmp    6f9 <malloc+0x29>
 765:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
 768:	8b 0a                	mov    (%edx),%ecx
 76a:	89 08                	mov    %ecx,(%eax)
 76c:	eb c1                	jmp    72f <malloc+0x5f>
...
pmalloc()
{
 ...
 773:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 776:	8b 0d d8 0b 00 00    	mov    0xbd8,%ecx
 77c:	85 c9                	test   %ecx,%ecx
 77e:	74 58                	je     7d8 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 780:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
 782:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
 789:	75 18                	jne    7a3 <pmalloc+0x33>
 78b:	eb 2c                	jmp    7b9 <pmalloc+0x49>
 78d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 790:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 792:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 799:	74 22                	je     7bd <pmalloc+0x4d>
 79b:	8b 0d d8 0b 00 00    	mov    0xbd8,%ecx
 7a1:	89 d0                	mov    %edx,%eax
        ...
        if(p == freep)
 7a3:	39 c1                	cmp    %eax,%ecx
 7a5:	75 e9                	jne    790 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
 7a7:	b8 01 02 00 00       	mov    $0x201,%eax
 7ac:	e8 cf fe ff ff       	call   680 <morecore>
 7b1:	85 c0                	test   %eax,%eax
 7b3:	75 db                	jne    790 <pmalloc+0x20>
                return 0;
 ...
 7bd:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 7bf:	a3 d8 0b 00 00       	mov    %eax,0xbd8
            prevp->s.ptr = p->s.ptr;
 7c4:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
 7c6:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 7cd:	8d 42 08             	lea    0x8(%edx),%eax
}
 7d0:	c9                   	leave  
 7d1:	c3                   	ret    
 7d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 7d8:	b9 dc 0b 00 00       	mov    $0xbdc,%ecx
        base.s.ptr = freep = prevp = &base;
 7dd:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 7e4:	0b 00 00 
 7e7:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 7ee:	0b 00 00 
        base.s.size = 0;
 7f1:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 7f8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7fb:	89 c8                	mov    %ecx,%eax
 7fd:	eb a4                	jmp    7a3 <pmalloc+0x33>
 7ff:	90                   	nop
...
int protect_page(void* ap)
{
 ...
 808:	74 1e                	je     828 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 80a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 80f:	75 17                	jne    828 <protect_page+0x28>
            return -1;
 ...
 815:	74 11                	je     828 <protect_page+0x28>
            return -1;

        p->protected = 1;
 817:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
...
int pfree(void* ap) {
 ...
 838:	74 1e                	je     858 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 83a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 83f:	75 17                	jne    858 <pfree+0x28>
            return -1;
 ...
 845:	74 11                	je     858 <pfree+0x28>
            free(ap);
 847:	50                   	push   %eax
 848:	e8 a3 fd ff ff       	call   5f0 <free>
            return 1;
 84d:	58                   	pop    %eax
