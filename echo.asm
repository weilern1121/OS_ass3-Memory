...
main(int argc, char *argv[])
{
  ...
  28:	68 50 08 00 00       	push   $0x850
  2d:	50                   	push   %eax
  2e:	68 52 08 00 00       	push   $0x852
  33:	6a 01                	push   $0x1
  ...
  47:	68 57 08 00 00       	push   $0x857
  4c:	50                   	push   %eax
  4d:	68 52 08 00 00       	push   $0x852
  52:	6a 01                	push   $0x1
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 59 08 00 00       	mov    $0x859,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 a0 0b 00 00       	mov    %eax,0xba0
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
 ...
 67c:	3d 00 10 00 00       	cmp    $0x1000,%eax
 681:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
 ...
 68b:	50                   	push   %eax
 68c:	e8 b9 fc ff ff       	call   34a <sbrk>
  if(p == (char*)-1)
 691:	83 c4 10             	add    $0x10,%esp
 694:	83 f8 ff             	cmp    $0xffffffff,%eax
 697:	74 1f                	je     6b8 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 6a2:	50                   	push   %eax
 6a3:	e8 38 ff ff ff       	call   5e0 <free>
  return freep;
 6a8:	a1 a0 0b 00 00       	mov    0xba0,%eax
 ...
 6ba:	eb f4                	jmp    6b0 <morecore+0x40>
...
malloc(uint nbytes)
{
 ...
 6ca:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6cd:	a1 a0 0b 00 00       	mov    0xba0,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 6d2:	c1 eb 03             	shr    $0x3,%ebx
 6d5:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
 6d8:	85 c0                	test   %eax,%eax
 6da:	74 54                	je     730 <malloc+0x70>
 ...
 6e5:	39 d9                	cmp    %ebx,%ecx
 6e7:	73 27                	jae    710 <malloc+0x50>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
 6e9:	39 15 a0 0b 00 00    	cmp    %edx,0xba0
 6ef:	89 d0                	mov    %edx,%eax
 6f1:	75 ed                	jne    6e0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 6f3:	89 d8                	mov    %ebx,%eax
 6f5:	e8 76 ff ff ff       	call   670 <morecore>
 6fa:	85 c0                	test   %eax,%eax
 6fc:	75 e2                	jne    6e0 <malloc+0x20>
                return 0;
    }
}
 6fe:	83 c4 04             	add    $0x4,%esp
                return 0;
 ...
 709:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits)
 710:	39 cb                	cmp    %ecx,%ebx
 712:	74 44                	je     758 <malloc+0x98>
                p->s.size -= nunits;
 714:	29 d9                	sub    %ebx,%ecx
 716:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 719:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 71c:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
 71f:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 724:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
 727:	8d 42 08             	lea    0x8(%edx),%eax
}
 72a:	5b                   	pop    %ebx
 72b:	5d                   	pop    %ebp
 72c:	c3                   	ret    
 72d:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
 730:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 737:	0b 00 00 
 73a:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 741:	0b 00 00 
        base.s.size = 0;
 744:	ba a4 0b 00 00       	mov    $0xba4,%edx
 749:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 750:	00 00 00 
 753:	eb 94                	jmp    6e9 <malloc+0x29>
 755:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
 758:	8b 0a                	mov    (%edx),%ecx
 75a:	89 08                	mov    %ecx,(%eax)
 75c:	eb c1                	jmp    71f <malloc+0x5f>
...
pmalloc()
{
 ...
 763:	83 ec 08             	sub    $0x8,%esp
    ...
    if((prevp = freep) == 0){
 766:	8b 0d a0 0b 00 00    	mov    0xba0,%ecx
 76c:	85 c9                	test   %ecx,%ecx
 76e:	74 58                	je     7c8 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 770:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
 772:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
 779:	75 18                	jne    793 <pmalloc+0x33>
 77b:	eb 2c                	jmp    7a9 <pmalloc+0x49>
 77d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 780:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 782:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 789:	74 22                	je     7ad <pmalloc+0x4d>
 78b:	8b 0d a0 0b 00 00    	mov    0xba0,%ecx
 791:	89 d0                	mov    %edx,%eax
        ...
        if(p == freep)
 793:	39 c1                	cmp    %eax,%ecx
 795:	75 e9                	jne    780 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
 797:	b8 01 02 00 00       	mov    $0x201,%eax
 79c:	e8 cf fe ff ff       	call   670 <morecore>
 7a1:	85 c0                	test   %eax,%eax
 7a3:	75 db                	jne    780 <pmalloc+0x20>
                return 0;
 ...
 7ad:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
 7af:	a3 a0 0b 00 00       	mov    %eax,0xba0
            prevp->s.ptr = p->s.ptr;
 7b4:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
 7b6:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
 7bd:	8d 42 08             	lea    0x8(%edx),%eax
}
 7c0:	c9                   	leave  
 7c1:	c3                   	ret    
 7c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
 7c8:	b9 a4 0b 00 00       	mov    $0xba4,%ecx
        base.s.ptr = freep = prevp = &base;
 7cd:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 7d4:	0b 00 00 
 7d7:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 7de:	0b 00 00 
        base.s.size = 0;
 7e1:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 7e8:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7eb:	89 c8                	mov    %ecx,%eax
 7ed:	eb a4                	jmp    793 <pmalloc+0x33>
 7ef:	90                   	nop

000007f0 <protect_page>:
...
int protect_page(void* ap)
{
 ...
 7f8:	74 1e                	je     818 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
 7fa:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7ff:	75 17                	jne    818 <protect_page+0x28>
            return -1;
 ...
 805:	74 11                	je     818 <protect_page+0x28>
            return -1;

        p->protected = 1;
 807:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
 80d:	b8 01 00 00 00       	mov    $0x1,%eax
    }
    else
        return -1;
}
 ...
 814:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        return -1;
 818:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 81d:	5d                   	pop    %ebp
 81e:	c3                   	ret    
 81f:	90                   	nop
...
int pfree(void* ap) {
 ...
 828:	74 1e                	je     848 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
 82a:	a9 ff 0f 00 00       	test   $0xfff,%eax
 82f:	75 17                	jne    848 <pfree+0x28>
            return -1;
 ...
 835:	74 11                	je     848 <pfree+0x28>
            free(ap);
 837:	50                   	push   %eax
 838:	e8 a3 fd ff ff       	call   5e0 <free>
            return 1;
 83d:	58                   	pop    %eax
 83e:	b8 01 00 00 00       	mov    $0x1,%eax
        }
    }
    return -1;
}
