...
main(int argc, char *argv[])
{
  ...
  28:	68 88 0a 00 00       	push   $0xa88
  2d:	50                   	push   %eax
  2e:	68 8a 0a 00 00       	push   $0xa8a
  33:	6a 01                	push   $0x1
  ...
  47:	68 cc 0a 00 00       	push   $0xacc
  4c:	50                   	push   %eax
  4d:	68 8a 0a 00 00       	push   $0xa8a
  52:	6a 01                	push   $0x1
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 98 0a 00 00 	movzbl 0xa98(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 8f 0a 00 00       	mov    $0xa8f,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 611:	a1 68 0e 00 00       	mov    0xe68,%eax
free(void *ap) {
 ...
 64d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 64f:	a3 68 0e 00 00       	mov    %eax,0xe68
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 654:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 68a:	a3 68 0e 00 00       	mov    %eax,0xe68
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6ac:	8b 15 68 0e 00 00    	mov    0xe68,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
        ...
        if (p == freep)
 6f1:	39 05 68 0e 00 00    	cmp    %eax,0xe68
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
    return freep;
 71b:	8b 15 68 0e 00 00    	mov    0xe68,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 747:	89 15 68 0e 00 00    	mov    %edx,0xe68
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 760:	c7 05 68 0e 00 00 6c 	movl   $0xe6c,0xe68
 767:	0e 00 00 
 76a:	c7 05 6c 0e 00 00 6c 	movl   $0xe6c,0xe6c
 771:	0e 00 00 
        base.s.size = 0;
 774:	b8 6c 0e 00 00       	mov    $0xe6c,%eax
 779:	c7 05 70 0e 00 00 00 	movl   $0x0,0xe70
 780:	00 00 00 
...
pmalloc(void) {
 ...
 7a8:	6a 10                	push   $0x10
 7aa:	e8 f1 fe ff ff       	call   6a0 <malloc>
    char *tmpAdr = sbrk(4096); //point to the first free place
 7af:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    struct PMHeader *nh = malloc(sizeof(struct PMHeader));
 7b6:	89 c3                	mov    %eax,%ebx
    char *tmpAdr = sbrk(4096); //point to the first free place
 7b8:	e8 8d fb ff ff       	call   34a <sbrk>
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 7bd:	83 c4 10             	add    $0x10,%esp
 7c0:	a9 ff 0f 00 00       	test   $0xfff,%eax
    char *tmpAdr = sbrk(4096); //point to the first free place
 7c5:	89 c6                	mov    %eax,%esi
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 7c7:	74 03                	je     7cc <pmalloc+0x2c>
        *tmpAdr = (char) PGROUNDUP((int) tmpAdr);
 7c9:	c6 00 00             	movb   $0x0,(%eax)

    //init PMHeader
    nh->PMheaderID = nextID++;
 7cc:	a1 58 0e 00 00       	mov    0xe58,%eax
    nh->PMnext = 0;
 7d1:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nh->PMadress = tmpAdr;
 7d8:	89 73 04             	mov    %esi,0x4(%ebx)
    nh->PMprotectedPage = 0;
 7db:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    nh->PMheaderID = nextID++;
 7e2:	8d 50 01             	lea    0x1(%eax),%edx
 7e5:	89 15 58 0e 00 00    	mov    %edx,0xe58
 7eb:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 7ed:	8b 15 5c 0e 00 00    	mov    0xe5c,%edx
 7f3:	85 d2                	test   %edx,%edx
 7f5:	74 39                	je     830 <pmalloc+0x90>
 ...
 7f7:	a1 60 0e 00 00       	mov    0xe60,%eax
        tail = tail->PMnext;
 7fc:	89 1d 60 0e 00 00    	mov    %ebx,0xe60
        tail->PMnext = nh;
 802:	89 58 08             	mov    %ebx,0x8(%eax)
 805:	8b 43 04             	mov    0x4(%ebx),%eax
    }
    //turn PMflag on and W flag off
    turnOnW(nh->PMadress);//TODO
 808:	83 ec 0c             	sub    $0xc,%esp
 80b:	50                   	push   %eax
 80c:	e8 69 fb ff ff       	call   37a <turnOnW>
    turnOnPM(nh->PMadress);
 811:	58                   	pop    %eax
 812:	ff 73 04             	pushl  0x4(%ebx)
 815:	e8 48 fb ff ff       	call   362 <turnOnPM>
    //fresh PTE
    updatePTE();
 81a:	e8 6b fb ff ff       	call   38a <updatePTE>
    PMcounter++;
 81f:	83 05 5c 0e 00 00 01 	addl   $0x1,0xe5c
    if (DEBUGMODE == 3)
        printf(1, ">PMALLOC-DONE!\n");
    return tmpAdr;
}
 826:	8d 65 f8             	lea    -0x8(%ebp),%esp
 829:	89 f0                	mov    %esi,%eax
 82b:	5b                   	pop    %ebx
 82c:	5e                   	pop    %esi
 82d:	5d                   	pop    %ebp
 82e:	c3                   	ret    
 82f:	90                   	nop
        PMinit = nh; //set PMinit link
 830:	89 1d 64 0e 00 00    	mov    %ebx,0xe64
        tail = nh;
 836:	89 1d 60 0e 00 00    	mov    %ebx,0xe60
    char *tmpAdr = sbrk(4096); //point to the first free place
 83c:	89 f0                	mov    %esi,%eax
 83e:	eb c8                	jmp    808 <pmalloc+0x68>
...
protect_page(void *ap) {
 ...
 847:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    if (ap) {
 84a:	85 db                	test   %ebx,%ebx
 84c:	74 7a                	je     8c8 <protect_page+0x88>
        if ((int) ap % 4096 != 0) {
 84e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 854:	75 72                	jne    8c8 <protect_page+0x88>
            if (DEBUGMODE == 3)
 ...
 8b8:	53                   	push   %ebx
 8b9:	68 a9 0a 00 00       	push   $0xaa9
 8be:	6a 02                	push   $0x2
 8c0:	e8 7b fb ff ff       	call   440 <printf>
...
printPMList(void) {
 ...
 8e5:	8b 1d 64 0e 00 00    	mov    0xe64,%ebx
    printf(1, "\nPMlist:\t");
 8eb:	83 ec 08             	sub    $0x8,%esp
 8ee:	68 bd 0a 00 00       	push   $0xabd
 8f3:	6a 01                	push   $0x1
 8f5:	e8 46 fb ff ff       	call   440 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 8fa:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 8ff:	83 c4 10             	add    $0x10,%esp
 902:	85 c0                	test   %eax,%eax
 904:	7e 2d                	jle    933 <printPMList+0x53>
 906:	31 f6                	xor    %esi,%esi
 908:	90                   	nop
 909:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(2, "%d\t", tmp2->PMadress);
 910:	83 ec 04             	sub    $0x4,%esp
 913:	ff 73 04             	pushl  0x4(%ebx)
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 916:	83 c6 01             	add    $0x1,%esi
        printf(2, "%d\t", tmp2->PMadress);
 919:	68 c7 0a 00 00       	push   $0xac7
 91e:	6a 02                	push   $0x2
 920:	e8 1b fb ff ff       	call   440 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 925:	83 c4 10             	add    $0x10,%esp
 928:	39 35 5c 0e 00 00    	cmp    %esi,0xe5c
 92e:	8b 5b 08             	mov    0x8(%ebx),%ebx
 931:	7f dd                	jg     910 <printPMList+0x30>
    printf(1, "\n\n");
 933:	83 ec 08             	sub    $0x8,%esp
 936:	68 cb 0a 00 00       	push   $0xacb
 93b:	6a 01                	push   $0x1
 93d:	e8 fe fa ff ff       	call   440 <printf>
}
 942:	83 c4 10             	add    $0x10,%esp
 945:	8d 65 f8             	lea    -0x8(%ebp),%esp
 948:	5b                   	pop    %ebx
 949:	5e                   	pop    %esi
 94a:	5d                   	pop    %ebp
 94b:	c3                   	ret    
...
checkIfPM(void *p) {
 ...
 950:	8b 15 5c 0e 00 00    	mov    0xe5c,%edx
    struct PMHeader *tmp = PMinit;
 956:	a1 64 0e 00 00       	mov    0xe64,%eax
    for (int i = 0; i < PMcounter; i++) {
 95b:	85 d2                	test   %edx,%edx
 95d:	7e 11                	jle    970 <checkIfPM+0x20>
checkIfPM(void *p) {
 95f:	55                   	push   %ebp
 960:	89 e5                	mov    %esp,%ebp
        if (tmp->PMadress == p)
 962:	8b 55 08             	mov    0x8(%ebp),%edx
 965:	39 50 04             	cmp    %edx,0x4(%eax)
            return 1;
    }
    return 0;
}
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 980:	a1 5c 0e 00 00       	mov    0xe5c,%eax
pfree(void *ap) {
 985:	55                   	push   %ebp
...
pfree(void *ap) {
 98c:	8b 75 08             	mov    0x8(%ebp),%esi
    if (ap) {
 98f:	74 1b                	je     9ac <pfree+0x2c>
 991:	85 f6                	test   %esi,%esi
 993:	74 17                	je     9ac <pfree+0x2c>
        struct PMHeader *PMap = PMinit;
        struct PMHeader *tmp = PMinit;
        //check aligned
        if ((int) ap % 4096 != 0) {
 995:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 99b:	8b 1d 64 0e 00 00    	mov    0xe64,%ebx
        if ((int) ap % 4096 != 0) {
 9a1:	75 09                	jne    9ac <pfree+0x2c>
    for (int i = 0; i < PMcounter; i++) {
 9a3:	85 c0                	test   %eax,%eax
 9a5:	7e 05                	jle    9ac <pfree+0x2c>
        if (tmp->PMadress == p)
 9a7:	3b 73 04             	cmp    0x4(%ebx),%esi
 9aa:	74 14                	je     9c0 <pfree+0x40>
            return -1;
        }
    }
    if (DEBUGMODE == 3)
    ...
    return -1;
 9ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 9b1:	8d 65 f8             	lea    -0x8(%ebp),%esp
 9b4:	5b                   	pop    %ebx
 9b5:	5e                   	pop    %esi
 9b6:	5d                   	pop    %ebp
 9b7:	c3                   	ret    
 ...
 9c3:	53                   	push   %ebx
 9c4:	e8 a9 f9 ff ff       	call   372 <turnOffW>
            turnOffPM(PMap);
 9c9:	89 1c 24             	mov    %ebx,(%esp)
 9cc:	e8 b1 f9 ff ff       	call   382 <turnOffPM>
            updatePTE();
 9d1:	e8 b4 f9 ff ff       	call   38a <updatePTE>
            PMcounter--;
 9d6:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 ...
 9e1:	85 c0                	test   %eax,%eax
            PMcounter--;
 9e3:	a3 5c 0e 00 00       	mov    %eax,0xe5c
            if (PMcounter == 0) {//if true ->reset PMlist
 9e8:	74 46                	je     a30 <pfree+0xb0>
 9ea:	89 d8                	mov    %ebx,%eax
 9ec:	eb 08                	jmp    9f6 <pfree+0x76>
 9ee:	66 90                	xchg   %ax,%ax
                while (PMap->PMnext != 0 && PMap->PMadress != ap)
 9f0:	39 ce                	cmp    %ecx,%esi
 9f2:	74 10                	je     a04 <pfree+0x84>
 9f4:	89 d0                	mov    %edx,%eax
 9f6:	8b 50 08             	mov    0x8(%eax),%edx
 9f9:	8b 48 04             	mov    0x4(%eax),%ecx
 9fc:	85 d2                	test   %edx,%edx
 9fe:	75 f0                	jne    9f0 <pfree+0x70>
                if (PMap->PMadress != ap) {
 a00:	39 ce                	cmp    %ecx,%esi
 a02:	75 65                	jne    a69 <pfree+0xe9>
                if (tmp->PMheaderID == PMap->PMheaderID) {//happens when both point on the first link
 a04:	8b 08                	mov    (%eax),%ecx
 a06:	39 0b                	cmp    %ecx,(%ebx)
 a08:	75 08                	jne    a12 <pfree+0x92>
 a0a:	eb 44                	jmp    a50 <pfree+0xd0>
 a0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 a10:	89 c3                	mov    %eax,%ebx
                    while (tmp->PMnext->PMheaderID != PMap->PMheaderID)
 a12:	8b 43 08             	mov    0x8(%ebx),%eax
 a15:	3b 08                	cmp    (%eax),%ecx
 a17:	75 f7                	jne    a10 <pfree+0x90>
                    tmp->PMnext = PMap->PMnext;
 a19:	89 53 08             	mov    %edx,0x8(%ebx)
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 a30:	c7 05 64 0e 00 00 00 	movl   $0x0,0xe64
 a37:	00 00 00 
                tail = 0;
 a3a:	c7 05 60 0e 00 00 00 	movl   $0x0,0xe60
 a41:	00 00 00 
}
 ...
 a50:	a1 64 0e 00 00       	mov    0xe64,%eax
 a55:	8b 40 08             	mov    0x8(%eax),%eax
 a58:	a3 64 0e 00 00       	mov    %eax,0xe64
}
 ...
 a6c:	56                   	push   %esi
 a6d:	68 a9 0a 00 00       	push   $0xaa9
 a72:	6a 02                	push   $0x2
 a74:	e8 c7 f9 ff ff       	call   440 <printf>
                    return -1;
 a79:	83 c4 10             	add    $0x10,%esp
 a7c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a81:	e9 2b ff ff ff       	jmp    9b1 <pfree+0x31>
