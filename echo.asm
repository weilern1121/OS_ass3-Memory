...
main(int argc, char *argv[])
{
  ...
  47:	68 53 08 00 00       	push   $0x853
  4c:	ff 74 b7 fc          	pushl  -0x4(%edi,%esi,4)
  50:	68 4e 08 00 00       	push   $0x84e
  55:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 55 08 00 00       	mov    $0x855,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 9c 0b 00 00       	mov    0xb9c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 9c 0b 00 00       	mov    %eax,0xb9c
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 9c 0b 00 00       	mov    %eax,0xb9c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
 ...
 644:	83 ec 04             	sub    $0x4,%esp
  ...
  if(nu < 4096)
 647:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 64c:	76 3a                	jbe    688 <morecore+0x48>
 64e:	89 c3                	mov    %eax,%ebx
 650:	8d 04 c5 00 00 00 00 	lea    0x0(,%eax,8),%eax
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
 657:	83 ec 0c             	sub    $0xc,%esp
 65a:	50                   	push   %eax
 65b:	e8 da fc ff ff       	call   33a <sbrk>
  if(p == (char*)-1)
 660:	83 c4 10             	add    $0x10,%esp
 663:	83 f8 ff             	cmp    $0xffffffff,%eax
 666:	74 30                	je     698 <morecore+0x58>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 671:	50                   	push   %eax
 672:	e8 39 ff ff ff       	call   5b0 <free>
  return freep;
 677:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 ...
 688:	b8 00 80 00 00       	mov    $0x8000,%eax
{
 ...
 692:	eb c3                	jmp    657 <morecore+0x17>
 694:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  p = sbrk(nu * sizeof(Header));
  if(p == (char*)-1)
    return 0;
 698:	31 c0                	xor    %eax,%eax
 69a:	eb e3                	jmp    67f <morecore+0x3f>
...
malloc(uint nbytes)
{
 ...
 6aa:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
 6ad:	a1 9c 0b 00 00       	mov    0xb9c,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
 ...
 6c7:	76 1f                	jbe    6e8 <malloc+0x48>
        ...
        if(p == freep)
 6c9:	39 15 9c 0b 00 00    	cmp    %edx,0xb9c
 6cf:	89 d0                	mov    %edx,%eax
 6d1:	75 ed                	jne    6c0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
 6d3:	89 d8                	mov    %ebx,%eax
 6d5:	e8 66 ff ff ff       	call   640 <morecore>
 6da:	85 c0                	test   %eax,%eax
 6dc:	75 e2                	jne    6c0 <malloc+0x20>
                return 0;
 6de:	31 c0                	xor    %eax,%eax
 6e0:	eb 1d                	jmp    6ff <malloc+0x5f>
 6e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size >= nunits){
            if(p->s.size == nunits)
 6e8:	39 cb                	cmp    %ecx,%ebx
 6ea:	74 1c                	je     708 <malloc+0x68>
                prevp->s.ptr = p->s.ptr;
            else {
                p->s.size -= nunits;
 6ec:	29 d9                	sub    %ebx,%ecx
 6ee:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
 6f1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
 6f4:	89 5a 04             	mov    %ebx,0x4(%edx)
            }
            freep = prevp;
 6f7:	a3 9c 0b 00 00       	mov    %eax,0xb9c
            return (void*)(p + 1);
 6fc:	8d 42 08             	lea    0x8(%edx),%eax
        }
        if(p == freep)
            if((p = morecore(nunits)) == 0)
                return 0;
 ...
 705:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size >= nunits){
            if(p->s.size == nunits)
                prevp->s.ptr = p->s.ptr;
 708:	8b 0a                	mov    (%edx),%ecx
 70a:	89 08                	mov    %ecx,(%eax)
 70c:	eb e9                	jmp    6f7 <malloc+0x57>
    Header *p, *prevp;
    uint nunits;
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 70e:	c7 05 9c 0b 00 00 a0 	movl   $0xba0,0xb9c
 715:	0b 00 00 
 718:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 71f:	0b 00 00 
        base.s.size = 0;
 722:	ba a0 0b 00 00       	mov    $0xba0,%edx
 727:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 72e:	00 00 00 
 731:	eb 96                	jmp    6c9 <malloc+0x29>
...
pmalloc()
{
 ...
 744:	83 ec 04             	sub    $0x4,%esp
    ...
    if((prevp = freep) == 0){
 747:	a1 9c 0b 00 00       	mov    0xb9c,%eax
 74c:	85 c0                	test   %eax,%eax
 74e:	74 56                	je     7a6 <pmalloc+0x66>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 750:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
 752:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
 759:	74 25                	je     780 <pmalloc+0x40>
            (p+1)->x = 1;
            turnOnPM( (void *)( p + 1 ) );
            return (void*)(p + 1);
        }
        ...
        if(p == freep)
 75b:	39 15 9c 0b 00 00    	cmp    %edx,0xb9c
 761:	89 d0                	mov    %edx,%eax
 763:	75 eb                	jne    750 <pmalloc+0x10>
            if((p = morecore(nunits)) == 0)
 765:	b8 01 02 00 00       	mov    $0x201,%eax
 76a:	e8 d1 fe ff ff       	call   640 <morecore>
 76f:	85 c0                	test   %eax,%eax
 771:	75 dd                	jne    750 <pmalloc+0x10>
                return 0;
 773:	31 db                	xor    %ebx,%ebx
 775:	eb 28                	jmp    79f <pmalloc+0x5f>
 ...
 78d:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
 78f:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            turnOnPM( (void *)( p + 1 ) );
 796:	53                   	push   %ebx
 797:	e8 b6 fb ff ff       	call   352 <turnOnPM>
            return (void*)(p + 1);
 ...
 7a5:	c3                   	ret    
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 9c 0b 00 00 a0 	movl   $0xba0,0xb9c
 7ad:	0b 00 00 
 7b0:	c7 05 a0 0b 00 00 a0 	movl   $0xba0,0xba0
 7b7:	0b 00 00 
        base.s.size = 0;
 7ba:	ba a0 0b 00 00       	mov    $0xba0,%edx
 7bf:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 7c6:	00 00 00 
 7c9:	eb 90                	jmp    75b <pmalloc+0x1b>
 7cb:	90                   	nop
...
protect_page(void* ap)
{
 ...
 7d8:	74 16                	je     7f0 <protect_page+0x20>
    {
        if( (uint)ap % 4096 != 0 )
 7da:	a9 ff 0f 00 00       	test   $0xfff,%eax
 7df:	75 0f                	jne    7f0 <protect_page+0x20>
        p = ap;
        return turnOffW( p );
    }
    else
 ...
 7e1:	5d                   	pop    %ebp
        ...
        p = ap;
        return turnOffW( p );
 7e2:	e9 7b fb ff ff       	jmp    362 <turnOffW>
 ...
 7f0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 7f5:	5d                   	pop    %ebp
 7f6:	c3                   	ret    
...
pfree(void* ap) {
 ...
 80c:	74 32                	je     840 <pfree+0x40>
        if ((uint) ap % 4096 != 0)
 80e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 814:	75 2a                	jne    840 <pfree+0x40>
            return -1;
 ...
 819:	53                   	push   %ebx
 81a:	e8 3b fb ff ff       	call   35a <checkOnPM>
 81f:	83 c4 10             	add    $0x10,%esp
 822:	85 c0                	test   %eax,%eax
 824:	74 1a                	je     840 <pfree+0x40>
            free(ap);
 826:	83 ec 0c             	sub    $0xc,%esp
 829:	53                   	push   %ebx
 82a:	e8 81 fd ff ff       	call   5b0 <free>
            return 1;
