...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d 02 1a 00 00 20 	cmpb   $0x20,0x1a02
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 00 1a 00 00       	push   $0x1a00
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 00 1a 00 00 63 	cmpb   $0x63,0x1a00
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 01 1a 00 00 64 	cmpb   $0x64,0x1a01
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 03 1a 00 00       	push   $0x1a03
      ec:	68 49 13 00 00       	push   $0x1349
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 a0 12 00 00       	push   $0x12a0
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 3d 13 00 00       	push   $0x133d
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 58 13 00 00 	jmp    *0x1358(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 aa 12 00 00       	push   $0x12aa
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 ba 12 00 00       	push   $0x12ba
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 a3 12 00 00       	push   $0x12a3
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 ca 12 00 00       	push   $0x12ca
     ...
     2d8:	68 cf 12 00 00       	push   $0x12cf
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 ca 12 00 00       	push   $0x12ca
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     337:	6a 54                	push   $0x54
     339:	e8 d2 0d 00 00       	call   1110 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3b7:	6a 0c                	push   $0xc
     3b9:	e8 52 0d 00 00       	call   1110 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3f7:	6a 0c                	push   $0xc
     3f9:	e8 12 0d 00 00       	call   1110 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     437:	6a 08                	push   $0x8
     439:	e8 d2 0c 00 00       	call   1110 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 e8 19 00 00       	push   $0x19e8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 e8 19 00 00       	push   $0x19e8
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 e0 19 00 00       	push   $0x19e0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 e8 19 00 00       	push   $0x19e8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 e8 19 00 00       	push   $0x19e8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 f1 12 00 00       	push   $0x12f1
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 d4 12 00 00       	push   $0x12d4
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 f4 12 00 00       	push   $0x12f4
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 0b 13 00 00       	push   $0x130b
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 fd 12 00 00       	push   $0x12fd
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 f6 12 00 00       	push   $0x12f6
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 10 13 00 00       	push   $0x1310
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 12 13 00 00       	push   $0x1312
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 0e 13 00 00       	push   $0x130e
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 f4 12 00 00       	push   $0x12f4
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 30 13 00 00       	push   $0x1330
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 70 13 00 00 	jmp    *0x1370(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 b9 12 00 00       	push   $0x12b9
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 32 13 00 00       	push   $0x1332
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 f6 12 00 00 	movl   $0x12f6,(%esp)
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 90 13 00 00 	movzbl 0x1390(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb 88 13 00 00       	mov    $0x1388,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1031:	a1 64 1a 00 00       	mov    0x1a64,%eax
{
  ...
  freep = p;
    106f:	a3 64 1a 00 00       	mov    %eax,0x1a64
}
    1074:	5b                   	pop    %ebx
    1075:	5e                   	pop    %esi
    1076:	5f                   	pop    %edi
    ...
    1086:	72 ce                	jb     1056 <free+0x26>
{
  ...
  freep = p;
    10aa:	a3 64 1a 00 00       	mov    %eax,0x1a64
    p->s.size += bp->s.size;
...
morecore(uint nu)
{
    ...
    10c3:	53                   	push   %ebx
    10c4:	bb 00 10 00 00       	mov    $0x1000,%ebx
    10c9:	83 ec 10             	sub    $0x10,%esp
    10cc:	3d 00 10 00 00       	cmp    $0x1000,%eax
    10d1:	0f 43 d8             	cmovae %eax,%ebx
  char *p;
  Header *hp;
  ...
  p = sbrk(nu * sizeof(Header));
    10d4:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    10db:	50                   	push   %eax
    10dc:	e8 b9 fc ff ff       	call   d9a <sbrk>
  if(p == (char*)-1)
    10e1:	83 c4 10             	add    $0x10,%esp
    10e4:	83 f8 ff             	cmp    $0xffffffff,%eax
    10e7:	74 1f                	je     1108 <morecore+0x48>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    10e9:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    10ec:	83 ec 0c             	sub    $0xc,%esp
    10ef:	83 c0 08             	add    $0x8,%eax
    10f2:	50                   	push   %eax
    10f3:	e8 38 ff ff ff       	call   1030 <free>
  return freep;
    10f8:	a1 64 1a 00 00       	mov    0x1a64,%eax
    ...
    110a:	eb f4                	jmp    1100 <morecore+0x40>
...
malloc(uint nbytes)
{
    ...
    111a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
    111d:	a1 64 1a 00 00       	mov    0x1a64,%eax
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1122:	c1 eb 03             	shr    $0x3,%ebx
    1125:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
    1128:	85 c0                	test   %eax,%eax
    112a:	74 54                	je     1180 <malloc+0x70>
    112c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1130:	8b 10                	mov    (%eax),%edx
        if(p->s.size >= nunits){
    1132:	8b 4a 04             	mov    0x4(%edx),%ecx
    1135:	39 d9                	cmp    %ebx,%ecx
    1137:	73 27                	jae    1160 <malloc+0x50>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
    1139:	39 15 64 1a 00 00    	cmp    %edx,0x1a64
    113f:	89 d0                	mov    %edx,%eax
    1141:	75 ed                	jne    1130 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
    1143:	89 d8                	mov    %ebx,%eax
    1145:	e8 76 ff ff ff       	call   10c0 <morecore>
    114a:	85 c0                	test   %eax,%eax
    114c:	75 e2                	jne    1130 <malloc+0x20>
                return 0;
    }
}
    ...
    1159:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(p->s.size == nunits)
    1160:	39 cb                	cmp    %ecx,%ebx
    1162:	74 44                	je     11a8 <malloc+0x98>
                p->s.size -= nunits;
    1164:	29 d9                	sub    %ebx,%ecx
    1166:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
    1169:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
    116c:	89 5a 04             	mov    %ebx,0x4(%edx)
            freep = prevp;
    116f:	a3 64 1a 00 00       	mov    %eax,0x1a64
}
    1174:	83 c4 04             	add    $0x4,%esp
            return (void*)(p + 1);
    1177:	8d 42 08             	lea    0x8(%edx),%eax
}
    117a:	5b                   	pop    %ebx
    117b:	5d                   	pop    %ebp
    117c:	c3                   	ret    
    117d:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.ptr = freep = prevp = &base;
    1180:	c7 05 64 1a 00 00 68 	movl   $0x1a68,0x1a64
    1187:	1a 00 00 
    118a:	c7 05 68 1a 00 00 68 	movl   $0x1a68,0x1a68
    1191:	1a 00 00 
        base.s.size = 0;
    1194:	ba 68 1a 00 00       	mov    $0x1a68,%edx
    1199:	c7 05 6c 1a 00 00 00 	movl   $0x0,0x1a6c
    11a0:	00 00 00 
    11a3:	eb 94                	jmp    1139 <malloc+0x29>
    11a5:	8d 76 00             	lea    0x0(%esi),%esi
                prevp->s.ptr = p->s.ptr;
    11a8:	8b 0a                	mov    (%edx),%ecx
    11aa:	89 08                	mov    %ecx,(%eax)
    11ac:	eb c1                	jmp    116f <malloc+0x5f>
...
pmalloc()
{
    ...
    if((prevp = freep) == 0){
    11b6:	8b 0d 64 1a 00 00    	mov    0x1a64,%ecx
    11bc:	85 c9                	test   %ecx,%ecx
    11be:	74 58                	je     1218 <pmalloc+0x68>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11c0:	8b 01                	mov    (%ecx),%eax
        if(p->s.size == nunits){
    11c2:	81 78 04 01 02 00 00 	cmpl   $0x201,0x4(%eax)
    11c9:	75 18                	jne    11e3 <pmalloc+0x33>
    11cb:	eb 2c                	jmp    11f9 <pmalloc+0x49>
    11cd:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11d0:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
    11d2:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
    11d9:	74 22                	je     11fd <pmalloc+0x4d>
    11db:	8b 0d 64 1a 00 00    	mov    0x1a64,%ecx
    11e1:	89 d0                	mov    %edx,%eax
        ...
        if(p == freep)
    11e3:	39 c1                	cmp    %eax,%ecx
    11e5:	75 e9                	jne    11d0 <pmalloc+0x20>
            if((p = morecore(nunits)) == 0)
    11e7:	b8 01 02 00 00       	mov    $0x201,%eax
    11ec:	e8 cf fe ff ff       	call   10c0 <morecore>
    11f1:	85 c0                	test   %eax,%eax
    11f3:	75 db                	jne    11d0 <pmalloc+0x20>
                return 0;
    ...
    11fb:	89 c8                	mov    %ecx,%eax
            prevp->s.ptr = p->s.ptr;
    11fd:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
    11ff:	a3 64 1a 00 00       	mov    %eax,0x1a64
            prevp->s.ptr = p->s.ptr;
    1204:	89 08                	mov    %ecx,(%eax)
            (p+1)->x = 1;
    1206:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            return (void*)(p + 1);
    120d:	8d 42 08             	lea    0x8(%edx),%eax
}
    1210:	c9                   	leave  
    1211:	c3                   	ret    
    1212:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        base.s.size = 0;
    1218:	b9 68 1a 00 00       	mov    $0x1a68,%ecx
        base.s.ptr = freep = prevp = &base;
    121d:	c7 05 64 1a 00 00 68 	movl   $0x1a68,0x1a64
    1224:	1a 00 00 
    1227:	c7 05 68 1a 00 00 68 	movl   $0x1a68,0x1a68
    122e:	1a 00 00 
        base.s.size = 0;
    1231:	c7 05 6c 1a 00 00 00 	movl   $0x0,0x1a6c
    1238:	00 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    123b:	89 c8                	mov    %ecx,%eax
    123d:	eb a4                	jmp    11e3 <pmalloc+0x33>
    123f:	90                   	nop

00001240 <protect_page>:
...
int protect_page(void* ap)
{
    ...
    1248:	74 1e                	je     1268 <protect_page+0x28>
    {
        if( (uint)ap % 4096 != 0 )
    124a:	a9 ff 0f 00 00       	test   $0xfff,%eax
    124f:	75 17                	jne    1268 <protect_page+0x28>
            return -1;

        p = ap;
        if( !p->pmalloced )
    1251:	8b 10                	mov    (%eax),%edx
    1253:	85 d2                	test   %edx,%edx
    1255:	74 11                	je     1268 <protect_page+0x28>
            return -1;

        p->protected = 1;
    1257:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
        return 1;
...
int pfree(void* ap) {
    ...
    1278:	74 1e                	je     1298 <pfree+0x28>
        if ((uint) ap % 4096 != 0)
    127a:	a9 ff 0f 00 00       	test   $0xfff,%eax
    127f:	75 17                	jne    1298 <pfree+0x28>
            return -1;
    ...
    1285:	74 11                	je     1298 <pfree+0x28>
            free(ap);
    1287:	50                   	push   %eax
    1288:	e8 a3 fd ff ff       	call   1030 <free>
            return 1;
    128d:	58                   	pop    %eax
