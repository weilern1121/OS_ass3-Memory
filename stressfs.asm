...
0000045a <updatePTE>:
SYSCALL(updatePTE)
 45a:	b8 1c 00 00 00       	mov    $0x1c,%eax
 45f:	cd 40                	int    $0x40
 461:	c3                   	ret    
 ...
 479:	85 d2                	test   %edx,%edx
{
 ...
 4a7:	f7 f1                	div    %ecx
 4a9:	0f b6 92 84 0b 00 00 	movzbl 0xb84(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6c4:	e9 8f fe ff ff       	jmp    558 <printf+0x48>
          s = "(null)";
 6c9:	bb 7b 0b 00 00       	mov    $0xb7b,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 6e1:	a1 58 0f 00 00       	mov    0xf58,%eax
free(void *ap) {
 ...
 71d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 71f:	a3 58 0f 00 00       	mov    %eax,0xf58
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 724:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 75a:	a3 58 0f 00 00       	mov    %eax,0xf58
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 77c:	8b 15 58 0f 00 00    	mov    0xf58,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 7bf:	73 47                	jae    808 <malloc+0x98>
        ...
        if (p == freep)
 7c1:	39 05 58 0f 00 00    	cmp    %eax,0xf58
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
    return freep;
 7eb:	8b 15 58 0f 00 00    	mov    0xf58,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 817:	89 15 58 0f 00 00    	mov    %edx,0xf58
}
 ...
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 830:	c7 05 58 0f 00 00 5c 	movl   $0xf5c,0xf58
 837:	0f 00 00 
 83a:	c7 05 5c 0f 00 00 5c 	movl   $0xf5c,0xf5c
 841:	0f 00 00 
        base.s.size = 0;
 844:	b8 5c 0f 00 00       	mov    $0xf5c,%eax
 849:	c7 05 60 0f 00 00 00 	movl   $0x0,0xf60
 850:	00 00 00 
...
pmalloc(void) {
 ...
 878:	6a 10                	push   $0x10
 87a:	e8 f1 fe ff ff       	call   770 <malloc>
    char *tmpAdr = sbrk(4096); //point to the first free place
 87f:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    struct PMHeader *nh = malloc(sizeof(struct PMHeader));
 886:	89 c3                	mov    %eax,%ebx
    char *tmpAdr = sbrk(4096); //point to the first free place
 888:	e8 8d fb ff ff       	call   41a <sbrk>
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 88d:	83 c4 10             	add    $0x10,%esp
 890:	a9 ff 0f 00 00       	test   $0xfff,%eax
    char *tmpAdr = sbrk(4096); //point to the first free place
 895:	89 c6                	mov    %eax,%esi
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 897:	74 03                	je     89c <pmalloc+0x2c>
        *tmpAdr = (char) PGROUNDUP((int) tmpAdr);
 899:	c6 00 00             	movb   $0x0,(%eax)

    //init PMHeader
    nh->PMheaderID = nextID++;
 89c:	a1 48 0f 00 00       	mov    0xf48,%eax
    nh->PMnext = 0;
 8a1:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nh->PMadress = tmpAdr;
 8a8:	89 73 04             	mov    %esi,0x4(%ebx)
    nh->PMprotectedPage = 0;
 8ab:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    nh->PMheaderID = nextID++;
 8b2:	8d 50 01             	lea    0x1(%eax),%edx
 8b5:	89 15 48 0f 00 00    	mov    %edx,0xf48
 8bb:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 8bd:	8b 15 4c 0f 00 00    	mov    0xf4c,%edx
 8c3:	85 d2                	test   %edx,%edx
 8c5:	74 39                	je     900 <pmalloc+0x90>
        PMinit = nh; //set PMinit link
        tail = nh;
    } else { //else- add new page to the end of PMlist
        tail->PMnext = nh;
 8c7:	a1 50 0f 00 00       	mov    0xf50,%eax
        tail = tail->PMnext;
 8cc:	89 1d 50 0f 00 00    	mov    %ebx,0xf50
        tail->PMnext = nh;
 8d2:	89 58 08             	mov    %ebx,0x8(%eax)
 ...
 8db:	50                   	push   %eax
 8dc:	e8 69 fb ff ff       	call   44a <turnOnW>
    turnOnPM(nh->PMadress);
 8e1:	58                   	pop    %eax
 8e2:	ff 73 04             	pushl  0x4(%ebx)
 8e5:	e8 48 fb ff ff       	call   432 <turnOnPM>
    //fresh PTE
    updatePTE();
 8ea:	e8 6b fb ff ff       	call   45a <updatePTE>
    PMcounter++;
 8ef:	83 05 4c 0f 00 00 01 	addl   $0x1,0xf4c
    if (DEBUGMODE == 3)
        printf(1, ">PMALLOC-DONE!\n");
    return tmpAdr;
}
 8f6:	8d 65 f8             	lea    -0x8(%ebp),%esp
 8f9:	89 f0                	mov    %esi,%eax
 8fb:	5b                   	pop    %ebx
 8fc:	5e                   	pop    %esi
 8fd:	5d                   	pop    %ebp
 8fe:	c3                   	ret    
 8ff:	90                   	nop
        PMinit = nh; //set PMinit link
 900:	89 1d 54 0f 00 00    	mov    %ebx,0xf54
        tail = nh;
 906:	89 1d 50 0f 00 00    	mov    %ebx,0xf50
    char *tmpAdr = sbrk(4096); //point to the first free place
 90c:	89 f0                	mov    %esi,%eax
 90e:	eb c8                	jmp    8d8 <pmalloc+0x68>

00000910 <protect_page>:
...
protect_page(void *ap) {
 ...
 917:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    if (ap) {
 91a:	85 db                	test   %ebx,%ebx
 91c:	74 7a                	je     998 <protect_page+0x88>
        if ((int) ap % 4096 != 0) {
 91e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 924:	75 72                	jne    998 <protect_page+0x88>
            if (DEBUGMODE == 3)
 ...
 929:	53                   	push   %ebx
 92a:	e8 0b fb ff ff       	call   43a <checkOnPM>
 92f:	83 c4 10             	add    $0x10,%esp
 932:	85 c0                	test   %eax,%eax
 934:	74 62                	je     998 <protect_page+0x88>
            turnOffW(ap);
 936:	83 ec 0c             	sub    $0xc,%esp
 939:	53                   	push   %ebx
 93a:	e8 03 fb ff ff       	call   442 <turnOffW>
            updatePTE();
 93f:	e8 16 fb ff ff       	call   45a <updatePTE>
            updateProc(1); // protectedPages++
 944:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 94b:	e8 12 fb ff ff       	call   462 <updateProc>
            //turn on flag
            struct PMHeader *PMap = PMinit;
 950:	a1 54 0f 00 00       	mov    0xf54,%eax
            while (PMap->PMnext != 0 && PMap->PMadress != ap)
 955:	83 c4 10             	add    $0x10,%esp
 958:	eb 0c                	jmp    966 <protect_page+0x56>
 95a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 960:	39 cb                	cmp    %ecx,%ebx
 962:	74 10                	je     974 <protect_page+0x64>
 964:	89 d0                	mov    %edx,%eax
 966:	8b 50 08             	mov    0x8(%eax),%edx
 969:	8b 48 04             	mov    0x4(%eax),%ecx
 96c:	85 d2                	test   %edx,%edx
 96e:	75 f0                	jne    960 <protect_page+0x50>
                PMap = PMap->PMnext;
            if (PMap->PMadress != ap) {
 970:	39 cb                	cmp    %ecx,%ebx
 972:	75 11                	jne    985 <protect_page+0x75>
                printf(2, "PROBLEM with ap:%d\n", ap);
                return -1;
            }
            //got here ->MPap points the protected link
            PMap->PMprotectedPage = 1;//turn on FLAG
 974:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
            if (DEBUGMODE == 3)
 ...
 988:	53                   	push   %ebx
 989:	68 95 0b 00 00       	push   $0xb95
 98e:	6a 02                	push   $0x2
 990:	e8 7b fb ff ff       	call   510 <printf>
...
printPMList(void) {
 ...
 9b5:	8b 1d 54 0f 00 00    	mov    0xf54,%ebx
    printf(1, "\nPMlist:\t");
 9bb:	83 ec 08             	sub    $0x8,%esp
 9be:	68 a9 0b 00 00       	push   $0xba9
 9c3:	6a 01                	push   $0x1
 9c5:	e8 46 fb ff ff       	call   510 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 9ca:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 9cf:	83 c4 10             	add    $0x10,%esp
 9d2:	85 c0                	test   %eax,%eax
 9d4:	7e 2d                	jle    a03 <printPMList+0x53>
 ...
 9e6:	83 c6 01             	add    $0x1,%esi
        printf(2, "%d\t", tmp2->PMadress);
 9e9:	68 b3 0b 00 00       	push   $0xbb3
 9ee:	6a 02                	push   $0x2
 9f0:	e8 1b fb ff ff       	call   510 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 9f5:	83 c4 10             	add    $0x10,%esp
 9f8:	39 35 4c 0f 00 00    	cmp    %esi,0xf4c
 9fe:	8b 5b 08             	mov    0x8(%ebx),%ebx
 a01:	7f dd                	jg     9e0 <printPMList+0x30>
    printf(1, "\n\n");
 a03:	83 ec 08             	sub    $0x8,%esp
 a06:	68 b7 0b 00 00       	push   $0xbb7
 a0b:	6a 01                	push   $0x1
 a0d:	e8 fe fa ff ff       	call   510 <printf>
}
 a12:	83 c4 10             	add    $0x10,%esp
 a15:	8d 65 f8             	lea    -0x8(%ebp),%esp
 a18:	5b                   	pop    %ebx
 a19:	5e                   	pop    %esi
 a1a:	5d                   	pop    %ebp
 a1b:	c3                   	ret    
...
checkIfPM(void *p) {
 ...
 a20:	8b 15 4c 0f 00 00    	mov    0xf4c,%edx
    struct PMHeader *tmp = PMinit;
 a26:	a1 54 0f 00 00       	mov    0xf54,%eax
    for (int i = 0; i < PMcounter; i++) {
 a2b:	85 d2                	test   %edx,%edx
 a2d:	7e 11                	jle    a40 <checkIfPM+0x20>
checkIfPM(void *p) {
 a2f:	55                   	push   %ebp
 a30:	89 e5                	mov    %esp,%ebp
        if (tmp->PMadress == p)
 a32:	8b 55 08             	mov    0x8(%ebp),%edx
 a35:	39 50 04             	cmp    %edx,0x4(%eax)
            return 1;
    }
    return 0;
}
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 a50:	a1 4c 0f 00 00       	mov    0xf4c,%eax
pfree(void *ap) {
 a55:	55                   	push   %ebp
...
pfree(void *ap) {
 a5c:	8b 75 08             	mov    0x8(%ebp),%esi
    if (ap) {
 a5f:	74 1b                	je     a7c <pfree+0x2c>
 a61:	85 f6                	test   %esi,%esi
 a63:	74 17                	je     a7c <pfree+0x2c>
        struct PMHeader *PMap = PMinit;
        struct PMHeader *tmp = PMinit;
        //check aligned
        if ((int) ap % 4096 != 0) {
 a65:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 a6b:	8b 1d 54 0f 00 00    	mov    0xf54,%ebx
        if ((int) ap % 4096 != 0) {
 a71:	75 09                	jne    a7c <pfree+0x2c>
    for (int i = 0; i < PMcounter; i++) {
 a73:	85 c0                	test   %eax,%eax
 a75:	7e 05                	jle    a7c <pfree+0x2c>
        if (tmp->PMadress == p)
 a77:	3b 73 04             	cmp    0x4(%ebx),%esi
 a7a:	74 14                	je     a90 <pfree+0x40>
            return -1;
        }
    }
    if (DEBUGMODE == 3)
    ...
    return -1;
 a7c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 a81:	8d 65 f8             	lea    -0x8(%ebp),%esp
 a84:	5b                   	pop    %ebx
 a85:	5e                   	pop    %esi
 a86:	5d                   	pop    %ebp
 a87:	c3                   	ret    
 ...
 a93:	53                   	push   %ebx
 a94:	e8 a9 f9 ff ff       	call   442 <turnOffW>
            turnOffPM(PMap);
 a99:	89 1c 24             	mov    %ebx,(%esp)
 a9c:	e8 b1 f9 ff ff       	call   452 <turnOffPM>
            updatePTE();
 aa1:	e8 b4 f9 ff ff       	call   45a <updatePTE>
            PMcounter--;
 aa6:	a1 4c 0f 00 00       	mov    0xf4c,%eax
 ...
 ab1:	85 c0                	test   %eax,%eax
            PMcounter--;
 ab3:	a3 4c 0f 00 00       	mov    %eax,0xf4c
            if (PMcounter == 0) {//if true ->reset PMlist
 ab8:	74 46                	je     b00 <pfree+0xb0>
 aba:	89 d8                	mov    %ebx,%eax
 abc:	eb 08                	jmp    ac6 <pfree+0x76>
 abe:	66 90                	xchg   %ax,%ax
                while (PMap->PMnext != 0 && PMap->PMadress != ap)
 ac0:	39 ce                	cmp    %ecx,%esi
 ac2:	74 10                	je     ad4 <pfree+0x84>
 ac4:	89 d0                	mov    %edx,%eax
 ac6:	8b 50 08             	mov    0x8(%eax),%edx
 ac9:	8b 48 04             	mov    0x4(%eax),%ecx
 acc:	85 d2                	test   %edx,%edx
 ace:	75 f0                	jne    ac0 <pfree+0x70>
                if (PMap->PMadress != ap) {
 ad0:	39 ce                	cmp    %ecx,%esi
 ad2:	75 65                	jne    b39 <pfree+0xe9>
                if (tmp->PMheaderID == PMap->PMheaderID) {//happens when both point on the first link
 ad4:	8b 08                	mov    (%eax),%ecx
 ad6:	39 0b                	cmp    %ecx,(%ebx)
 ad8:	75 08                	jne    ae2 <pfree+0x92>
 ada:	eb 44                	jmp    b20 <pfree+0xd0>
 adc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 ae0:	89 c3                	mov    %eax,%ebx
                    while (tmp->PMnext->PMheaderID != PMap->PMheaderID)
 ae2:	8b 43 08             	mov    0x8(%ebx),%eax
 ae5:	3b 08                	cmp    (%eax),%ecx
 ae7:	75 f7                	jne    ae0 <pfree+0x90>
                    tmp->PMnext = PMap->PMnext;
 ae9:	89 53 08             	mov    %edx,0x8(%ebx)
}
 aec:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 aef:	b8 01 00 00 00       	mov    $0x1,%eax
}
 af4:	5b                   	pop    %ebx
 af5:	5e                   	pop    %esi
 af6:	5d                   	pop    %ebp
 ...
 af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 b00:	c7 05 54 0f 00 00 00 	movl   $0x0,0xf54
 b07:	00 00 00 
                tail = 0;
 b0a:	c7 05 50 0f 00 00 00 	movl   $0x0,0xf50
 b11:	00 00 00 
}
 b14:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 b20:	a1 54 0f 00 00       	mov    0xf54,%eax
 b25:	8b 40 08             	mov    0x8(%eax),%eax
 b28:	a3 54 0f 00 00       	mov    %eax,0xf54
}
 b2d:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 b3c:	56                   	push   %esi
 b3d:	68 95 0b 00 00       	push   $0xb95
 b42:	6a 02                	push   $0x2
 b44:	e8 c7 f9 ff ff       	call   510 <printf>
                    return -1;
 b49:	83 c4 10             	add    $0x10,%esp
 b4c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 b51:	e9 2b ff ff ff       	jmp    a81 <pfree+0x31>
