 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 50 0a 00 00 	movzbl 0xa50(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 48 0a 00 00       	mov    $0xa48,%ebx
        while(*s != 0){
...
free(void *ap) {
 ...
 5d1:	a1 18 0e 00 00       	mov    0xe18,%eax
free(void *ap) {
 ...
 60d:	89 08                	mov    %ecx,(%eax)
    freep = p;
 60f:	a3 18 0e 00 00       	mov    %eax,0xe18
    if (DEBUGMODE == 3)
        printf(1, ">FREE-DONE!\t");
}
 614:	5b                   	pop    %ebx
...
free(void *ap) {
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 64a:	a3 18 0e 00 00       	mov    %eax,0xe18
        p->s.size += bp->s.size;
...
malloc(uint nbytes) {
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 66c:	8b 15 18 0e 00 00    	mov    0xe18,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
        ...
        if (p == freep)
 6b1:	39 05 18 0e 00 00    	cmp    %eax,0xe18
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
    return freep;
 6db:	8b 15 18 0e 00 00    	mov    0xe18,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 707:	89 15 18 0e 00 00    	mov    %edx,0xe18
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 720:	c7 05 18 0e 00 00 1c 	movl   $0xe1c,0xe18
 727:	0e 00 00 
 72a:	c7 05 1c 0e 00 00 1c 	movl   $0xe1c,0xe1c
 731:	0e 00 00 
        base.s.size = 0;
 734:	b8 1c 0e 00 00       	mov    $0xe1c,%eax
 739:	c7 05 20 0e 00 00 00 	movl   $0x0,0xe20
 740:	00 00 00 
...
pmalloc(void) {
 ...
 768:	6a 10                	push   $0x10
 76a:	e8 f1 fe ff ff       	call   660 <malloc>
    char *tmpAdr = sbrk(4096); //point to the first free place
 76f:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    struct PMHeader *nh = malloc(sizeof(struct PMHeader));
 776:	89 c3                	mov    %eax,%ebx
    char *tmpAdr = sbrk(4096); //point to the first free place
 778:	e8 8d fb ff ff       	call   30a <sbrk>
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 77d:	83 c4 10             	add    $0x10,%esp
 780:	a9 ff 0f 00 00       	test   $0xfff,%eax
    char *tmpAdr = sbrk(4096); //point to the first free place
 785:	89 c6                	mov    %eax,%esi
    if ((int) tmpAdr % 4096 != 0) //if not align->fix this
 787:	74 03                	je     78c <pmalloc+0x2c>
        *tmpAdr = (char) PGROUNDUP((int) tmpAdr);
 789:	c6 00 00             	movb   $0x0,(%eax)

    //init PMHeader
    nh->PMheaderID = nextID++;
 78c:	a1 08 0e 00 00       	mov    0xe08,%eax
    nh->PMnext = 0;
 791:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nh->PMadress = tmpAdr;
 798:	89 73 04             	mov    %esi,0x4(%ebx)
    nh->PMprotectedPage = 0;
 79b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    nh->PMheaderID = nextID++;
 7a2:	8d 50 01             	lea    0x1(%eax),%edx
 7a5:	89 15 08 0e 00 00    	mov    %edx,0xe08
 7ab:	89 03                	mov    %eax,(%ebx)

    //if first-> PMpage=tail=nh
    if (PMcounter == 0) {
 7ad:	8b 15 0c 0e 00 00    	mov    0xe0c,%edx
 7b3:	85 d2                	test   %edx,%edx
 7b5:	74 39                	je     7f0 <pmalloc+0x90>
        PMinit = nh; //set PMinit link
        tail = nh;
    } else { //else- add new page to the end of PMlist
        tail->PMnext = nh;
 7b7:	a1 10 0e 00 00       	mov    0xe10,%eax
        tail = tail->PMnext;
 7bc:	89 1d 10 0e 00 00    	mov    %ebx,0xe10
        tail->PMnext = nh;
 7c2:	89 58 08             	mov    %ebx,0x8(%eax)
 7c5:	8b 43 04             	mov    0x4(%ebx),%eax
    }
    //turn PMflag on and W flag off
    turnOnW(nh->PMadress);//TODO
 7c8:	83 ec 0c             	sub    $0xc,%esp
 7cb:	50                   	push   %eax
 7cc:	e8 69 fb ff ff       	call   33a <turnOnW>
    turnOnPM(nh->PMadress);
 7d1:	58                   	pop    %eax
 7d2:	ff 73 04             	pushl  0x4(%ebx)
 7d5:	e8 48 fb ff ff       	call   322 <turnOnPM>
    //fresh PTE
    updatePTE();
 7da:	e8 6b fb ff ff       	call   34a <updatePTE>
    PMcounter++;
 7df:	83 05 0c 0e 00 00 01 	addl   $0x1,0xe0c
    if (DEBUGMODE == 3)
        printf(1, ">PMALLOC-DONE!\n");
    return tmpAdr;
}
 7e6:	8d 65 f8             	lea    -0x8(%ebp),%esp
 7e9:	89 f0                	mov    %esi,%eax
 7eb:	5b                   	pop    %ebx
 7ec:	5e                   	pop    %esi
 7ed:	5d                   	pop    %ebp
 7ee:	c3                   	ret    
 7ef:	90                   	nop
        PMinit = nh; //set PMinit link
 7f0:	89 1d 14 0e 00 00    	mov    %ebx,0xe14
        tail = nh;
 7f6:	89 1d 10 0e 00 00    	mov    %ebx,0xe10
    char *tmpAdr = sbrk(4096); //point to the first free place
 7fc:	89 f0                	mov    %esi,%eax
 7fe:	eb c8                	jmp    7c8 <pmalloc+0x68>

00000800 <protect_page>:
...
protect_page(void *ap) {
 ...
 80c:	74 7a                	je     888 <protect_page+0x88>
        if ((int) ap % 4096 != 0) {
 80e:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 814:	75 72                	jne    888 <protect_page+0x88>
            if (DEBUGMODE == 3)
 ...
 819:	53                   	push   %ebx
 81a:	e8 0b fb ff ff       	call   32a <checkOnPM>
 81f:	83 c4 10             	add    $0x10,%esp
 822:	85 c0                	test   %eax,%eax
 824:	74 62                	je     888 <protect_page+0x88>
            turnOffW(ap);
 826:	83 ec 0c             	sub    $0xc,%esp
 829:	53                   	push   %ebx
 82a:	e8 03 fb ff ff       	call   332 <turnOffW>
            updatePTE();
 82f:	e8 16 fb ff ff       	call   34a <updatePTE>
            updateProc(1); // protectedPages++
 834:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 83b:	e8 12 fb ff ff       	call   352 <updateProc>
            //turn on flag
            struct PMHeader *PMap = PMinit;
 840:	a1 14 0e 00 00       	mov    0xe14,%eax
            while (PMap->PMnext != 0 && PMap->PMadress != ap)
 845:	83 c4 10             	add    $0x10,%esp
 848:	eb 0c                	jmp    856 <protect_page+0x56>
 84a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 850:	39 cb                	cmp    %ecx,%ebx
 852:	74 10                	je     864 <protect_page+0x64>
 854:	89 d0                	mov    %edx,%eax
 856:	8b 50 08             	mov    0x8(%eax),%edx
 859:	8b 48 04             	mov    0x4(%eax),%ecx
 85c:	85 d2                	test   %edx,%edx
 85e:	75 f0                	jne    850 <protect_page+0x50>
                PMap = PMap->PMnext;
            if (PMap->PMadress != ap) {
 860:	39 cb                	cmp    %ecx,%ebx
 862:	75 11                	jne    875 <protect_page+0x75>
                printf(2, "PROBLEM with ap:%d\n", ap);
                return -1;
            }
            //got here ->MPap points the protected link
            PMap->PMprotectedPage = 1;//turn on FLAG
 864:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
            if (DEBUGMODE == 3)
 ...
 878:	53                   	push   %ebx
 879:	68 61 0a 00 00       	push   $0xa61
 87e:	6a 02                	push   $0x2
 880:	e8 7b fb ff ff       	call   400 <printf>
 ...
 890:	c9                   	leave  
 891:	c3                   	ret    
 892:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 899:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000008a0 <printPMList>:
...
printPMList(void) {
 ...
 8a5:	8b 1d 14 0e 00 00    	mov    0xe14,%ebx
    printf(1, "\nPMlist:\t");
 8ab:	83 ec 08             	sub    $0x8,%esp
 8ae:	68 75 0a 00 00       	push   $0xa75
 8b3:	6a 01                	push   $0x1
 8b5:	e8 46 fb ff ff       	call   400 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 8ba:	a1 0c 0e 00 00       	mov    0xe0c,%eax
 8bf:	83 c4 10             	add    $0x10,%esp
 8c2:	85 c0                	test   %eax,%eax
 8c4:	7e 2d                	jle    8f3 <printPMList+0x53>
 8c6:	31 f6                	xor    %esi,%esi
 8c8:	90                   	nop
 8c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(2, "%d\t", tmp2->PMadress);
 8d0:	83 ec 04             	sub    $0x4,%esp
 8d3:	ff 73 04             	pushl  0x4(%ebx)
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 8d6:	83 c6 01             	add    $0x1,%esi
        printf(2, "%d\t", tmp2->PMadress);
 8d9:	68 7f 0a 00 00       	push   $0xa7f
 8de:	6a 02                	push   $0x2
 8e0:	e8 1b fb ff ff       	call   400 <printf>
    for (int i = 0; i < PMcounter; i++, tmp2 = tmp2->PMnext)
 8e5:	83 c4 10             	add    $0x10,%esp
 8e8:	39 35 0c 0e 00 00    	cmp    %esi,0xe0c
 8ee:	8b 5b 08             	mov    0x8(%ebx),%ebx
 8f1:	7f dd                	jg     8d0 <printPMList+0x30>
    printf(1, "\n\n");
 8f3:	83 ec 08             	sub    $0x8,%esp
 8f6:	68 83 0a 00 00       	push   $0xa83
 8fb:	6a 01                	push   $0x1
 8fd:	e8 fe fa ff ff       	call   400 <printf>
}
...
checkIfPM(void *p) {
 ...
 910:	8b 15 0c 0e 00 00    	mov    0xe0c,%edx
    struct PMHeader *tmp = PMinit;
 916:	a1 14 0e 00 00       	mov    0xe14,%eax
    for (int i = 0; i < PMcounter; i++) {
 91b:	85 d2                	test   %edx,%edx
 91d:	7e 11                	jle    930 <checkIfPM+0x20>
checkIfPM(void *p) {
 91f:	55                   	push   %ebp
 920:	89 e5                	mov    %esp,%ebp
        if (tmp->PMadress == p)
 922:	8b 55 08             	mov    0x8(%ebp),%edx
 925:	39 50 04             	cmp    %edx,0x4(%eax)
            return 1;
    }
    return 0;
}
 928:	5d                   	pop    %ebp
        if (tmp->PMadress == p)
 929:	0f 94 c0             	sete   %al
 92c:	0f b6 c0             	movzbl %al,%eax
}
 92f:	c3                   	ret    
    return 0;
...
pfree(void *ap) {
    ...
    //validation check
    if (PMcounter == 0) {
 940:	a1 0c 0e 00 00       	mov    0xe0c,%eax
pfree(void *ap) {
 945:	55                   	push   %ebp
...
pfree(void *ap) {
 94c:	8b 75 08             	mov    0x8(%ebp),%esi
    if (ap) {
 94f:	74 1b                	je     96c <pfree+0x2c>
 951:	85 f6                	test   %esi,%esi
 953:	74 17                	je     96c <pfree+0x2c>
        struct PMHeader *PMap = PMinit;
        struct PMHeader *tmp = PMinit;
        //check aligned
        if ((int) ap % 4096 != 0) {
 955:	f7 c6 ff 0f 00 00    	test   $0xfff,%esi
        struct PMHeader *PMap = PMinit;
 95b:	8b 1d 14 0e 00 00    	mov    0xe14,%ebx
        if ((int) ap % 4096 != 0) {
 961:	75 09                	jne    96c <pfree+0x2c>
    for (int i = 0; i < PMcounter; i++) {
 963:	85 c0                	test   %eax,%eax
 965:	7e 05                	jle    96c <pfree+0x2c>
        if (tmp->PMadress == p)
 967:	3b 73 04             	cmp    0x4(%ebx),%esi
 96a:	74 14                	je     980 <pfree+0x40>
            return -1;
        }
    }
    if (DEBUGMODE == 3)
    ...
    return -1;
 96c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 971:	8d 65 f8             	lea    -0x8(%ebp),%esp
 974:	5b                   	pop    %ebx
 975:	5e                   	pop    %esi
 976:	5d                   	pop    %ebp
 977:	c3                   	ret    
 ...
 983:	53                   	push   %ebx
 984:	e8 a9 f9 ff ff       	call   332 <turnOffW>
            turnOffPM(PMap);
 989:	89 1c 24             	mov    %ebx,(%esp)
 98c:	e8 b1 f9 ff ff       	call   342 <turnOffPM>
            updatePTE();
 991:	e8 b4 f9 ff ff       	call   34a <updatePTE>
            PMcounter--;
 996:	a1 0c 0e 00 00       	mov    0xe0c,%eax
            if (PMcounter == 0) {//if true ->reset PMlist
 99b:	83 c4 10             	add    $0x10,%esp
            PMcounter--;
 99e:	83 e8 01             	sub    $0x1,%eax
            if (PMcounter == 0) {//if true ->reset PMlist
 9a1:	85 c0                	test   %eax,%eax
            PMcounter--;
 9a3:	a3 0c 0e 00 00       	mov    %eax,0xe0c
            if (PMcounter == 0) {//if true ->reset PMlist
 9a8:	74 46                	je     9f0 <pfree+0xb0>
 9aa:	89 d8                	mov    %ebx,%eax
 9ac:	eb 08                	jmp    9b6 <pfree+0x76>
 9ae:	66 90                	xchg   %ax,%ax
                while (PMap->PMnext != 0 && PMap->PMadress != ap)
 9b0:	39 ce                	cmp    %ecx,%esi
 9b2:	74 10                	je     9c4 <pfree+0x84>
 9b4:	89 d0                	mov    %edx,%eax
 9b6:	8b 50 08             	mov    0x8(%eax),%edx
 9b9:	8b 48 04             	mov    0x4(%eax),%ecx
 9bc:	85 d2                	test   %edx,%edx
 9be:	75 f0                	jne    9b0 <pfree+0x70>
                if (PMap->PMadress != ap) {
 9c0:	39 ce                	cmp    %ecx,%esi
 9c2:	75 65                	jne    a29 <pfree+0xe9>
                if (tmp->PMheaderID == PMap->PMheaderID) {//happens when both point on the first link
 9c4:	8b 08                	mov    (%eax),%ecx
 9c6:	39 0b                	cmp    %ecx,(%ebx)
 9c8:	75 08                	jne    9d2 <pfree+0x92>
 9ca:	eb 44                	jmp    a10 <pfree+0xd0>
 9cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 9d0:	89 c3                	mov    %eax,%ebx
                    while (tmp->PMnext->PMheaderID != PMap->PMheaderID)
 9d2:	8b 43 08             	mov    0x8(%ebx),%eax
 9d5:	3b 08                	cmp    (%eax),%ecx
 9d7:	75 f7                	jne    9d0 <pfree+0x90>
                    tmp->PMnext = PMap->PMnext;
 9d9:	89 53 08             	mov    %edx,0x8(%ebx)
}
 9dc:	8d 65 f8             	lea    -0x8(%ebp),%esp
            return 1;
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                PMinit = 0;
 9f0:	c7 05 14 0e 00 00 00 	movl   $0x0,0xe14
 9f7:	00 00 00 
                tail = 0;
 9fa:	c7 05 10 0e 00 00 00 	movl   $0x0,0xe10
 a01:	00 00 00 
}
 ...
 a10:	a1 14 0e 00 00       	mov    0xe14,%eax
 a15:	8b 40 08             	mov    0x8(%eax),%eax
 a18:	a3 14 0e 00 00       	mov    %eax,0xe14
}
 ...
 a2c:	56                   	push   %esi
 a2d:	68 61 0a 00 00       	push   $0xa61
 a32:	6a 02                	push   $0x2
 a34:	e8 c7 f9 ff ff       	call   400 <printf>
                    return -1;
 a39:	83 c4 10             	add    $0x10,%esp
 a3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a41:	e9 2b ff ff ff       	jmp    971 <pfree+0x31>
