...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
     126:	68 d0 3e 00 00       	push   $0x3ed0
     12b:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     131:	e8 ca 38 00 00       	call   3a00 <printf>

  if(mkdir("iputdir") < 0){
     136:	c7 04 24 63 3e 00 00 	movl   $0x3e63,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     14c:	68 63 3e 00 00       	push   $0x3e63
  ...
  if(unlink("../iputdir") < 0){
     ...
     164:	68 60 3e 00 00       	push   $0x3e60
  ...
  if(chdir("/") < 0){
     ...
     178:	68 85 3e 00 00       	push   $0x3e85
  ...
  printf(stdout, "iput test ok\n");
     ...
     18c:	68 08 3f 00 00       	push   $0x3f08
     191:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
     1a1:	50                   	push   %eax
     1a2:	50                   	push   %eax
     1a3:	68 3c 3e 00 00       	push   $0x3e3c
     1a8:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(chdir("/") < 0){
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 87 3e 00 00       	push   $0x3e87
     1bf:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 6b 3e 00 00       	push   $0x3e6b
     1d6:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 4a 3e 00 00       	push   $0x3e4a
     1ed:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     206:	68 97 3e 00 00       	push   $0x3e97
     20b:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     22b:	68 63 3e 00 00       	push   $0x3e63
    ...
    if(chdir("iputdir") < 0){
     ...
     243:	68 63 3e 00 00       	push   $0x3e63
    ...
    if(unlink("../iputdir") < 0){
     ...
     257:	68 60 3e 00 00       	push   $0x3e60
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     278:	68 ba 3e 00 00       	push   $0x3eba
     27d:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    ...
    if(unlink("../iputdir") < 0){
     ...
     293:	68 6b 3e 00 00       	push   $0x3e6b
     298:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 7d 4d 00 00       	push   $0x4d7d
     2af:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    ...
    if(chdir("iputdir") < 0){
     ...
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 a6 3e 00 00       	push   $0x3ea6
     2c6:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 3c 3e 00 00       	push   $0x3e3c
     2dd:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     2f6:	68 cc 3e 00 00       	push   $0x3ecc
     2fb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     301:	e8 fa 36 00 00       	call   3a00 <printf>
  if(mkdir("oidir") < 0){
     306:	c7 04 24 db 3e 00 00 	movl   $0x3edb,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     32f:	6a 02                	push   $0x2
     331:	68 db 3e 00 00       	push   $0x3edb
    ...
    if(fd >= 0){
     ...
     345:	68 60 4e 00 00       	push   $0x4e60
     34a:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("oidir") != 0){
     36a:	c7 04 24 db 3e 00 00 	movl   $0x3edb,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     385:	68 04 3f 00 00       	push   $0x3f04
     38a:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     ...
     3a0:	e8 fd 34 00 00       	call   38a2 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 e1 3e 00 00       	push   $0x3ee1
     3ac:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 7d 4d 00 00       	push   $0x4d7d
     3c3:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("oidir") != 0){
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 f5 3e 00 00       	push   $0x3ef5
     3da:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     3f6:	68 16 3f 00 00       	push   $0x3f16
     3fb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     401:	e8 fa 35 00 00       	call   3a00 <printf>
  fd = open("echo", 0);
     406:	58                   	pop    %eax
     407:	5a                   	pop    %edx
     408:	6a 00                	push   $0x0
     40a:	68 21 3f 00 00       	push   $0x3f21
  ...
  fd = open("doesnotexist", 0);
     ...
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 39 3f 00 00       	push   $0x3f39
  ...
  printf(stdout, "open test ok\n");
     ...
     43c:	68 64 3f 00 00       	push   $0x3f64
     441:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     451:	50                   	push   %eax
     452:	50                   	push   %eax
     453:	68 26 3f 00 00       	push   $0x3f26
     458:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 46 3f 00 00       	push   $0x3f46
     46f:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     488:	68 72 3f 00 00       	push   $0x3f72
     48d:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     493:	e8 68 35 00 00       	call   3a00 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     498:	59                   	pop    %ecx
     499:	5b                   	pop    %ebx
     49a:	68 02 02 00 00       	push   $0x202
     49f:	68 83 3f 00 00       	push   $0x3f83
  ...
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
     4bb:	68 89 3f 00 00       	push   $0x3f89
     4c0:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4d3:	6a 0a                	push   $0xa
     4d5:	68 c0 3f 00 00       	push   $0x3fc0
     4da:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ef:	6a 0a                	push   $0xa
     4f1:	68 cb 3f 00 00       	push   $0x3fcb
     4f6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     513:	68 d6 3f 00 00       	push   $0x3fd6
     518:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  fd = open("small", O_RDONLY);
     ...
     52c:	5a                   	pop    %edx
     52d:	6a 00                	push   $0x0
     52f:	68 83 3f 00 00       	push   $0x3f83
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     549:	68 e1 3f 00 00       	push   $0x3fe1
     54e:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  i = read(fd, buf, 2000);
     ...
     561:	68 60 87 00 00       	push   $0x8760
     566:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     57d:	68 15 40 00 00       	push   $0x4015
     582:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("small") < 0){
     595:	c7 04 24 83 3f 00 00 	movl   $0x3f83,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ab:	68 3d 40 00 00       	push   $0x403d
     5b0:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     5c8:	53                   	push   %ebx
     5c9:	68 84 4e 00 00       	push   $0x4e84
     5ce:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     5e1:	53                   	push   %ebx
     5e2:	68 a8 4e 00 00       	push   $0x4ea8
     5e7:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5fa:	68 fa 3f 00 00       	push   $0x3ffa
     5ff:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     612:	68 41 43 00 00       	push   $0x4341
     617:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     62a:	68 28 40 00 00       	push   $0x4028
     62f:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     642:	68 a4 3f 00 00       	push   $0x3fa4
     647:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 51 40 00 00       	push   $0x4051
     66d:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     67f:	68 cb 40 00 00       	push   $0x40cb
  ...
  for(i = 0; i < MAXFILE; i++){
    ((int*)buf)[0] = i;
     6a3:	89 1d 60 87 00 00    	mov    %ebx,0x8760
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 60 87 00 00       	push   $0x8760
     6b3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6dc:	5a                   	pop    %edx
     6dd:	6a 00                	push   $0x0
     6df:	68 cb 40 00 00       	push   $0x40cb
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 60 87 00 00       	mov    0x8760,%eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     71f:	68 60 87 00 00       	push   $0x8760
     724:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     746:	c7 04 24 cb 40 00 00 	movl   $0x40cb,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     760:	68 f2 40 00 00       	push   $0x40f2
     765:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     77d:	53                   	push   %ebx
     77e:	68 7b 40 00 00       	push   $0x407b
     783:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    ...
    if(((int*)buf)[0] != n){
     ...
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 cc 4e 00 00       	push   $0x4ecc
     79a:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     ...
     7ad:	50                   	push   %eax
     7ae:	68 cf 40 00 00       	push   $0x40cf
     7b3:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     7cb:	68 b2 40 00 00       	push   $0x40b2
     7d0:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     ...
     7e3:	68 99 40 00 00       	push   $0x4099
     7e8:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     ...
     7fb:	68 61 40 00 00       	push   $0x4061
     800:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     813:	68 df 40 00 00       	push   $0x40df
     818:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 ec 4e 00 00       	push   $0x4eec
     841:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     847:	e8 b4 31 00 00       	call   3a00 <printf>

  name[0] = 'a';
     84c:	c6 05 60 a7 00 00 61 	movb   $0x61,0xa760
  name[2] = '\0';
     853:	c6 05 62 a7 00 00 00 	movb   $0x0,0xa762
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     863:	88 1d 61 a7 00 00    	mov    %bl,0xa761
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 60 a7 00 00       	push   $0xa760
  ...
  name[0] = 'a';
     88b:	c6 05 60 a7 00 00 61 	movb   $0x61,0xa760
  name[2] = '\0';
     892:	c6 05 62 a7 00 00 00 	movb   $0x0,0xa762
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     8a3:	88 1d 61 a7 00 00    	mov    %bl,0xa761
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 60 a7 00 00       	push   $0xa760
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 14 4f 00 00       	push   $0x4f14
     8c6:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 00 41 00 00       	push   $0x4100
     8eb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     8f1:	e8 0a 31 00 00       	call   3a00 <printf>

  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 0c 41 00 00 	movl   $0x410c,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     90c:	68 0c 41 00 00       	push   $0x410c
  ...
  if(chdir("..") < 0){
     ...
     924:	68 b1 46 00 00       	push   $0x46b1
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 0c 41 00 00       	push   $0x410c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     94c:	68 49 41 00 00       	push   $0x4149
     951:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 3c 3e 00 00       	push   $0x3e3c
     968:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 35 41 00 00       	push   $0x4135
     97f:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 24 41 00 00       	push   $0x4124
     996:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 11 41 00 00       	push   $0x4111
     9ad:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 58 41 00 00       	push   $0x4158
     9cb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
     9d1:	e8 2a 30 00 00       	call   3a00 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 70 5f 00 00       	push   $0x5f70
     9dd:	68 21 3f 00 00       	push   $0x3f21
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 63 41 00 00       	push   $0x4163
     9f7:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 60 87 00 00       	push   $0x8760
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b 60 87 00 00 	cmp    %bl,0x8760(%ebx,%ecx,1)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aaa:	68 92 41 00 00       	push   $0x4192
     aaf:	6a 01                	push   $0x1
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ae0:	88 9c 18 60 87 00 00 	mov    %bl,0x8760(%eax,%ebx,1)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     af8:	68 60 87 00 00       	push   $0x8760
  ...
  printf(1, "pipe1 ok\n");
     b35:	58                   	pop    %eax
     b36:	5a                   	pop    %edx
     b37:	68 b7 41 00 00       	push   $0x41b7
     b3c:	6a 01                	push   $0x1
    ...
    if(total != 5 * 1033){
     ...
     b51:	68 a0 41 00 00       	push   $0x41a0
     b56:	6a 01                	push   $0x1
     ...
     b5d:	e8 40 2d 00 00       	call   38a2 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     b65:	68 75 41 00 00       	push   $0x4175
     b6a:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     ...
     b79:	68 c1 41 00 00       	push   $0x41c1
     b7e:	6a 01                	push   $0x1
    ...
    for(n = 0; n < 5; n++){
     ...
     b8d:	68 84 41 00 00       	push   $0x4184
     b92:	6a 01                	push   $0x1
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ba9:	68 d0 41 00 00       	push   $0x41d0
     bae:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bfa:	6a 01                	push   $0x1
     bfc:	68 95 47 00 00       	push   $0x4795
     ...
     c14:	68 da 41 00 00       	push   $0x41da
     c19:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c46:	68 60 87 00 00       	push   $0x8760
    ...
    printf(1, "preempt read error");
     ...
     c5e:	68 ee 41 00 00       	push   $0x41ee
     c63:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c80:	58                   	pop    %eax
     c81:	5a                   	pop    %edx
     c82:	68 01 42 00 00       	push   $0x4201
     c87:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     ca6:	59                   	pop    %ecx
     ca7:	5b                   	pop    %ebx
     ca8:	68 0a 42 00 00       	push   $0x420a
     cad:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cc3:	5e                   	pop    %esi
     cc4:	5f                   	pop    %edi
     cc5:	68 13 42 00 00       	push   $0x4213
     cca:	6a 01                	push   $0x1
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d0e:	68 7d 4d 00 00       	push   $0x4d7d
     d13:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     d2b:	68 1f 42 00 00       	push   $0x421f
     d30:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d4b:	68 2f 42 00 00       	push   $0x422f
     d50:	6a 01                	push   $0x1
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d79:	68 3c 42 00 00       	push   $0x423c
     d7e:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     df1:	58                   	pop    %eax
     df2:	5a                   	pop    %edx
     df3:	68 60 42 00 00       	push   $0x4260
     df8:	6a 01                	push   $0x1
    ...
    if(m1 == 0){
     ...
     e1b:	68 46 42 00 00       	push   $0x4246
     e20:	6a 01                	push   $0x1
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	68 68 4f 00 00       	push   $0x4f68
     ed1:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     efa:	5a                   	pop    %edx
     efb:	6a 00                	push   $0x0
     efd:	68 77 42 00 00       	push   $0x4277
  ...
  unlink("sharedfd");
     f6a:	c7 04 24 77 42 00 00 	movl   $0x4277,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f8f:	68 80 42 00 00       	push   $0x4280
     f94:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fa9:	68 3c 4f 00 00       	push   $0x4f3c
     fae:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fc3:	68 88 4f 00 00       	push   $0x4f88
     fc8:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fdf:	53                   	push   %ebx
     fe0:	52                   	push   %edx
     fe1:	68 8d 42 00 00       	push   $0x428d
     fe6:	6a 01                	push   $0x1
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    1006:	be a2 42 00 00       	mov    $0x42a2,%esi
...
fourfiles(void)
{
  ...
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1010:	c7 45 d8 a2 42 00 00 	movl   $0x42a2,-0x28(%ebp)
    1017:	c7 45 dc eb 43 00 00 	movl   $0x43eb,-0x24(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    101e:	68 a8 42 00 00       	push   $0x42a8
    1023:	6a 01                	push   $0x1
// time, to test block allocation.
void
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1025:	c7 45 e0 ef 43 00 00 	movl   $0x43ef,-0x20(%ebp)
    102c:	c7 45 e4 a5 42 00 00 	movl   $0x42a5,-0x1c(%ebp)
  char *fname;
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1081:	c7 45 d4 a2 42 00 00 	movl   $0x42a2,-0x2c(%ebp)
  }
  ...
  for(i = 0; i < 2; i++){
    ...
    10a8:	68 60 87 00 00       	push   $0x8760
    10ad:	56                   	push   %esi
    ...
    10bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(j = 0; j < n; j++){
        if(buf[j] != '0'+i){
    10c0:	0f be 8a 60 87 00 00 	movsbl 0x8760(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    1107:	68 e6 42 00 00       	push   $0x42e6
    110c:	6a 01                	push   $0x1
    ...
    112c:	68 c9 42 00 00       	push   $0x42c9
    1131:	6a 01                	push   $0x1
    ...
    1165:	68 60 87 00 00       	push   $0x8760
    ...
    117a:	68 60 87 00 00       	push   $0x8760
    117f:	56                   	push   %esi
    ...
    119c:	50                   	push   %eax
    119d:	68 b8 42 00 00       	push   $0x42b8
    11a2:	6a 01                	push   $0x1
    ...
    11b1:	68 43 45 00 00       	push   $0x4543
    11b6:	6a 01                	push   $0x1
    ...
    11c5:	53                   	push   %ebx
    11c6:	68 d5 42 00 00       	push   $0x42d5
    11cb:	6a 01                	push   $0x1
    ...
    11da:	68 7d 4d 00 00       	push   $0x4d7d
    11df:	6a 01                	push   $0x1
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    11fb:	68 f4 42 00 00       	push   $0x42f4
    1200:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    12fc:	68 07 43 00 00       	push   $0x4307
    1301:	6a 01                	push   $0x1
    ...
    1388:	68 f5 3e 00 00       	push   $0x3ef5
    138d:	6a 01                	push   $0x1
    ...
    13a8:	57                   	push   %edi
    13a9:	68 b4 4f 00 00       	push   $0x4fb4
    13ae:	6a 01                	push   $0x1
    ...
    13bd:	68 43 45 00 00       	push   $0x4543
    13c2:	6a 01                	push   $0x1
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    13d1:	68 7d 4d 00 00       	push   $0x4d7d
    13d6:	6a 01                	push   $0x1
    ...
    13ed:	57                   	push   %edi
    13ee:	68 d8 4f 00 00       	push   $0x4fd8
    13f3:	6a 01                	push   $0x1
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1408:	68 18 43 00 00       	push   $0x4318
    140d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    141b:	68 29 43 00 00       	push   $0x4329
  ...
  write(fd, "hello", 5);
    ...
    1435:	6a 05                	push   $0x5
    1437:	68 4e 43 00 00       	push   $0x434e
    143c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    144b:	5a                   	pop    %edx
    144c:	6a 02                	push   $0x2
    144e:	68 29 43 00 00       	push   $0x4329
  ...
  if(unlink("unlinkread") != 0){
    ...
    1468:	68 29 43 00 00       	push   $0x4329
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1485:	68 29 43 00 00       	push   $0x4329
  ...
  write(fd1, "yyy", 3);
    1494:	6a 03                	push   $0x3
    1496:	68 86 43 00 00       	push   $0x4386
    149b:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14b1:	68 60 87 00 00       	push   $0x8760
    14b6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14c8:	80 3d 60 87 00 00 68 	cmpb   $0x68,0x8760
  ...
  if(write(fd, buf, 10) != 10){
    ...
    14d4:	6a 0a                	push   $0xa
    14d6:	68 60 87 00 00       	push   $0x8760
    14db:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    14f2:	c7 04 24 29 43 00 00 	movl   $0x4329,(%esp)
    14f9:	e8 f4 23 00 00       	call   38f2 <unlink>
  printf(1, "unlinkread ok\n");
    14fe:	58                   	pop    %eax
    14ff:	5a                   	pop    %edx
    1500:	68 d1 43 00 00       	push   $0x43d1
    1505:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1516:	51                   	push   %ecx
    1517:	51                   	push   %ecx
    1518:	68 34 43 00 00       	push   $0x4334
    151d:	6a 01                	push   $0x1
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1529:	51                   	push   %ecx
    152a:	51                   	push   %ecx
    152b:	68 b8 43 00 00       	push   $0x43b8
    1530:	6a 01                	push   $0x1
  ...
  if(buf[0] != 'h'){
    ...
    153c:	53                   	push   %ebx
    153d:	53                   	push   %ebx
    153e:	68 a1 43 00 00       	push   $0x43a1
    1543:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    154f:	56                   	push   %esi
    1550:	56                   	push   %esi
    1551:	68 8a 43 00 00       	push   $0x438a
    1556:	6a 01                	push   $0x1
  ...
  if(unlink("unlinkread") != 0){
    ...
    1562:	50                   	push   %eax
    1563:	50                   	push   %eax
    1564:	68 6c 43 00 00       	push   $0x436c
    1569:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1575:	50                   	push   %eax
    1576:	50                   	push   %eax
    1577:	68 54 43 00 00       	push   $0x4354
    157c:	6a 01                	push   $0x1
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1597:	68 e0 43 00 00       	push   $0x43e0
    159c:	6a 01                	push   $0x1
    159e:	e8 5d 24 00 00       	call   3a00 <printf>

  unlink("lf1");
    15a3:	c7 04 24 ea 43 00 00 	movl   $0x43ea,(%esp)
    15aa:	e8 43 23 00 00       	call   38f2 <unlink>
  unlink("lf2");
    15af:	c7 04 24 ee 43 00 00 	movl   $0x43ee,(%esp)
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    15c2:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15dc:	6a 05                	push   $0x5
    15de:	68 4e 43 00 00       	push   $0x434e
    15e3:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    15fe:	5b                   	pop    %ebx
    15ff:	58                   	pop    %eax
    1600:	68 ee 43 00 00       	push   $0x43ee
    1605:	68 ea 43 00 00       	push   $0x43ea
  ...
  unlink("lf1");
    ...
    161d:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(open("lf1", 0) >= 0){
    ...
    1628:	5a                   	pop    %edx
    1629:	6a 00                	push   $0x0
    162b:	68 ea 43 00 00       	push   $0x43ea
  ...
  fd = open("lf2", 0);
    ...
    1643:	6a 00                	push   $0x0
    1645:	68 ee 43 00 00       	push   $0x43ee
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1664:	68 60 87 00 00       	push   $0x8760
    1669:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1684:	58                   	pop    %eax
    1685:	5a                   	pop    %edx
    1686:	68 ee 43 00 00       	push   $0x43ee
    168b:	68 ee 43 00 00       	push   $0x43ee
  ...
  unlink("lf2");
    ...
    16a3:	68 ee 43 00 00       	push   $0x43ee
    16a8:	e8 45 22 00 00       	call   38f2 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ad:	59                   	pop    %ecx
    16ae:	5b                   	pop    %ebx
    16af:	68 ea 43 00 00       	push   $0x43ea
    16b4:	68 ee 43 00 00       	push   $0x43ee
  ...
  if(link(".", "lf1") >= 0){
    ...
    16c8:	68 ea 43 00 00       	push   $0x43ea
    16cd:	68 b2 46 00 00       	push   $0x46b2
  ...
  printf(1, "linktest ok\n");
    ...
    16e1:	68 88 44 00 00       	push   $0x4488
    16e6:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    16f5:	50                   	push   %eax
    16f6:	50                   	push   %eax
    16f7:	68 f2 43 00 00       	push   $0x43f2
    16fc:	6a 01                	push   $0x1
  ...
  if(link(".", "lf1") >= 0){
    ...
    1708:	50                   	push   %eax
    1709:	50                   	push   %eax
    170a:	68 6c 44 00 00       	push   $0x446c
    170f:	6a 01                	push   $0x1
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    171b:	52                   	push   %edx
    171c:	52                   	push   %edx
    171d:	68 20 50 00 00       	push   $0x5020
    1722:	6a 01                	push   $0x1
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    172e:	50                   	push   %eax
    172f:	50                   	push   %eax
    1730:	68 4e 44 00 00       	push   $0x444e
    1735:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1741:	51                   	push   %ecx
    1742:	51                   	push   %ecx
    1743:	68 3d 44 00 00       	push   $0x443d
    1748:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1754:	53                   	push   %ebx
    1755:	53                   	push   %ebx
    1756:	68 2c 44 00 00       	push   $0x442c
    175b:	6a 01                	push   $0x1
  ...
  if(open("lf1", 0) >= 0){
    ...
    1767:	50                   	push   %eax
    1768:	50                   	push   %eax
    1769:	68 f8 4f 00 00       	push   $0x4ff8
    176e:	6a 01                	push   $0x1
  ...
  if(link("lf1", "lf2") < 0){
    ...
    177a:	51                   	push   %ecx
    177b:	51                   	push   %ecx
    177c:	68 17 44 00 00       	push   $0x4417
    1781:	6a 01                	push   $0x1
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    178d:	50                   	push   %eax
    178e:	50                   	push   %eax
    178f:	68 05 44 00 00       	push   $0x4405
    1794:	6a 01                	push   $0x1
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    17b3:	68 95 44 00 00       	push   $0x4495
    17b8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1870:	53                   	push   %ebx
    1871:	68 a8 44 00 00       	push   $0x44a8
    1876:	6a 01                	push   $0x1
    ...
    188b:	53                   	push   %ebx
    188c:	68 a5 44 00 00       	push   $0x44a5
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid && (i % 3) == 1){
      link("C0", file);
    18a6:	53                   	push   %ebx
    18a7:	68 a5 44 00 00       	push   $0x44a5
  ...
  fd = open(".", 0);
    ...
    18dc:	5e                   	pop    %esi
    18dd:	6a 00                	push   $0x0
    18df:	68 b2 46 00 00       	push   $0x46b2
  ...
  printf(1, "concreate ok\n");
    ...
    1a33:	68 fa 44 00 00       	push   $0x44fa
    1a38:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1a4a:	68 7d 4d 00 00       	push   $0x4d7d
    1a4f:	6a 01                	push   $0x1
  ...
  if(n != 40){
    ...
    1a5e:	68 44 50 00 00       	push   $0x5044
    1a63:	6a 01                	push   $0x1
    ...
    1a75:	50                   	push   %eax
    1a76:	68 dd 44 00 00       	push   $0x44dd
    1a7b:	6a 01                	push   $0x1
    ...
    1a8d:	50                   	push   %eax
    1a8e:	68 c4 44 00 00       	push   $0x44c4
    1a93:	6a 01                	push   $0x1
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1ab9:	68 08 45 00 00       	push   $0x4508
    1abe:	6a 01                	push   $0x1
    1ac0:	e8 3b 1f 00 00       	call   3a00 <printf>

  unlink("x");
    1ac5:	c7 04 24 95 47 00 00 	movl   $0x4795,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1b08:	68 95 47 00 00       	push   $0x4795
  ...
  for(i = 0; i < 100; i++){
    ...
    1b3d:	68 95 47 00 00       	push   $0x4795
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b66:	68 1d 45 00 00       	push   $0x451d
    1b6b:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 100; i++){
    ...
    1b83:	68 95 47 00 00       	push   $0x4795
    1b88:	68 19 45 00 00       	push   $0x4519
  ...
  if(pid < 0){
    ...
    1b9d:	68 7d 4d 00 00       	push   $0x4d7d
    1ba2:	6a 01                	push   $0x1
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1bc8:	68 2c 45 00 00       	push   $0x452c
    1bcd:	6a 01                	push   $0x1
    1bcf:	e8 2c 1e 00 00       	call   3a00 <printf>
  unlink("bd");
    1bd4:	c7 04 24 39 45 00 00 	movl   $0x4539,(%esp)
  ...
  fd = open("bd", O_CREATE);
    ...
    1be7:	68 39 45 00 00       	push   $0x4539
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
    1c1c:	56                   	push   %esi
    1c1d:	68 39 45 00 00       	push   $0x4539
  }
  close(fd);
  ...
  unlink("bd");
    1c53:	68 39 45 00 00       	push   $0x4539
  ...
  printf(1, "bigdir ok\n");
    ...
    1c9c:	68 7b 45 00 00       	push   $0x457b
    1ca1:	6a 01                	push   $0x1
    ...
    1cb5:	68 52 45 00 00       	push   $0x4552
    1cba:	6a 01                	push   $0x1
    ...
    1cc9:	68 66 45 00 00       	push   $0x4566
    1cce:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1cdd:	68 3c 45 00 00       	push   $0x453c
    1ce2:	6a 01                	push   $0x1
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cf7:	68 86 45 00 00       	push   $0x4586
    1cfc:	6a 01                	push   $0x1
    1cfe:	e8 fd 1c 00 00       	call   3a00 <printf>

  unlink("ff");
    1d03:	c7 04 24 0f 46 00 00 	movl   $0x460f,(%esp)
    1d0a:	e8 e3 1b 00 00       	call   38f2 <unlink>
  if(mkdir("dd") != 0){
    1d0f:	c7 04 24 ac 46 00 00 	movl   $0x46ac,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	68 e5 45 00 00       	push   $0x45e5
  ...
  write(fd, "ff", 2);
    ...
    1d48:	6a 02                	push   $0x2
    1d4a:	68 0f 46 00 00       	push   $0x460f
    1d4f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d5d:	c7 04 24 ac 46 00 00 	movl   $0x46ac,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d77:	68 c0 45 00 00       	push   $0x45c0
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d94:	68 e2 45 00 00       	push   $0x45e2
  ...
  write(fd, "FF", 2);
    ...
    1dae:	6a 02                	push   $0x2
    1db0:	68 03 46 00 00       	push   $0x4603
    1db5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1dc4:	5a                   	pop    %edx
    1dc5:	6a 00                	push   $0x0
    1dc7:	68 06 46 00 00       	push   $0x4606
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1de6:	68 60 87 00 00       	push   $0x8760
    1deb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1dfd:	80 3d 60 87 00 00 66 	cmpb   $0x66,0x8760
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e13:	5b                   	pop    %ebx
    1e14:	58                   	pop    %eax
    1e15:	68 46 46 00 00       	push   $0x4646
    1e1a:	68 e2 45 00 00       	push   $0x45e2
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e32:	68 e2 45 00 00       	push   $0x45e2
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e4a:	6a 00                	push   $0x0
    1e4c:	68 e2 45 00 00       	push   $0x45e2
  ...
  if(chdir("dd") != 0){
    ...
    1e64:	68 ac 46 00 00       	push   $0x46ac
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e7c:	68 7a 46 00 00       	push   $0x467a
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1e94:	68 a0 46 00 00       	push   $0x46a0
  ...
  if(chdir("./..") != 0){
    ...
    1eac:	68 af 46 00 00       	push   $0x46af
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ec4:	6a 00                	push   $0x0
    1ec6:	68 46 46 00 00       	push   $0x4646
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ee5:	68 60 87 00 00       	push   $0x8760
    1eea:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f06:	5b                   	pop    %ebx
    1f07:	6a 00                	push   $0x0
    1f09:	68 e2 45 00 00       	push   $0x45e2
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f26:	68 fa 46 00 00       	push   $0x46fa
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f43:	68 1f 47 00 00       	push   $0x471f
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f60:	68 ac 46 00 00       	push   $0x46ac
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f78:	6a 02                	push   $0x2
    1f7a:	68 ac 46 00 00       	push   $0x46ac
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1f92:	6a 01                	push   $0x1
    1f94:	68 ac 46 00 00       	push   $0x46ac
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fac:	68 8e 47 00 00       	push   $0x478e
    1fb1:	68 fa 46 00 00       	push   $0x46fa
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fc9:	68 8e 47 00 00       	push   $0x478e
    1fce:	68 1f 47 00 00       	push   $0x471f
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1fe6:	68 46 46 00 00       	push   $0x4646
    1feb:	68 e5 45 00 00       	push   $0x45e5
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2003:	68 fa 46 00 00       	push   $0x46fa
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    201b:	68 1f 47 00 00       	push   $0x471f
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    204b:	68 1f 47 00 00       	push   $0x471f
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2063:	68 fa 46 00 00       	push   $0x46fa
  ...
  if(chdir("dd/ff") == 0){
    ...
    207b:	68 e5 45 00 00       	push   $0x45e5
  ...
  if(chdir("dd/xx") == 0){
    ...
    2093:	68 91 47 00 00       	push   $0x4791
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20ab:	68 46 46 00 00       	push   $0x4646
  ...
  if(unlink("dd/ff") != 0){
    ...
    20c3:	68 e5 45 00 00       	push   $0x45e5
  ...
  if(unlink("dd") == 0){
    ...
    20db:	68 ac 46 00 00       	push   $0x46ac
  ...
  if(unlink("dd") < 0){
    ...
    210b:	68 ac 46 00 00       	push   $0x46ac
  ...
  printf(1, "subdir ok\n");
    ...
    2123:	68 8e 48 00 00       	push   $0x488e
    2128:	6a 01                	push   $0x1
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2137:	50                   	push   %eax
    2138:	50                   	push   %eax
    2139:	68 2b 46 00 00       	push   $0x462b
    213e:	6a 01                	push   $0x1
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    214a:	50                   	push   %eax
    214b:	50                   	push   %eax
    214c:	68 86 46 00 00       	push   $0x4686
    2151:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    215d:	52                   	push   %edx
    215e:	52                   	push   %edx
    215f:	68 51 46 00 00       	push   $0x4651
    2164:	6a 01                	push   $0x1
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2170:	50                   	push   %eax
    2171:	50                   	push   %eax
    2172:	68 03 47 00 00       	push   $0x4703
    2177:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2183:	52                   	push   %edx
    2184:	52                   	push   %edx
    2185:	68 e8 50 00 00       	push   $0x50e8
    218a:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2196:	52                   	push   %edx
    2197:	52                   	push   %edx
    2198:	68 97 47 00 00       	push   $0x4797
    219d:	6a 01                	push   $0x1
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    21a9:	51                   	push   %ecx
    21aa:	51                   	push   %ecx
    21ab:	68 58 51 00 00       	push   $0x5158
    21b0:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    21bc:	50                   	push   %eax
    21bd:	50                   	push   %eax
    21be:	68 12 46 00 00       	push   $0x4612
    21c3:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    21cf:	51                   	push   %ecx
    21d0:	51                   	push   %ecx
    21d1:	68 eb 45 00 00       	push   $0x45eb
    21d6:	6a 01                	push   $0x1
  ...
  if(chdir("./..") != 0){
    ...
    21e2:	50                   	push   %eax
    21e3:	50                   	push   %eax
    21e4:	68 b4 46 00 00       	push   $0x46b4
    21e9:	6a 01                	push   $0x1
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    21f5:	51                   	push   %ecx
    21f6:	51                   	push   %ecx
    21f7:	68 a0 50 00 00       	push   $0x50a0
    21fc:	6a 01                	push   $0x1
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2208:	53                   	push   %ebx
    2209:	53                   	push   %ebx
    220a:	68 34 51 00 00       	push   $0x5134
    220f:	6a 01                	push   $0x1
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    221b:	50                   	push   %eax
    221c:	50                   	push   %eax
    221d:	68 10 51 00 00       	push   $0x5110
    2222:	6a 01                	push   $0x1
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    222e:	50                   	push   %eax
    222f:	50                   	push   %eax
    2230:	68 73 47 00 00       	push   $0x4773
    2235:	6a 01                	push   $0x1
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2241:	50                   	push   %eax
    2242:	50                   	push   %eax
    2243:	68 5a 47 00 00       	push   $0x475a
    2248:	6a 01                	push   $0x1
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2254:	50                   	push   %eax
    2255:	50                   	push   %eax
    2256:	68 44 47 00 00       	push   $0x4744
    225b:	6a 01                	push   $0x1
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2267:	50                   	push   %eax
    2268:	50                   	push   %eax
    2269:	68 28 47 00 00       	push   $0x4728
    226e:	6a 01                	push   $0x1
  ...
  if(chdir("dd") != 0){
    ...
    227a:	50                   	push   %eax
    227b:	50                   	push   %eax
    227c:	68 69 46 00 00       	push   $0x4669
    2281:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    228d:	50                   	push   %eax
    228e:	50                   	push   %eax
    228f:	68 c4 50 00 00       	push   $0x50c4
    2294:	6a 01                	push   $0x1
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    22a0:	53                   	push   %ebx
    22a1:	53                   	push   %ebx
    22a2:	68 c7 45 00 00       	push   $0x45c7
    22a7:	6a 01                	push   $0x1
  ...
  if(unlink("dd") >= 0){
    ...
    22b3:	50                   	push   %eax
    22b4:	50                   	push   %eax
    22b5:	68 78 50 00 00       	push   $0x5078
    22ba:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    22c6:	50                   	push   %eax
    22c7:	50                   	push   %eax
    22c8:	68 ab 45 00 00       	push   $0x45ab
    22cd:	6a 01                	push   $0x1
  ...
  if(mkdir("dd") != 0){
    ...
    22d9:	50                   	push   %eax
    22da:	50                   	push   %eax
    22db:	68 93 45 00 00       	push   $0x4593
    22e0:	6a 01                	push   $0x1
  ...
  if(unlink("dd") < 0){
    ...
    22ec:	50                   	push   %eax
    22ed:	50                   	push   %eax
    22ee:	68 7c 48 00 00       	push   $0x487c
    22f3:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd") < 0){
    ...
    22ff:	52                   	push   %edx
    2300:	52                   	push   %edx
    2301:	68 67 48 00 00       	push   $0x4867
    2306:	6a 01                	push   $0x1
  ...
  if(unlink("dd") == 0){
    ...
    2312:	51                   	push   %ecx
    2313:	51                   	push   %ecx
    2314:	68 7c 51 00 00       	push   $0x517c
    2319:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff") != 0){
    ...
    2325:	53                   	push   %ebx
    2326:	53                   	push   %ebx
    2327:	68 52 48 00 00       	push   $0x4852
    232c:	6a 01                	push   $0x1
  ...
  if(chdir("dd/xx") == 0){
    ...
    2338:	50                   	push   %eax
    2339:	50                   	push   %eax
    233a:	68 3a 48 00 00       	push   $0x483a
    233f:	6a 01                	push   $0x1
  ...
  if(chdir("dd/ff") == 0){
    ...
    234b:	50                   	push   %eax
    234c:	50                   	push   %eax
    234d:	68 22 48 00 00       	push   $0x4822
    2352:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    235e:	50                   	push   %eax
    235f:	50                   	push   %eax
    2360:	68 06 48 00 00       	push   $0x4806
    2365:	6a 01                	push   $0x1
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2371:	50                   	push   %eax
    2372:	50                   	push   %eax
    2373:	68 ea 47 00 00       	push   $0x47ea
    2378:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2384:	50                   	push   %eax
    2385:	50                   	push   %eax
    2386:	68 cd 47 00 00       	push   $0x47cd
    238b:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2397:	50                   	push   %eax
    2398:	50                   	push   %eax
    2399:	68 b2 47 00 00       	push   $0x47b2
    239e:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    23aa:	50                   	push   %eax
    23ab:	50                   	push   %eax
    23ac:	68 df 46 00 00       	push   $0x46df
    23b1:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    23bd:	50                   	push   %eax
    23be:	50                   	push   %eax
    23bf:	68 c7 46 00 00       	push   $0x46c7
    23c4:	6a 01                	push   $0x1
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23dd:	68 99 48 00 00       	push   $0x4899
    23e2:	6a 01                	push   $0x1
    23e4:	e8 17 16 00 00       	call   3a00 <printf>

  unlink("bigwrite");
    23e9:	c7 04 24 a8 48 00 00 	movl   $0x48a8,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2408:	68 a8 48 00 00       	push   $0x48a8
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    241e:	53                   	push   %ebx
    241f:	68 60 87 00 00       	push   $0x8760
    2424:	50                   	push   %eax
    ...
    2434:	53                   	push   %ebx
    2435:	68 60 87 00 00       	push   $0x8760
    243a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2456:	c7 04 24 a8 48 00 00 	movl   $0x48a8,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2470:	68 db 48 00 00       	push   $0x48db
    2475:	6a 01                	push   $0x1
    ...
    2486:	50                   	push   %eax
    2487:	53                   	push   %ebx
    2488:	68 c9 48 00 00       	push   $0x48c9
    248d:	6a 01                	push   $0x1
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    249c:	68 b1 48 00 00       	push   $0x48b1
    24a1:	6a 01                	push   $0x1
...
bigfile(void)
{
  ...
  fd = open("bigfile", 0);
    ...
    253e:	5b                   	pop    %ebx
    253f:	6a 00                	push   $0x0
    2541:	68 04 49 00 00       	push   $0x4904
  ...
  if(fd < 0){
    ...
    256b:	0f be 05 60 87 00 00 	movsbl 0x8760,%eax
    2572:	89 fa                	mov    %edi,%edx
    2574:	d1 fa                	sar    %edx
    2576:	39 d0                	cmp    %edx,%eax
    2578:	75 6e                	jne    25e8 <bigfile+0x138>
    257a:	0f be 15 8b 88 00 00 	movsbl 0x888b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2596:	68 60 87 00 00       	push   $0x8760
    259b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25c5:	68 04 49 00 00       	push   $0x4904
    25ca:	e8 23 13 00 00       	call   38f2 <unlink>

  printf(1, "bigfile test ok\n");
    25cf:	58                   	pop    %eax
    25d0:	5a                   	pop    %edx
    25d1:	68 93 49 00 00       	push   $0x4993
    25d6:	6a 01                	push   $0x1
    ...
    25eb:	68 60 49 00 00       	push   $0x4960
    25f0:	6a 01                	push   $0x1
    ...
    25ff:	68 4c 49 00 00       	push   $0x494c
    2604:	6a 01                	push   $0x1
  ...
  for(i = 0; ; i++){
    ...
    2613:	68 37 49 00 00       	push   $0x4937
    2618:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 20; i++){
    ...
    2627:	68 0c 49 00 00       	push   $0x490c
    262c:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    263b:	68 22 49 00 00       	push   $0x4922
    2640:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    264f:	68 f6 48 00 00       	push   $0x48f6
    2654:	6a 01                	push   $0x1
  ...
  if(total != 20*600){
    ...
    2663:	68 79 49 00 00       	push   $0x4979
    2668:	6a 01                	push   $0x1
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2686:	68 a4 49 00 00       	push   $0x49a4
    268b:	6a 01                	push   $0x1
    268d:	e8 6e 13 00 00       	call   3a00 <printf>

  if(mkdir("12345678901234") != 0){
    2692:	c7 04 24 df 49 00 00 	movl   $0x49df,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26ac:	68 9c 51 00 00       	push   $0x519c
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c9:	68 ec 51 00 00       	push   $0x51ec
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26e8:	5a                   	pop    %edx
    26e9:	6a 00                	push   $0x0
    26eb:	68 5c 52 00 00       	push   $0x525c
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2705:	c7 04 24 d0 49 00 00 	movl   $0x49d0,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    271b:	68 f8 52 00 00       	push   $0x52f8
  ...
  printf(1, "fourteen ok\n");
    ...
    272f:	68 ee 49 00 00       	push   $0x49ee
    2734:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2740:	50                   	push   %eax
    2741:	50                   	push   %eax
    2742:	68 b3 49 00 00       	push   $0x49b3
    2747:	6a 01                	push   $0x1
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2753:	50                   	push   %eax
    2754:	50                   	push   %eax
    2755:	68 18 53 00 00       	push   $0x5318
    275a:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2766:	52                   	push   %edx
    2767:	52                   	push   %edx
    2768:	68 c8 52 00 00       	push   $0x52c8
    276d:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    2779:	51                   	push   %ecx
    277a:	51                   	push   %ecx
    277b:	68 8c 52 00 00       	push   $0x528c
    2780:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    278c:	51                   	push   %ecx
    278d:	51                   	push   %ecx
    278e:	68 1c 52 00 00       	push   $0x521c
    2793:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    279f:	50                   	push   %eax
    27a0:	50                   	push   %eax
    27a1:	68 bc 51 00 00       	push   $0x51bc
    27a6:	6a 01                	push   $0x1
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    27c6:	68 fb 49 00 00       	push   $0x49fb
    27cb:	6a 01                	push   $0x1
    27cd:	e8 2e 12 00 00       	call   3a00 <printf>
  if(mkdir("dots") != 0){
    27d2:	c7 04 24 07 4a 00 00 	movl   $0x4a07,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27ec:	68 07 4a 00 00       	push   $0x4a07
  ...
  if(unlink(".") == 0){
    ...
    2804:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(unlink("..") == 0){
    ...
    281c:	68 b1 46 00 00       	push   $0x46b1
  ...
  if(chdir("/") != 0){
    ...
    2834:	68 85 3e 00 00       	push   $0x3e85
  ...
  if(unlink("dots/.") == 0){
    ...
    284c:	68 4f 4a 00 00       	push   $0x4a4f
  ...
  if(unlink("dots/..") == 0){
    ...
    2860:	68 6d 4a 00 00       	push   $0x4a6d
  ...
  if(unlink("dots") != 0){
    ...
    2874:	68 07 4a 00 00       	push   $0x4a07
  ...
  printf(1, "rmdot ok\n");
    ...
    2888:	68 a2 4a 00 00       	push   $0x4aa2
    288d:	6a 01                	push   $0x1
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2899:	50                   	push   %eax
    289a:	50                   	push   %eax
    289b:	68 0c 4a 00 00       	push   $0x4a0c
    28a0:	6a 01                	push   $0x1
  ...
  if(unlink("dots") != 0){
    ...
    28ac:	50                   	push   %eax
    28ad:	50                   	push   %eax
    28ae:	68 8d 4a 00 00       	push   $0x4a8d
    28b3:	6a 01                	push   $0x1
  ...
  if(unlink("dots/..") == 0){
    ...
    28bf:	52                   	push   %edx
    28c0:	52                   	push   %edx
    28c1:	68 75 4a 00 00       	push   $0x4a75
    28c6:	6a 01                	push   $0x1
  ...
  if(unlink("dots/.") == 0){
    ...
    28d2:	51                   	push   %ecx
    28d3:	51                   	push   %ecx
    28d4:	68 56 4a 00 00       	push   $0x4a56
    28d9:	6a 01                	push   $0x1
  ...
  if(chdir("/") != 0){
    ...
    28e5:	50                   	push   %eax
    28e6:	50                   	push   %eax
    28e7:	68 87 3e 00 00       	push   $0x3e87
    28ec:	6a 01                	push   $0x1
  ...
  if(unlink("..") == 0){
    ...
    28f8:	50                   	push   %eax
    28f9:	50                   	push   %eax
    28fa:	68 40 4a 00 00       	push   $0x4a40
    28ff:	6a 01                	push   $0x1
  ...
  if(unlink(".") == 0){
    ...
    290b:	50                   	push   %eax
    290c:	50                   	push   %eax
    290d:	68 32 4a 00 00       	push   $0x4a32
    2912:	6a 01                	push   $0x1
  ...
  if(chdir("dots") != 0){
    ...
    291e:	50                   	push   %eax
    291f:	50                   	push   %eax
    2920:	68 1f 4a 00 00       	push   $0x4a1f
    2925:	6a 01                	push   $0x1
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2947:	68 ac 4a 00 00       	push   $0x4aac
    294c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    295a:	68 b9 4a 00 00       	push   $0x4ab9
  ...
  if(chdir("dirfile") == 0){
    2978:	c7 04 24 b9 4a 00 00 	movl   $0x4ab9,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2992:	6a 00                	push   $0x0
    2994:	68 f2 4a 00 00       	push   $0x4af2
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29b1:	68 f2 4a 00 00       	push   $0x4af2
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29c9:	68 f2 4a 00 00       	push   $0x4af2
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29e1:	68 f2 4a 00 00       	push   $0x4af2
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    29f9:	68 f2 4a 00 00       	push   $0x4af2
    29fe:	68 56 4b 00 00       	push   $0x4b56
  ...
  if(unlink("dirfile") != 0){
    ...
    2a16:	68 b9 4a 00 00       	push   $0x4ab9
  ...
  fd = open(".", O_RDWR);
    ...
    2a2e:	6a 02                	push   $0x2
    2a30:	68 b2 46 00 00       	push   $0x46b2
  ...
  fd = open(".", 0);
    ...
    2a48:	6a 00                	push   $0x0
    2a4a:	68 b2 46 00 00       	push   $0x46b2
  ...
  if(write(fd, "x", 1) > 0){
    2a59:	6a 01                	push   $0x1
    2a5b:	68 95 47 00 00       	push   $0x4795
    2a60:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a76:	58                   	pop    %eax
    2a77:	5a                   	pop    %edx
    2a78:	68 89 4b 00 00       	push   $0x4b89
    2a7d:	6a 01                	push   $0x1
  ...
  if(fd >= 0){
    ...
    2a8c:	50                   	push   %eax
    2a8d:	50                   	push   %eax
    2a8e:	68 fd 4a 00 00       	push   $0x4afd
    2a93:	6a 01                	push   $0x1
  ...
  if(chdir("dirfile") == 0){
    ...
    2a9f:	50                   	push   %eax
    2aa0:	50                   	push   %eax
    2aa1:	68 d8 4a 00 00       	push   $0x4ad8
    2aa6:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    2ab2:	52                   	push   %edx
    2ab3:	52                   	push   %edx
    2ab4:	68 c1 4a 00 00       	push   $0x4ac1
    2ab9:	6a 01                	push   $0x1
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ac5:	51                   	push   %ecx
    2ac6:	51                   	push   %ecx
    2ac7:	68 75 4b 00 00       	push   $0x4b75
    2acc:	6a 01                	push   $0x1
  ...
  if(fd >= 0){
    ...
    2ad8:	53                   	push   %ebx
    2ad9:	53                   	push   %ebx
    2ada:	68 6c 53 00 00       	push   $0x536c
    2adf:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile") != 0){
    ...
    2aeb:	50                   	push   %eax
    2aec:	50                   	push   %eax
    2aed:	68 5d 4b 00 00       	push   $0x4b5d
    2af2:	6a 01                	push   $0x1
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2afe:	50                   	push   %eax
    2aff:	50                   	push   %eax
    2b00:	68 4c 53 00 00       	push   $0x534c
    2b05:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b11:	50                   	push   %eax
    2b12:	50                   	push   %eax
    2b13:	68 38 4b 00 00       	push   $0x4b38
    2b18:	6a 01                	push   $0x1
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2b24:	50                   	push   %eax
    2b25:	50                   	push   %eax
    2b26:	68 1b 4b 00 00       	push   $0x4b1b
    2b2b:	6a 01                	push   $0x1
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2b4c:	68 99 4b 00 00       	push   $0x4b99
    2b51:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2b63:	68 aa 4b 00 00       	push   $0x4baa
    ...
    2b7b:	68 aa 4b 00 00       	push   $0x4baa
    ...
    2b93:	68 5f 42 00 00       	push   $0x425f
    2b98:	e8 6d 0d 00 00       	call   390a <mkdir>
    link("README", "");
    2b9d:	59                   	pop    %ecx
    2b9e:	58                   	pop    %eax
    2b9f:	68 5f 42 00 00       	push   $0x425f
    2ba4:	68 56 4b 00 00       	push   $0x4b56
    2ba9:	e8 54 0d 00 00       	call   3902 <link>
    fd = open("", O_CREATE);
    2bae:	58                   	pop    %eax
    2baf:	5a                   	pop    %edx
    2bb0:	68 00 02 00 00       	push   $0x200
    2bb5:	68 5f 42 00 00       	push   $0x425f
    ...
    2bda:	68 94 47 00 00       	push   $0x4794
    ...
    2bfa:	68 94 47 00 00       	push   $0x4794
  ...
  chdir("/");
    ...
    2c13:	68 85 3e 00 00       	push   $0x3e85
    2c18:	e8 f5 0c 00 00       	call   3912 <chdir>
  printf(1, "empty file name OK\n");
    2c1d:	58                   	pop    %eax
    2c1e:	5a                   	pop    %edx
    2c1f:	68 d8 4b 00 00       	push   $0x4bd8
    2c24:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c36:	68 b0 4b 00 00       	push   $0x4bb0
    2c3b:	6a 01                	push   $0x1
    ...
    2c4a:	68 c4 4b 00 00       	push   $0x4bc4
    2c4f:	6a 01                	push   $0x1
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2c69:	68 ec 4b 00 00       	push   $0x4bec
    2c6e:	6a 01                	push   $0x1
    ...
    2c80:	74 62                	je     2ce4 <forktest+0x84>
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cbb:	68 1e 4c 00 00       	push   $0x4c1e
    2cc0:	6a 01                	push   $0x1
  ...
  if(n == 1000){
    ...
    2cd3:	68 8c 53 00 00       	push   $0x538c
    2cd8:	6a 01                	push   $0x1
  ...
  for(; n > 0; n--){
    ...
    2cec:	68 f7 4b 00 00       	push   $0x4bf7
    2cf1:	6a 01                	push   $0x1
  ...
  if(wait() != -1){
    ...
    2d00:	68 0b 4c 00 00       	push   $0x4c0b
    2d05:	6a 01                	push   $0x1
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2d2b:	68 2c 4c 00 00       	push   $0x4c2c
    2d30:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f9c:	68 d4 4c 00 00       	push   $0x4cd4
    2fa1:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2fd0:	6a 01                	push   $0x1
    2fd2:	68 95 47 00 00       	push   $0x4795
  ...
  for(i = 0; i < 5000; i++){
    ...
    2ffe:	53                   	push   %ebx
    2fff:	57                   	push   %edi
    3000:	68 37 4c 00 00       	push   $0x4c37
    3005:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c == (char*)0xffffffff){
    ...
    301b:	68 b9 4c 00 00       	push   $0x4cb9
    3020:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pipe(fds) != 0){
    ...
    3033:	68 75 41 00 00       	push   $0x4175
    3038:	6a 01                	push   $0x1
    ...
    3047:	50                   	push   %eax
    3048:	53                   	push   %ebx
    3049:	68 a0 4c 00 00       	push   $0x4ca0
    304e:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3069:	68 7d 4d 00 00       	push   $0x4d7d
    306e:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c != a){
    ...
    307e:	50                   	push   %eax
    307f:	53                   	push   %ebx
    3080:	68 80 54 00 00       	push   $0x5480
    3085:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(*lastaddr == 99){
    ...
    3098:	68 50 54 00 00       	push   $0x5450
    309d:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    30ad:	57                   	push   %edi
    30ae:	53                   	push   %ebx
    30af:	68 28 54 00 00       	push   $0x5428
    30b4:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c != a - 4096){
    ...
    30c4:	50                   	push   %eax
    30c5:	53                   	push   %ebx
    30c6:	68 f0 53 00 00       	push   $0x53f0
    30cb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c == (char*)0xffffffff){
    ...
    30de:	68 85 4c 00 00       	push   $0x4c85
    30e3:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    30f6:	68 b0 53 00 00       	push   $0x53b0
    30fb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(c != a + 1){
    ...
    3113:	68 69 4c 00 00       	push   $0x4c69
    3118:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  if(pid < 0){
    ...
    312b:	68 52 4c 00 00       	push   $0x4c52
    3130:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 e2 4c 00 00       	push   $0x4ce2
    315f:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 f1 4c 00 00       	push   $0x4cf1
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 15 4d 00 00       	push   $0x4d15
    31c9:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    31e6:	68 fc 4c 00 00       	push   $0x4cfc
    31eb:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 22 4d 00 00       	push   $0x4d22
    320b:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    3211:	e8 ea 07 00 00       	call   3a00 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d 40 60 00 00 00 	cmpb   $0x0,0x6040
    3220:	75 35                	jne    3257 <bsstest+0x57>
    3222:	b8 41 60 00 00       	mov    $0x6041,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
  for(i = 0; i < sizeof(uninit); i++){
    3238:	3d 50 87 00 00       	cmp    $0x8750,%eax
  ...
  printf(stdout, "bss test ok\n");
    ...
    3242:	68 3d 4d 00 00       	push   $0x4d3d
    3247:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325a:	68 2c 4d 00 00       	push   $0x4d2c
    325f:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3276:	68 4a 4d 00 00       	push   $0x4d4a
  ...
  fd = open("bigarg-ok", 0);
    ...
    329a:	6a 00                	push   $0x0
    329c:	68 4a 4d 00 00       	push   $0x4d4a
  ...
  unlink("bigarg-ok");
    32ba:	c7 04 24 4a 4d 00 00 	movl   $0x4d4a,(%esp)
    32c1:	e8 2c 06 00 00       	call   38f2 <unlink>
}
    32c6:	83 c4 10             	add    $0x10,%esp
    32c9:	c9                   	leave  
    32ca:	c3                   	ret    
    32cb:	b8 a0 5f 00 00       	mov    $0x5fa0,%eax
  pid = fork();
  if(pid == 0){
    ...
    32d0:	c7 00 a4 54 00 00    	movl   $0x54a4,(%eax)
  ...
  if(pid == 0){
    ...
    int i;
    for(i = 0; i < MAXARG-1; i++)
    32d9:	3d 1c 60 00 00       	cmp    $0x601c,%eax
    ...
    32e0:	51                   	push   %ecx
    32e1:	51                   	push   %ecx
    32e2:	68 54 4d 00 00       	push   $0x4d54
    32e7:	ff 35 6c 5f 00 00    	pushl  0x5f6c
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    32ed:	c7 05 1c 60 00 00 00 	movl   $0x0,0x601c
    32f4:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    32fc:	58                   	pop    %eax
    32fd:	5a                   	pop    %edx
    32fe:	68 a0 5f 00 00       	push   $0x5fa0
    3303:	68 21 3f 00 00       	push   $0x3f21
    3308:	e8 cd 05 00 00       	call   38da <exec>
    printf(stdout, "bigarg test ok\n");
    330d:	59                   	pop    %ecx
    330e:	58                   	pop    %eax
    330f:	68 61 4d 00 00       	push   $0x4d61
    3314:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    331a:	e8 e1 06 00 00       	call   3a00 <printf>
    fd = open("bigarg-ok", O_CREATE);
    331f:	58                   	pop    %eax
    3320:	5a                   	pop    %edx
    3321:	68 00 02 00 00       	push   $0x200
    3326:	68 4a 4d 00 00       	push   $0x4d4a
  ...
  if(fd < 0){
    ...
    333d:	50                   	push   %eax
    333e:	50                   	push   %eax
    333f:	68 8a 4d 00 00       	push   $0x4d8a
    3344:	ff 35 6c 5f 00 00    	pushl  0x5f6c
    ...
    3354:	52                   	push   %edx
    3355:	52                   	push   %edx
    3356:	68 71 4d 00 00       	push   $0x4d71
    335b:	ff 35 6c 5f 00 00    	pushl  0x5f6c
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    337b:	68 9f 4d 00 00       	push   $0x4d9f
    3380:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3418:	50                   	push   %eax
    3419:	68 ac 4d 00 00       	push   $0x4dac
    341e:	6a 01                	push   $0x1
    ...
    3452:	68 60 87 00 00       	push   $0x8760
    3457:	57                   	push   %edi
    ...
    346a:	56                   	push   %esi
    346b:	68 c8 4d 00 00       	push   $0x4dc8
    3470:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3494:	50                   	push   %eax
    3495:	68 b8 4d 00 00       	push   $0x4db8
    349a:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    3548:	68 d8 4d 00 00       	push   $0x4dd8
    354d:	6a 01                	push   $0x1
...
uio()
{
  ...
  printf(1, "uio test\n");
    3566:	68 ee 4d 00 00       	push   $0x4dee
    356b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3588:	68 f8 4d 00 00       	push   $0x4df8
    358d:	6a 01                	push   $0x1
  ...
  if(pid == 0){
    ...
    35aa:	52                   	push   %edx
    35ab:	52                   	push   %edx
    35ac:	68 84 55 00 00       	push   $0x5584
    35b1:	6a 01                	push   $0x1
    ...
    35bd:	50                   	push   %eax
    35be:	50                   	push   %eax
    35bf:	68 7d 4d 00 00       	push   $0x4d7d
    35c4:	6a 01                	push   $0x1
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    35d7:	6a 00                	push   $0x0
    35d9:	68 07 4e 00 00       	push   $0x4e07
  ...
  printf(1, "arg test passed\n");
    360d:	58                   	pop    %eax
    360e:	5a                   	pop    %edx
    360f:	68 19 4e 00 00       	push   $0x4e19
    3614:	6a 01                	push   $0x1
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    3623:	51                   	push   %ecx
    3624:	51                   	push   %ecx
    3625:	68 0c 4e 00 00       	push   $0x4e0c
    362a:	6a 02                	push   $0x2
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    3640:	69 05 68 5f 00 00 0d 	imul   $0x19660d,0x5f68,%eax
    3647:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    ...
    3653:	a3 68 5f 00 00       	mov    %eax,0x5f68
  return randstate;
}
    3658:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    399f:	f7 f6                	div    %esi
    39a1:	0f b6 92 dc 55 00 00 	movzbl 0x55dc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b18:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    3b1b:	b8 d4 55 00 00       	mov    $0x55d4,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ba1:	a1 20 60 00 00       	mov    0x6020,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    3bf9:	a3 20 60 00 00       	mov    %eax,0x6020
}
    3bfe:	5b                   	pop    %ebx
    3bff:	5e                   	pop    %esi
    3c00:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    3c1d:	a3 20 60 00 00       	mov    %eax,0x6020
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    3c37:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3c3c:	76 3a                	jbe    3c78 <morecore+0x48>
    3c3e:	89 c3                	mov    %eax,%ebx
    3c40:	8d 04 c5 00 00 00 00 	lea    0x0(,%eax,8),%eax
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
    3c47:	83 ec 0c             	sub    $0xc,%esp
    3c4a:	50                   	push   %eax
    3c4b:	e8 da fc ff ff       	call   392a <sbrk>
  if(p == (char*)-1)
    3c50:	83 c4 10             	add    $0x10,%esp
    3c53:	83 f8 ff             	cmp    $0xffffffff,%eax
    3c56:	74 30                	je     3c88 <morecore+0x58>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3c58:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3c5b:	83 ec 0c             	sub    $0xc,%esp
    3c5e:	83 c0 08             	add    $0x8,%eax
    3c61:	50                   	push   %eax
    3c62:	e8 39 ff ff ff       	call   3ba0 <free>
  return freep;
    3c67:	a1 20 60 00 00       	mov    0x6020,%eax
    3c6c:	83 c4 10             	add    $0x10,%esp
}
    3c6f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3c72:	c9                   	leave  
    3c73:	c3                   	ret    
    3c74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3c78:	b8 00 80 00 00       	mov    $0x8000,%eax
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    nu = 4096;
    3c7d:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3c82:	eb c3                	jmp    3c47 <morecore+0x17>
    3c84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  p = sbrk(nu * sizeof(Header));
  if(p == (char*)-1)
    return 0;
    3c88:	31 c0                	xor    %eax,%eax
    3c8a:	eb e3                	jmp    3c6f <morecore+0x3f>
...
malloc(uint nbytes)
{
    ...
    3c9a:	8d 58 07             	lea    0x7(%eax),%ebx
    if((prevp = freep) == 0){
    3c9d:	a1 20 60 00 00       	mov    0x6020,%eax
malloc(uint nbytes)
{
    Header *p, *prevp;
    uint nunits;
    ...
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3ca2:	c1 eb 03             	shr    $0x3,%ebx
    3ca5:	83 c3 01             	add    $0x1,%ebx
    if((prevp = freep) == 0){
    3ca8:	85 c0                	test   %eax,%eax
    3caa:	74 52                	je     3cfe <malloc+0x6e>
    3cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3cb0:	8b 10                	mov    (%eax),%edx
        if(p->s.size >= nunits){
    3cb2:	8b 4a 04             	mov    0x4(%edx),%ecx
    3cb5:	39 cb                	cmp    %ecx,%ebx
    3cb7:	76 1f                	jbe    3cd8 <malloc+0x48>
                p->s.size = nunits;
            }
            freep = prevp;
            return (void*)(p + 1);
        ...
        if(p == freep)
    3cb9:	39 15 20 60 00 00    	cmp    %edx,0x6020
    3cbf:	89 d0                	mov    %edx,%eax
    3cc1:	75 ed                	jne    3cb0 <malloc+0x20>
            if((p = morecore(nunits)) == 0)
    3cc3:	89 d8                	mov    %ebx,%eax
    3cc5:	e8 66 ff ff ff       	call   3c30 <morecore>
    3cca:	85 c0                	test   %eax,%eax
    3ccc:	75 e2                	jne    3cb0 <malloc+0x20>
                return 0;
    3cce:	31 c0                	xor    %eax,%eax
    3cd0:	eb 1d                	jmp    3cef <malloc+0x5f>
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size >= nunits){
            if(p->s.size == nunits)
    3cd8:	39 cb                	cmp    %ecx,%ebx
    3cda:	74 1c                	je     3cf8 <malloc+0x68>
                prevp->s.ptr = p->s.ptr;
            else {
                p->s.size -= nunits;
    3cdc:	29 d9                	sub    %ebx,%ecx
    3cde:	89 4a 04             	mov    %ecx,0x4(%edx)
                p += p->s.size;
    3ce1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
                p->s.size = nunits;
    3ce4:	89 5a 04             	mov    %ebx,0x4(%edx)
            }
            freep = prevp;
    3ce7:	a3 20 60 00 00       	mov    %eax,0x6020
            return (void*)(p + 1);
    3cec:	8d 42 08             	lea    0x8(%edx),%eax
        }
        if(p == freep)
            if((p = morecore(nunits)) == 0)
                return 0;
    ...
    3cef:	83 c4 04             	add    $0x4,%esp
    3cf2:	5b                   	pop    %ebx
    3cf3:	5d                   	pop    %ebp
    3cf4:	c3                   	ret    
    3cf5:	8d 76 00             	lea    0x0(%esi),%esi
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size >= nunits){
            if(p->s.size == nunits)
                prevp->s.ptr = p->s.ptr;
    3cf8:	8b 0a                	mov    (%edx),%ecx
    3cfa:	89 08                	mov    %ecx,(%eax)
    3cfc:	eb e9                	jmp    3ce7 <malloc+0x57>
    Header *p, *prevp;
    uint nunits;
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
    3cfe:	c7 05 20 60 00 00 24 	movl   $0x6024,0x6020
    3d05:	60 00 00 
    3d08:	c7 05 24 60 00 00 24 	movl   $0x6024,0x6024
    3d0f:	60 00 00 
        base.s.size = 0;
    3d12:	ba 24 60 00 00       	mov    $0x6024,%edx
    3d17:	c7 05 28 60 00 00 00 	movl   $0x0,0x6028
    3d1e:	00 00 00 
    3d21:	eb 96                	jmp    3cb9 <malloc+0x29>
...
pmalloc()
{
    ...
    3d33:	53                   	push   %ebx
    3d34:	83 ec 04             	sub    $0x4,%esp
    Header *p, *prevp;
    uint nunits;

    nunits = ( 4096 + sizeof(Header) - 1)/sizeof(Header) + 1;
    if((prevp = freep) == 0){
    3d37:	a1 20 60 00 00       	mov    0x6020,%eax
    3d3c:	85 c0                	test   %eax,%eax
    3d3e:	74 56                	je     3d96 <pmalloc+0x66>
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d40:	8b 10                	mov    (%eax),%edx
        if(p->s.size == nunits){
    3d42:	81 7a 04 01 02 00 00 	cmpl   $0x201,0x4(%edx)
    3d49:	74 25                	je     3d70 <pmalloc+0x40>
            (p+1)->x = 1;
            turnOnPM( (void *)( p + 1 ) );
            return (void*)(p + 1);
        }
        ...
        if(p == freep)
    3d4b:	39 15 20 60 00 00    	cmp    %edx,0x6020
    3d51:	89 d0                	mov    %edx,%eax
    3d53:	75 eb                	jne    3d40 <pmalloc+0x10>
            if((p = morecore(nunits)) == 0)
    3d55:	b8 01 02 00 00       	mov    $0x201,%eax
    3d5a:	e8 d1 fe ff ff       	call   3c30 <morecore>
    3d5f:	85 c0                	test   %eax,%eax
    3d61:	75 dd                	jne    3d40 <pmalloc+0x10>
                return 0;
    3d63:	31 db                	xor    %ebx,%ebx
    3d65:	eb 28                	jmp    3d8f <pmalloc+0x5f>
    3d67:	89 f6                	mov    %esi,%esi
    ...
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
    3d70:	8b 0a                	mov    (%edx),%ecx
            freep = prevp;
            (p+1)->x = 1;
            turnOnPM( (void *)( p + 1 ) );
    3d72:	8d 5a 08             	lea    0x8(%edx),%ebx
    3d75:	83 ec 0c             	sub    $0xc,%esp
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
            freep = prevp;
    3d78:	a3 20 60 00 00       	mov    %eax,0x6020
        base.s.ptr = freep = prevp = &base;
        base.s.size = 0;
    }
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
        if(p->s.size == nunits){
            prevp->s.ptr = p->s.ptr;
    3d7d:	89 08                	mov    %ecx,(%eax)
            freep = prevp;
            (p+1)->x = 1;
    3d7f:	c7 42 08 01 00 00 00 	movl   $0x1,0x8(%edx)
            turnOnPM( (void *)( p + 1 ) );
    3d86:	53                   	push   %ebx
    3d87:	e8 b6 fb ff ff       	call   3942 <turnOnPM>
            return (void*)(p + 1);
    ...
    3d8f:	89 d8                	mov    %ebx,%eax
    3d91:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3d94:	c9                   	leave  
    3d95:	c3                   	ret    
    Header *p, *prevp;
    uint nunits;
    ...
    if((prevp = freep) == 0){
        base.s.ptr = freep = prevp = &base;
    3d96:	c7 05 20 60 00 00 24 	movl   $0x6024,0x6020
    3d9d:	60 00 00 
    3da0:	c7 05 24 60 00 00 24 	movl   $0x6024,0x6024
    3da7:	60 00 00 
        base.s.size = 0;
    3daa:	ba 24 60 00 00       	mov    $0x6024,%edx
    3daf:	c7 05 28 60 00 00 00 	movl   $0x0,0x6028
    3db6:	00 00 00 
    3db9:	eb 90                	jmp    3d4b <pmalloc+0x1b>
    3dbb:	90                   	nop
    3dbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00003dc0 <protect_page>:
}
...
protect_page(void* ap)
{
    ...
    3dc8:	74 16                	je     3de0 <protect_page+0x20>
    {
        if( (uint)ap % 4096 != 0 )
    3dca:	a9 ff 0f 00 00       	test   $0xfff,%eax
    3dcf:	75 0f                	jne    3de0 <protect_page+0x20>
        p = ap;
        return turnOffW( p );
    }
    else
    ...
    3dd1:	5d                   	pop    %ebp
        ...
        p = ap;
        return turnOffW( p );
    3dd2:	e9 7b fb ff ff       	jmp    3952 <turnOffW>
...
pfree(void* ap) {
    ...
    3df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
    Header *p;
    if (ap) {
    3dfa:	85 db                	test   %ebx,%ebx
    3dfc:	74 32                	je     3e30 <pfree+0x40>
        if ((uint) ap % 4096 != 0)
    3dfe:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
    3e04:	75 2a                	jne    3e30 <pfree+0x40>
            return -1;
    ...
    3e09:	53                   	push   %ebx
    3e0a:	e8 3b fb ff ff       	call   394a <checkOnPM>
    3e0f:	83 c4 10             	add    $0x10,%esp
    3e12:	85 c0                	test   %eax,%eax
    3e14:	74 1a                	je     3e30 <pfree+0x40>
            free(ap);
    3e16:	83 ec 0c             	sub    $0xc,%esp
    3e19:	53                   	push   %ebx
    3e1a:	e8 81 fd ff ff       	call   3ba0 <free>
            return 1;
    3e1f:	83 c4 10             	add    $0x10,%esp
    3e22:	b8 01 00 00 00       	mov    $0x1,%eax
        }
    }
    return -1;
}
    3e27:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3e2a:	c9                   	leave  
    3e2b:	c3                   	ret    
