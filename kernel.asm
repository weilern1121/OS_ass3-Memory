...
801000e4:	e8 c7 48 00 00       	call   801049b0 <acquire>
...
8010020b:	e8 a0 47 00 00       	call   801049b0 <acquire>
  b->refcnt--;
...
8010028c:	e8 1f 47 00 00       	call   801049b0 <acquire>
  while(n > 0){
...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 d3 81 10 80 	movl   $0x801081d3,(%esp)
...
801004d3:	e8 d8 5c 00 00       	call   801061b0 <uartputc>
801004d8:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004df:	e8 cc 5c 00 00       	call   801061b0 <uartputc>
801004e4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004eb:	e8 c0 5c 00 00       	call   801061b0 <uartputc>
...
8010061b:	e8 90 43 00 00       	call   801049b0 <acquire>
...
801007c8:	e8 e3 41 00 00       	call   801049b0 <acquire>
...
80100803:	e8 a8 41 00 00       	call   801049b0 <acquire>
  while((c = getc()) >= 0){
...
80100868:	e8 63 42 00 00       	call   80104ad0 <release>
  if(doprocdump) {
...
801008f6:	e8 f5 3c 00 00       	call   801045f0 <wakeup>
...
80100976:	5d                   	pop    %ebp
  ...
  if(doprocdump) {
    procdump();  // now call procdump() wo. cons.lock held
80100977:	e9 64 3d 00 00       	jmp    801046e0 <procdump>
      }
      break;
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
...
80100b04:	e8 b7 66 00 00       	call   801071c0 <allocuvm>
...
80100b3a:	e8 91 65 00 00       	call   801070d0 <loaduvm>
...
80100b95:	e8 26 66 00 00       	call   801071c0 <allocuvm>
...
80100c2d:	e8 2e 41 00 00       	call   80104d60 <strlen>
...
80100c40:	e8 1b 41 00 00       	call   80104d60 <strlen>
...
80100c51:	e8 1a 6b 00 00       	call   80107770 <copyout>
...
80100cb7:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
    ...
    sp -= (3 + argc + 1) * 4;
    if (copyout(pgdir, sp, ustack, (3 + argc + 1) * 4) < 0)
80100cbd:	e8 ae 6a 00 00       	call   80107770 <copyout>
...
80100d02:	e8 19 40 00 00       	call   80104d20 <safestrcpy>
...
80100d5a:	e8 e1 61 00 00       	call   80106f40 <switchuvm>
    freevm(oldpgdir);
80100d5f:	89 1c 24             	mov    %ebx,(%esp)
80100d62:	e8 89 67 00 00       	call   801074f0 <freevm>
    if (DEBUGMODE == 1)
        cprintf(">EXEC-DONE!\t");
    return 0;
...
80100d86:	68 ad 78 10 80       	push   $0x801078ad
80100d8b:	68 c0 0f 11 80       	push   $0x80110fc0
80100d90:	e8 1b 3b 00 00       	call   801048b0 <initlock>
}
...
80100db1:	e8 fa 3b 00 00       	call   801049b0 <acquire>
...
80100de1:	e8 ea 3c 00 00       	call   80104ad0 <release>
      return f;
...
80100df8:	e8 d3 3c 00 00       	call   80104ad0 <release>
  return 0;
...
80100e1f:	e8 8c 3b 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100e3c:	e8 8f 3c 00 00       	call   80104ad0 <release>
  return f;
}
...
80100e4b:	68 b4 78 10 80       	push   $0x801078b4
...
80100e71:	e8 3a 3b 00 00       	call   801049b0 <acquire>
  if(f->ref < 1)
...
80100e9b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e9c:	e9 2f 3c 00 00       	jmp    80104ad0 <release>
...
80100ec5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100ec8:	e8 03 3c 00 00       	call   80104ad0 <release>
...
80100f22:	68 bc 78 10 80       	push   $0x801078bc
...
80101002:	68 c6 78 10 80       	push   $0x801078c6
...
80101114:	68 cf 78 10 80       	push   $0x801078cf
...
80101121:	68 d5 78 10 80       	push   $0x801078d5
...
801011d2:	68 df 78 10 80       	push   $0x801078df
...
80101215:	e8 06 39 00 00       	call   80104b20 <memset>
  log_write(bp);
...
8010125a:	e8 51 37 00 00       	call   801049b0 <acquire>
...
8010129f:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012a2:	e8 29 38 00 00       	call   80104ad0 <release>
      return ip;
...
801012ef:	e8 dc 37 00 00       	call   80104ad0 <release>
...
80101304:	68 f5 78 10 80       	push   $0x801078f5
...
801013ca:	68 05 79 10 80       	push   $0x80107905
...
80101401:	e8 ca 37 00 00       	call   80104bd0 <memmove>
  brelse(bp);
...
80101496:	68 18 79 10 80       	push   $0x80107918
...
80101519:	68 dc 79 10 80       	push   $0x801079dc
...
801015ae:	e8 6d 35 00 00       	call   80104b20 <memset>
      dip->type = type;
...
801015e3:	68 38 79 10 80       	push   $0x80107938
...
80101651:	e8 7a 35 00 00       	call   80104bd0 <memmove>
  log_write(bp);
...
8010167f:	e8 2c 33 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101684:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101688:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
8010168f:	e8 3c 34 00 00       	call   80104ad0 <release>
  return ip;
}
...
801016c2:	e8 19 31 00 00       	call   801047e0 <acquiresleep>
...
80101738:	e8 93 34 00 00       	call   80104bd0 <memmove>
    brelse(bp);
...
8010175d:	68 50 79 10 80       	push   $0x80107950
...
8010176a:	68 4a 79 10 80       	push   $0x8010794a
...
80101793:	e8 e8 30 00 00       	call   80104880 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
801017af:	e9 8c 30 00 00       	jmp    80104840 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017b7:	68 5f 79 10 80       	push   $0x8010795f
...
801017e0:	e8 fb 2f 00 00       	call   801047e0 <acquiresleep>
...
801017fa:	e8 41 30 00 00       	call   80104840 <releasesleep>

  acquire(&icache.lock);
801017ff:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101806:	e8 a5 31 00 00       	call   801049b0 <acquire>
  ip->ref--;
...
8010181f:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
80101820:	e9 ab 32 00 00       	jmp    80104ad0 <release>
...
80101830:	e8 7b 31 00 00       	call   801049b0 <acquire>
    int r = ip->ref;
80101835:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
80101838:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
8010183f:	e8 8c 32 00 00       	call   80104ad0 <release>
    if(r == 1){
...
80101a28:	e8 a3 31 00 00       	call   80104bd0 <memmove>
    brelse(bp);
...
80101b24:	e8 a7 30 00 00       	call   80104bd0 <memmove>
    log_write(bp);
...
80101bbe:	e8 8d 30 00 00       	call   80104c50 <strncmp>
}
80101bc3:	c9                   	leave  
80101bc4:	c3                   	ret    
...
80101c25:	e8 26 30 00 00       	call   80104c50 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c5d:	68 79 79 10 80       	push   $0x80107979
...
80101c6a:	68 67 79 10 80       	push   $0x80107967
...
80101ca9:	e8 02 2d 00 00       	call   801049b0 <acquire>
  ip->ref++;
80101cae:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb2:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101cb9:	e8 12 2e 00 00       	call   80104ad0 <release>
...
80101d15:	e8 b6 2e 00 00       	call   80104bd0 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101da4:	e8 27 2e 00 00       	call   80104bd0 <memmove>
    name[len] = 0;
...
80101e8d:	e8 2e 2e 00 00       	call   80104cc0 <strncpy>
  de.inum = inum;
...
80101ed8:	68 d1 7f 10 80       	push   $0x80107fd1
...
80101fe1:	68 95 79 10 80       	push   $0x80107995
80101fe6:	56                   	push   %esi
80101fe7:	e8 e4 2b 00 00       	call   80104bd0 <memmove>
  itoa(p->pid, path+ 6);
80101fec:	58                   	pop    %eax
...
80102042:	68 9d 79 10 80       	push   $0x8010799d
80102047:	53                   	push   %ebx
80102048:	e8 03 2c 00 00       	call   80104c50 <strncmp>
  }
...
8010205d:	68 9c 79 10 80       	push   $0x8010799c
80102062:	53                   	push   %ebx
80102063:	e8 e8 2b 00 00       	call   80104c50 <strncmp>
  }
...
801020b7:	e8 64 2a 00 00       	call   80104b20 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80102124:	e8 07 32 00 00       	call   80105330 <isdirempty>
...
801021ac:	68 b1 79 10 80       	push   $0x801079b1
...
801021b9:	68 9f 79 10 80       	push   $0x8010799f
...
801021e0:	68 95 79 10 80       	push   $0x80107995
801021e5:	56                   	push   %esi
801021e6:	e8 e5 29 00 00       	call   80104bd0 <memmove>
    itoa(p->pid, path + 6);
801021eb:	58                   	pop    %eax
...
80102205:	e8 36 33 00 00       	call   80105540 <create>
    iunlock(in);
...
80102259:	68 c0 79 10 80       	push   $0x801079c0
...
80102380:	68 38 7a 10 80       	push   $0x80107a38
...
8010238d:	68 2f 7a 10 80       	push   $0x80107a2f
...
801023a6:	68 4a 7a 10 80       	push   $0x80107a4a
801023ab:	68 80 b5 10 80       	push   $0x8010b580
801023b0:	e8 fb 24 00 00       	call   801048b0 <initlock>
...
8010242e:	e8 7d 25 00 00       	call   801049b0 <acquire>
...
8010245e:	e8 8d 21 00 00       	call   801045f0 <wakeup>
...
8010247c:	e8 4f 26 00 00       	call   80104ad0 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801024ce:	e8 ad 23 00 00       	call   80104880 <holdingsleep>
...
80102508:	e8 a3 24 00 00       	call   801049b0 <acquire>
...
80102575:	c9                   	leave  
  ...
  release(&idelock);
80102576:	e9 55 25 00 00       	jmp    80104ad0 <release>
...
8010258e:	68 4e 7a 10 80       	push   $0x80107a4e
...
8010259b:	68 79 7a 10 80       	push   $0x80107a79
...
801025a8:	68 64 7a 10 80       	push   $0x80107a64
...
8010260a:	68 98 7a 10 80       	push   $0x80107a98
...
801026c2:	81 fb a8 69 12 80    	cmp    $0x801269a8,%ebx
...
801026e2:	e8 39 24 00 00       	call   80104b20 <memset>
...
8010271a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010271b:	e9 b0 23 00 00       	jmp    80104ad0 <release>
...
80102728:	e8 83 22 00 00       	call   801049b0 <acquire>
...
80102735:	68 ca 7a 10 80       	push   $0x80107aca
...
8010279b:	68 d0 7a 10 80       	push   $0x80107ad0
801027a0:	68 40 36 11 80       	push   $0x80113640
801027a5:	e8 06 21 00 00       	call   801048b0 <initlock>
...
8010288e:	e8 3d 22 00 00       	call   80104ad0 <release>
...
801028a8:	e8 03 21 00 00       	call   801049b0 <acquire>
  r = kmem.freelist;
...
80102906:	0f b6 82 00 7c 10 80 	movzbl -0x7fef8400(%edx),%eax
...
8010292e:	0f b6 82 00 7c 10 80 	movzbl -0x7fef8400(%edx),%eax
80102935:	09 c1                	or     %eax,%ecx
80102937:	0f b6 82 00 7b 10 80 	movzbl -0x7fef8500(%edx),%eax
...
8010294b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010294e:	8b 04 85 e0 7a 10 80 	mov    -0x7fef8520(,%eax,4),%eax
...
80102cb4:	e8 b7 1e 00 00       	call   80104b70 <memcmp>
...
80102de4:	e8 e7 1d 00 00       	call   80104bd0 <memmove>
...
80102e8a:	68 00 7d 10 80       	push   $0x80107d00
80102e8f:	68 80 36 11 80       	push   $0x80113680
80102e94:	e8 17 1a 00 00       	call   801048b0 <initlock>
  readsb(dev, &sb);
80102e99:	58                   	pop    %eax
...
80102f2b:	e8 80 1a 00 00       	call   801049b0 <acquire>
...
80102f7c:	e8 4f 1b 00 00       	call   80104ad0 <release>
      break;
    }
  }
}
...
80102f9e:	e8 0d 1a 00 00       	call   801049b0 <acquire>
  log.outstanding -= 1;
...
80102fdd:	e8 ee 1a 00 00       	call   80104ad0 <release>
}
...
8010303c:	e8 8f 1b 00 00       	call   80104bd0 <memmove>
...
80103085:	e8 26 19 00 00       	call   801049b0 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80103098:	00 00 00 
    wakeup(&log);
8010309b:	e8 50 15 00 00       	call   801045f0 <wakeup>
    release(&log.lock);
801030a0:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
801030a7:	e8 24 1a 00 00       	call   80104ad0 <release>
...
801030c8:	e8 23 15 00 00       	call   801045f0 <wakeup>
  }
  release(&log.lock);
801030cd:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
801030d4:	e8 f7 19 00 00       	call   80104ad0 <release>
...
801030e7:	68 04 7d 10 80       	push   $0x80107d04
...
8010313e:	e8 6d 18 00 00       	call   801049b0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
8010318d:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
8010318e:	e9 3d 19 00 00       	jmp    80104ad0 <release>
80103193:	90                   	nop
...
801031b3:	68 13 7d 10 80       	push   $0x80107d13
801031b8:	e8 b3 d1 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
801031bd:	83 ec 0c             	sub    $0xc,%esp
801031c0:	68 29 7d 10 80       	push   $0x80107d29
...
801031e8:	68 44 7d 10 80       	push   $0x80107d44
801031ed:	e8 6e d4 ff ff       	call   80100660 <cprintf>
    idtinit();       // load idt register
801031f2:	e8 09 2c 00 00       	call   80105e00 <idtinit>
...
80103213:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103216:	e8 05 3d 00 00       	call   80106f20 <switchkvm>
  seginit();
8010321b:	e8 00 3c 00 00       	call   80106e20 <seginit>
  lapicinit();
...
80103279:	e8 72 2e 00 00       	call   801060f0 <uartinit>
  pinit();         // process table
8010327e:	e8 9d 08 00 00       	call   80103b20 <pinit>
  tvinit();        // trap vectors
80103283:	e8 d8 2a 00 00       	call   80105d60 <tvinit>
  binit();         // buffer cache
...
801032a9:	e8 22 19 00 00       	call   80104bd0 <memmove>
...
80103378:	68 58 7d 10 80       	push   $0x80107d58
8010337d:	56                   	push   %esi
8010337e:	e8 ed 17 00 00       	call   80104b70 <memcmp>
...
8010343c:	68 5d 7d 10 80       	push   $0x80107d5d
80103441:	56                   	push   %esi
80103442:	e8 29 17 00 00       	call   80104b70 <memcmp>
...
801034d0:	ff 24 95 9c 7d 10 80 	jmp    *-0x7fef8264(,%edx,4)
...
80103577:	68 62 7d 10 80       	push   $0x80107d62
...
80103584:	68 7c 7d 10 80       	push   $0x80107d7c
...
80103630:	00 00 00 
  initlock(&p->lock, "pipe");
80103633:	68 b0 7d 10 80       	push   $0x80107db0
80103638:	50                   	push   %eax
80103639:	e8 72 12 00 00       	call   801048b0 <initlock>
  (*f0)->type = FD_PIPE;
...
801036cf:	e8 dc 12 00 00       	call   801049b0 <acquire>
  if(writable){
...
801036ef:	e8 fc 0e 00 00       	call   801045f0 <wakeup>
...
80103713:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103714:	e9 b7 13 00 00       	jmp    80104ad0 <release>
...
80103734:	e8 b7 0e 00 00       	call   801045f0 <wakeup>
...
80103744:	e8 87 13 00 00       	call   80104ad0 <release>
    kfree((char*)p);
...
8010376d:	e8 3e 12 00 00       	call   801049b0 <acquire>
  for(i = 0; i < n; i++){
...
801037c0:	e8 2b 0e 00 00       	call   801045f0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801037c5:	58                   	pop    %eax
801037c6:	5a                   	pop    %edx
...
801037f4:	e8 d7 12 00 00       	call   80104ad0 <release>
        return -1;
...
80103843:	e8 a8 0d 00 00       	call   801045f0 <wakeup>
  release(&p->lock);
80103848:	89 1c 24             	mov    %ebx,(%esp)
8010384b:	e8 80 12 00 00       	call   80104ad0 <release>
  return n;
...
80103870:	e8 3b 11 00 00       	call   801049b0 <acquire>
...
801038d9:	e8 f2 11 00 00       	call   80104ad0 <release>
      return -1;
...
8010393e:	e8 ad 0c 00 00       	call   801045f0 <wakeup>
  release(&p->lock);
80103943:	89 1c 24             	mov    %ebx,(%esp)
80103946:	e8 85 11 00 00       	call   80104ad0 <release>
  return i;
...
80103991:	e8 1a 10 00 00       	call   801049b0 <acquire>
...
8010399c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801039a0:	81 c3 50 04 00 00    	add    $0x450,%ebx
801039a6:	81 fb 54 61 12 80    	cmp    $0x80126154,%ebx
...
801039d3:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
    ...
    release(&ptable.lock);
801039d9:	e8 f2 10 00 00       	call   80104ad0 <release>
...
801039ff:	89 53 18             	mov    %edx,0x18(%ebx)
    ...
    sp -= 4;
    *(uint *) sp = (uint) trapret;
80103a02:	c7 40 14 52 5d 10 80 	movl   $0x80105d52,0x14(%eax)
...
80103a0e:	89 43 1c             	mov    %eax,0x1c(%ebx)
    memset(p->context, 0, sizeof *p->context);
80103a11:	e8 0a 11 00 00       	call   80104b20 <memset>
    p->context->eip = (uint) forkret;
80103a16:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a19:	8d 8b 00 04 00 00    	lea    0x400(%ebx),%ecx
80103a1f:	8d 93 40 04 00 00    	lea    0x440(%ebx),%edx
80103a25:	83 c4 10             	add    $0x10,%esp
80103a28:	c7 40 10 d0 3a 10 80 	movl   $0x80103ad0,0x10(%eax)

    //TODO INIT PROC PAGES FIELDS
    p->pagesCounter = 0;
80103a2f:	c7 83 44 04 00 00 00 	movl   $0x0,0x444(%ebx)
80103a36:	00 00 00 
80103a39:	89 c8                	mov    %ecx,%eax
    p->nextpageid = 1;
80103a3b:	c7 83 40 04 00 00 01 	movl   $0x1,0x440(%ebx)
80103a42:	00 00 00 
//    p->swapOffset = 0;
    p->pagesequel = 0;
80103a45:	c7 83 4c 04 00 00 00 	movl   $0x0,0x44c(%ebx)
80103a4c:	00 00 00 
    p->pagesinSwap = 0;
80103a4f:	c7 83 48 04 00 00 00 	movl   $0x0,0x448(%ebx)
80103a56:	00 00 00 
...
80103a7f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    ...
    //init proc's pages
    for( pg = p->pages ; pg < &p->pages[MAX_TOTAL_PAGES]; pg++ )
80103a86:	83 c0 1c             	add    $0x1c,%eax
    {
        pg->offset = 0;
        pg->pageid = 0;
        pg->present = 0;
80103a89:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
        pg->sequel = 0;
80103a90:	c7 40 ec 00 00 00 00 	movl   $0x0,-0x14(%eax)
        pg->physAdress = 0;
80103a97:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
        pg->virtAdress = 0;
80103a9e:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
    //init swap table
    for(int k=0; k<MAX_PSYC_PAGES ; k++)
        p->swapFileEntries[k]=0;
    ...
    //init proc's pages
    for( pg = p->pages ; pg < &p->pages[MAX_TOTAL_PAGES]; pg++ )
80103aa5:	39 c8                	cmp    %ecx,%eax
80103aa7:	72 cf                	jb     80103a78 <allocproc+0xf8>
...
80103ab8:	e8 13 10 00 00       	call   80104ad0 <release>
    return 0;
...
80103ac7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        return 0;
80103ace:	eb db                	jmp    80103aab <allocproc+0x12b>
...
80103adb:	e8 f0 0f 00 00       	call   80104ad0 <release>
...
80103b26:	68 b5 7d 10 80       	push   $0x80107db5
80103b2b:	68 20 4d 11 80       	push   $0x80114d20
80103b30:	e8 7b 0d 00 00       	call   801048b0 <initlock>
}
...
80103b9d:	68 bc 7d 10 80       	push   $0x80107dbc
...
80103baa:	68 98 7e 10 80       	push   $0x80107e98
...
80103be4:	83 ec 04             	sub    $0x4,%esp
    ...
    struct proc *p;
    pushcli();
80103be7:	e8 84 0d 00 00       	call   80104970 <pushcli>
    c = mycpu();
80103bec:	e8 4f ff ff ff       	call   80103b40 <mycpu>
    p = c->proc;
80103bf1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80103bf7:	e8 64 0e 00 00       	call   80104a60 <popcli>
    return p;
}
...
80103c23:	e8 48 39 00 00       	call   80107570 <setupkvm>
...
80103c41:	e8 0a 34 00 00       	call   80107050 <inituvm>
    p->sz = PGSIZE;
...
80103c56:	e8 c5 0e 00 00       	call   80104b20 <memset>
...
80103caf:	68 e5 7d 10 80       	push   $0x80107de5
80103cb4:	50                   	push   %eax
80103cb5:	e8 66 10 00 00       	call   80104d20 <safestrcpy>
    p->cwd = namei("/");
80103cba:	c7 04 24 ee 7d 10 80 	movl   $0x80107dee,(%esp)
...
80103cd0:	e8 db 0c 00 00       	call   801049b0 <acquire>
...
80103ce3:	e8 e8 0d 00 00       	call   80104ad0 <release>
}
...
80103cf3:	68 cc 7d 10 80       	push   $0x80107dcc
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
80103d08:	e8 63 0c 00 00       	call   80104970 <pushcli>
    c = mycpu();
80103d0d:	e8 2e fe ff ff       	call   80103b40 <mycpu>
    p = c->proc;
80103d12:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80103d18:	e8 43 0d 00 00       	call   80104a60 <popcli>
growproc(int n) {
    uint sz;
    struct proc *curproc = myproc();
...
80103d2e:	e8 8d 34 00 00       	call   801071c0 <allocuvm>
...
80103d40:	e8 fb 31 00 00       	call   80106f40 <switchuvm>
    return 0;
...
80103d64:	e8 57 37 00 00       	call   801074c0 <deallocuvm>
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
80103d89:	e8 e2 0b 00 00       	call   80104970 <pushcli>
    c = mycpu();
80103d8e:	e8 ad fd ff ff       	call   80103b40 <mycpu>
    p = c->proc;
80103d93:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80103d99:	e8 c2 0c 00 00       	call   80104a60 <popcli>
    int i, pid;
    struct proc *np;
    struct proc *curproc = myproc();
    struct page *pg , *cg;
...
80103dce:	e8 6d 38 00 00       	call   80107640 <copyuvm>
...
80103df8:	8b 83 40 04 00 00    	mov    0x440(%ebx),%eax
80103dfe:	89 82 40 04 00 00    	mov    %eax,0x440(%edx)
    np->pagesCounter = curproc->pagesCounter;
80103e04:	8b 83 44 04 00 00    	mov    0x444(%ebx),%eax
80103e0a:	89 82 44 04 00 00    	mov    %eax,0x444(%edx)
//    np->swapOffset = curproc->swapOffset;
    np->pagesequel = curproc->pagesequel;
80103e10:	8b 83 4c 04 00 00    	mov    0x44c(%ebx),%eax
80103e16:	89 82 4c 04 00 00    	mov    %eax,0x44c(%edx)
    np->pagesinSwap = curproc->pagesinSwap;
80103e1c:	8b 83 48 04 00 00    	mov    0x448(%ebx),%eax
80103e22:	89 82 48 04 00 00    	mov    %eax,0x448(%edx)
...
80103e30:	8b 8c 83 00 04 00 00 	mov    0x400(%ebx,%eax,4),%ecx
80103e37:	89 8c 82 00 04 00 00 	mov    %ecx,0x400(%edx,%eax,4)
//    np->swapOffset = curproc->swapOffset;
    np->pagesequel = curproc->pagesequel;
    np->pagesinSwap = curproc->pagesinSwap;
...
80103e52:	8d ba 00 04 00 00    	lea    0x400(%edx),%edi
80103e58:	90                   	nop
...
80103e60:	8b 71 10             	mov    0x10(%ecx),%esi
    ...
    for( pg = np->pages , cg = curproc->pages;
            pg < &np->pages[MAX_TOTAL_PAGES]; pg++ , cg++)
80103e63:	83 c0 1c             	add    $0x1c,%eax
80103e66:	83 c1 1c             	add    $0x1c,%ecx
    {
        pg->offset = cg->offset;
80103e69:	89 70 f4             	mov    %esi,-0xc(%eax)
        pg->pageid = cg->pageid;
80103e6c:	8b 71 e8             	mov    -0x18(%ecx),%esi
80103e6f:	89 70 e8             	mov    %esi,-0x18(%eax)
        pg->present = cg->present;
80103e72:	8b 71 f0             	mov    -0x10(%ecx),%esi
80103e75:	89 70 f0             	mov    %esi,-0x10(%eax)
        pg->sequel = cg->sequel;
80103e78:	8b 71 ec             	mov    -0x14(%ecx),%esi
80103e7b:	89 70 ec             	mov    %esi,-0x14(%eax)
        pg->physAdress = cg->physAdress;
80103e7e:	8b 71 f8             	mov    -0x8(%ecx),%esi
80103e81:	89 70 f8             	mov    %esi,-0x8(%eax)
        pg->virtAdress = cg->virtAdress;
80103e84:	8b 71 fc             	mov    -0x4(%ecx),%esi
80103e87:	89 70 fc             	mov    %esi,-0x4(%eax)
    //copy swap table
    for(int k=0; k<MAX_PSYC_PAGES ; k++)
        np->swapFileEntries[k]=curproc->swapFileEntries[k];
    ...
    //copy pages
    for( pg = np->pages , cg = curproc->pages;
80103e8a:	39 f8                	cmp    %edi,%eax
80103e8c:	72 d2                	jb     80103e60 <fork+0xe0>
        pg->physAdress = cg->physAdress;
        pg->virtAdress = cg->virtAdress;
    }
    ...
    if (!firstRun) {
80103e8e:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80103e93:	85 c0                	test   %eax,%eax
80103e95:	0f 85 c5 00 00 00    	jne    80103f60 <fork+0x1e0>
        //TODO PAGECOUNTER-16= PAGES IN SWAP FILE
        for( int k = 0 ; k < curproc->pagesCounter - MAX_PSYC_PAGES ; k++ ){
80103e9b:	83 bb 44 04 00 00 10 	cmpl   $0x10,0x444(%ebx)
80103ea2:	0f 8e b8 00 00 00    	jle    80103f60 <fork+0x1e0>
80103ea8:	31 ff                	xor    %edi,%edi
80103eaa:	eb 39                	jmp    80103ee5 <fork+0x165>
...
80103ecf:	0f 84 4b 01 00 00    	je     80104020 <fork+0x2a0>
    ...
    if (!firstRun) {
        //TODO PAGECOUNTER-16= PAGES IN SWAP FILE
        for( int k = 0 ; k < curproc->pagesCounter - MAX_PSYC_PAGES ; k++ ){
80103ed5:	8b 83 44 04 00 00    	mov    0x444(%ebx),%eax
...
80103ef7:	e8 24 0c 00 00       	call   80104b20 <memset>
...
80103fb7:	e8 64 0d 00 00       	call   80104d20 <safestrcpy>
...
80103fc9:	e8 e2 09 00 00       	call   801049b0 <acquire>
...
80103fdf:	e8 ec 0a 00 00       	call   80104ad0 <release>
...
8010408e:	e8 1d 09 00 00       	call   801049b0 <acquire>
...
80104099:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801040a0:	81 c3 50 04 00 00    	add    $0x450,%ebx
801040a6:	81 fb 54 61 12 80    	cmp    $0x80126154,%ebx
...
801040bd:	53                   	push   %ebx
        ...
        acquire(&ptable.lock);
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801040be:	81 c3 50 04 00 00    	add    $0x450,%ebx
            ...
            c->proc = p;
            switchuvm(p);
801040c4:	e8 77 2e 00 00       	call   80106f40 <switchuvm>
            p->state = RUNNING;

            swtch(&(c->scheduler), p->context);
801040c9:	58                   	pop    %eax
801040ca:	5a                   	pop    %edx
801040cb:	ff b3 cc fb ff ff    	pushl  -0x434(%ebx)
801040d1:	57                   	push   %edi
            ...
            switchuvm(p);
            p->state = RUNNING;
801040d2:	c7 83 bc fb ff ff 04 	movl   $0x4,-0x444(%ebx)
801040d9:	00 00 00 

            swtch(&(c->scheduler), p->context);
801040dc:	e8 9a 0c 00 00       	call   80104d7b <swtch>
            switchkvm();
801040e1:	e8 3a 2e 00 00       	call   80106f20 <switchkvm>
...
801040e6:	83 c4 10             	add    $0x10,%esp
        ...
        acquire(&ptable.lock);
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801040e9:	81 fb 54 61 12 80    	cmp    $0x80126154,%ebx
            swtch(&(c->scheduler), p->context);
            switchkvm();
...
80104108:	e8 c3 09 00 00       	call   80104ad0 <release>
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
80104125:	e8 46 08 00 00       	call   80104970 <pushcli>
    c = mycpu();
8010412a:	e8 11 fa ff ff       	call   80103b40 <mycpu>
    p = c->proc;
8010412f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104135:	e8 26 09 00 00       	call   80104a60 <popcli>
void
sched(void) {
    int intena;
...
80104142:	e8 e9 07 00 00       	call   80104930 <holding>
...
80104183:	e8 f3 0b 00 00       	call   80104d7b <swtch>
    mycpu()->intena = intena;
...
801041a0:	68 f0 7d 10 80       	push   $0x80107df0
...
801041ad:	68 1c 7e 10 80       	push   $0x80107e1c
...
801041ba:	68 0e 7e 10 80       	push   $0x80107e0e
...
801041c7:	68 02 7e 10 80       	push   $0x80107e02
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
801041e9:	e8 82 07 00 00       	call   80104970 <pushcli>
    c = mycpu();
801041ee:	e8 4d f9 ff ff       	call   80103b40 <mycpu>
    p = c->proc;
801041f3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
    popcli();
801041f9:	e8 62 08 00 00       	call   80104a60 <popcli>
exit(void) {
    struct proc *curproc = myproc();
    struct proc *p;
    int fd;
...
80104269:	e8 42 07 00 00       	call   801049b0 <acquire>
...
80104280:	05 50 04 00 00       	add    $0x450,%eax
80104285:	3d 54 61 12 80       	cmp    $0x80126154,%eax
...
wakeup1(void *chan) {
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010429e:	05 50 04 00 00       	add    $0x450,%eax
801042a3:	3d 54 61 12 80       	cmp    $0x80126154,%eax
...
801042b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ...
    // Pass abandoned children to init.
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801042c0:	81 c2 50 04 00 00    	add    $0x450,%edx
801042c6:	81 fa 54 61 12 80    	cmp    $0x80126154,%edx
...
wakeup1(void *chan) {
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042e8:	05 50 04 00 00       	add    $0x450,%eax
801042ed:	3d 54 61 12 80       	cmp    $0x80126154,%eax
...
80104317:	68 3d 7e 10 80       	push   $0x80107e3d
...
80104324:	68 30 7e 10 80       	push   $0x80107e30
...
8010433c:	e8 6f 06 00 00       	call   801049b0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
    struct cpu *c;
    struct proc *p;
    pushcli();
80104341:	e8 2a 06 00 00       	call   80104970 <pushcli>
    c = mycpu();
80104346:	e8 f5 f7 ff ff       	call   80103b40 <mycpu>
    p = c->proc;
8010434b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104351:	e8 0a 07 00 00       	call   80104a60 <popcli>
...
80104369:	e8 62 07 00 00       	call   80104ad0 <release>
}
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
8010438f:	e8 dc 05 00 00       	call   80104970 <pushcli>
    c = mycpu();
80104394:	e8 a7 f7 ff ff       	call   80103b40 <mycpu>
    p = c->proc;
80104399:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
8010439f:	e8 bc 06 00 00       	call   80104a60 <popcli>
// Reacquires lock when awakened.
void
sleep(void *chan, struct spinlock *lk) {
    struct proc *p = myproc();
...
801043c0:	e8 eb 05 00 00       	call   801049b0 <acquire>
        release(lk);
801043c5:	89 34 24             	mov    %esi,(%esp)
801043c8:	e8 03 07 00 00       	call   80104ad0 <release>
    }
    // Go to sleep.
    p->chan = chan;
...
801043ea:	e8 e1 06 00 00       	call   80104ad0 <release>
        acquire(lk);
...
801043fb:	5d                   	pop    %ebp
    ...
    if (lk != &ptable.lock) {  //DOC: sleeplock2
        release(&ptable.lock);
        acquire(lk);
801043fc:	e9 af 05 00 00       	jmp    801049b0 <acquire>
...
80104429:	68 4f 7e 10 80       	push   $0x80107e4f
...
80104436:	68 49 7e 10 80       	push   $0x80107e49
...
myproc(void) {
    ...
    struct proc *p;
    pushcli();
80104449:	e8 22 05 00 00       	call   80104970 <pushcli>
    c = mycpu();
8010444e:	e8 ed f6 ff ff       	call   80103b40 <mycpu>
    p = c->proc;
80104453:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
    popcli();
80104459:	e8 02 06 00 00       	call   80104a60 <popcli>
    struct proc *p;
    struct page *pg;
    int havekids, pid;
    struct proc *curproc = myproc();
...
80104466:	e8 45 05 00 00       	call   801049b0 <acquire>
...
80104480:	81 c3 50 04 00 00    	add    $0x450,%ebx
80104486:	81 fb 54 61 12 80    	cmp    $0x80126154,%ebx
...
80104497:	74 3d                	je     801044d6 <wait+0x96>
    ...
    for (;;) {
        ...
        havekids = 0;
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104499:	81 c3 50 04 00 00    	add    $0x450,%ebx
            if (p->parent != curproc)
                continue;
            havekids = 1;
8010449f:	b8 01 00 00 00       	mov    $0x1,%eax
    ...
    for (;;) {
        ...
        havekids = 0;
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801044a4:	81 fb 54 61 12 80    	cmp    $0x80126154,%ebx
...
801044b2:	0f 84 0f 01 00 00    	je     801045c7 <wait+0x187>
801044b8:	8b 46 24             	mov    0x24(%esi),%eax
801044bb:	85 c0                	test   %eax,%eax
801044bd:	0f 85 04 01 00 00    	jne    801045c7 <wait+0x187>
            release(&ptable.lock);
            return -1;
        }
...
801044ef:	e8 fc 2f 00 00       	call   801074f0 <freevm>
801044f4:	8d 8b 00 04 00 00    	lea    0x400(%ebx),%ecx
801044fa:	8d 93 40 04 00 00    	lea    0x440(%ebx),%edx
                p->pid = 0;
...
80104523:	89 c8                	mov    %ecx,%eax
                p->pagesCounter = -1;
80104525:	c7 83 44 04 00 00 ff 	movl   $0xffffffff,0x444(%ebx)
8010452c:	ff ff ff 
                p->nextpageid = 0;
8010452f:	c7 83 40 04 00 00 00 	movl   $0x0,0x440(%ebx)
80104536:	00 00 00 
//                p->swapOffset = 0;
                p->pagesequel = 0;
                p->pagesinSwap = 0;
...
//                p->swapOffset = 0;
                p->pagesequel = 0;
8010453b:	c7 83 4c 04 00 00 00 	movl   $0x0,0x44c(%ebx)
80104542:	00 00 00 
                p->pagesinSwap = 0;
80104545:	c7 83 48 04 00 00 00 	movl   $0x0,0x448(%ebx)
8010454c:	00 00 00 
8010454f:	90                   	nop
                //init swap table
                for(int k=0; k<MAX_PSYC_PAGES ; k++)
...
80104566:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
                ...
                //init proc's pages
                for( pg = p->pages ; pg < &p->pages[MAX_TOTAL_PAGES]; pg++ )
8010456d:	83 c3 1c             	add    $0x1c,%ebx
                {
                    pg->active = 0;
                    pg->offset = 0;
                    pg->pageid = 0;
80104570:	c7 43 e8 00 00 00 00 	movl   $0x0,-0x18(%ebx)
                    pg->present = -1;
80104577:	c7 43 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebx)
                    pg->sequel = -1;
8010457e:	c7 43 ec ff ff ff ff 	movl   $0xffffffff,-0x14(%ebx)
                    pg->physAdress = 0;
80104585:	c7 43 f8 00 00 00 00 	movl   $0x0,-0x8(%ebx)
                    pg->virtAdress = 0;
8010458c:	c7 43 fc 00 00 00 00 	movl   $0x0,-0x4(%ebx)
                //init swap table
                for(int k=0; k<MAX_PSYC_PAGES ; k++)
                    p->swapFileEntries[k]=0;
                ...
                //init proc's pages
                for( pg = p->pages ; pg < &p->pages[MAX_TOTAL_PAGES]; pg++ )
80104593:	39 d9                	cmp    %ebx,%ecx
80104595:	77 c9                	ja     80104560 <wait+0x120>
...
801045ab:	75 f3                	jne    801045a0 <wait+0x160>
                    p->swapFileEntries[k]=0;

                release(&ptable.lock);
801045ad:	83 ec 0c             	sub    $0xc,%esp
801045b0:	68 20 4d 11 80       	push   $0x80114d20
801045b5:	e8 16 05 00 00       	call   80104ad0 <release>
                return pid;
...
801045bd:	8d 65 f4             	lea    -0xc(%ebp),%esp
                //init swap table
                for(int k=0; k<MAX_PSYC_PAGES ; k++)
                    p->swapFileEntries[k]=0;
...
801045ca:	68 20 4d 11 80       	push   $0x80114d20
801045cf:	e8 fc 04 00 00       	call   80104ad0 <release>
            return -1;
...
801045f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
    acquire(&ptable.lock);
801045fa:	68 20 4d 11 80       	push   $0x80114d20
801045ff:	e8 ac 03 00 00       	call   801049b0 <acquire>
...
wakeup1(void *chan) {
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104607:	b8 54 4d 11 80       	mov    $0x80114d54,%eax
8010460c:	eb 0e                	jmp    8010461c <wakeup+0x2c>
8010460e:	66 90                	xchg   %ax,%ax
80104610:	05 50 04 00 00       	add    $0x450,%eax
80104615:	3d 54 61 12 80       	cmp    $0x80126154,%eax
8010461a:	74 1e                	je     8010463a <wakeup+0x4a>
        if (p->state == SLEEPING && p->chan == chan)
...
wakeup1(void *chan) {
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010462e:	05 50 04 00 00       	add    $0x450,%eax
80104633:	3d 54 61 12 80       	cmp    $0x80126154,%eax
...
wakeup(void *chan) {
    ...
    wakeup1(chan);
    release(&ptable.lock);
8010463a:	c7 45 08 20 4d 11 80 	movl   $0x80114d20,0x8(%ebp)
}
...
wakeup(void *chan) {
    ...
    wakeup1(chan);
    release(&ptable.lock);
80104645:	e9 86 04 00 00       	jmp    80104ad0 <release>
...
80104657:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    acquire(&ptable.lock);
8010465a:	68 20 4d 11 80       	push   $0x80114d20
8010465f:	e8 4c 03 00 00       	call   801049b0 <acquire>
80104664:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104667:	b8 54 4d 11 80       	mov    $0x80114d54,%eax
8010466c:	eb 0e                	jmp    8010467c <kill+0x2c>
8010466e:	66 90                	xchg   %ax,%ax
80104670:	05 50 04 00 00       	add    $0x450,%eax
80104675:	3d 54 61 12 80       	cmp    $0x80126154,%eax
8010467a:	74 3c                	je     801046b8 <kill+0x68>
        if (p->pid == pid) {
...
8010467f:	75 ef                	jne    80104670 <kill+0x20>
            ...
            if (p->state == SLEEPING)
80104681:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
    struct proc *p;
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
        if (p->pid == pid) {
            p->killed = 1;
80104685:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
            // Wake process from sleep if necessary.
            if (p->state == SLEEPING)
8010468c:	74 1a                	je     801046a8 <kill+0x58>
                p->state = RUNNABLE;
            release(&ptable.lock);
8010468e:	83 ec 0c             	sub    $0xc,%esp
80104691:	68 20 4d 11 80       	push   $0x80114d20
80104696:	e8 35 04 00 00       	call   80104ad0 <release>
            return 0;
...
801046af:	eb dd                	jmp    8010468e <kill+0x3e>
...
801046bb:	68 20 4d 11 80       	push   $0x80114d20
801046c0:	e8 0b 04 00 00       	call   80104ad0 <release>
    return -1;
...
801046e6:	8d 75 e8             	lea    -0x18(%ebp),%esi
801046e9:	bb c0 4d 11 80       	mov    $0x80114dc0,%ebx
801046ee:	83 ec 3c             	sub    $0x3c,%esp
801046f1:	eb 27                	jmp    8010471a <procdump+0x3a>
801046f3:	90                   	nop
...
801046fb:	68 d3 81 10 80       	push   $0x801081d3
80104700:	e8 5b bf ff ff       	call   80100660 <cprintf>
80104705:	83 c4 10             	add    $0x10,%esp
80104708:	81 c3 50 04 00 00    	add    $0x450,%ebx
    int i;
    struct proc *p;
    char *state;
    uint pc[10];
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010470e:	81 fb c0 61 12 80    	cmp    $0x801261c0,%ebx
80104714:	0f 84 7e 00 00 00    	je     80104798 <procdump+0xb8>
        if (p->state == UNUSED)
8010471a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010471d:	85 c0                	test   %eax,%eax
8010471f:	74 e7                	je     80104708 <procdump+0x28>
            continue;
        if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104721:	83 f8 05             	cmp    $0x5,%eax
            state = states[p->state];
        else
            state = "???";
80104724:	ba 60 7e 10 80       	mov    $0x80107e60,%edx
    uint pc[10];
    ...
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
        if (p->state == UNUSED)
            continue;
        if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104729:	77 11                	ja     8010473c <procdump+0x5c>
8010472b:	8b 14 85 c0 7e 10 80 	mov    -0x7fef8140(,%eax,4),%edx
            state = states[p->state];
        else
            state = "???";
80104732:	b8 60 7e 10 80       	mov    $0x80107e60,%eax
80104737:	85 d2                	test   %edx,%edx
80104739:	0f 44 d0             	cmove  %eax,%edx
        cprintf("%d %s %s", p->pid, state, p->name);
8010473c:	53                   	push   %ebx
8010473d:	52                   	push   %edx
8010473e:	ff 73 a4             	pushl  -0x5c(%ebx)
80104741:	68 64 7e 10 80       	push   $0x80107e64
80104746:	e8 15 bf ff ff       	call   80100660 <cprintf>
        if (p->state == SLEEPING) {
8010474b:	83 c4 10             	add    $0x10,%esp
8010474e:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104752:	75 a4                	jne    801046f8 <procdump+0x18>
            getcallerpcs((uint *) p->context->ebp + 2, pc);
80104754:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104757:	83 ec 08             	sub    $0x8,%esp
8010475a:	8d 7d c0             	lea    -0x40(%ebp),%edi
8010475d:	50                   	push   %eax
8010475e:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104761:	8b 40 0c             	mov    0xc(%eax),%eax
80104764:	83 c0 08             	add    $0x8,%eax
80104767:	50                   	push   %eax
80104768:	e8 63 01 00 00       	call   801048d0 <getcallerpcs>
8010476d:	83 c4 10             	add    $0x10,%esp
            for (i = 0; i < 10 && pc[i] != 0; i++)
80104770:	8b 17                	mov    (%edi),%edx
80104772:	85 d2                	test   %edx,%edx
80104774:	74 82                	je     801046f8 <procdump+0x18>
                cprintf(" %p", pc[i]);
80104776:	83 ec 08             	sub    $0x8,%esp
80104779:	83 c7 04             	add    $0x4,%edi
8010477c:	52                   	push   %edx
8010477d:	68 61 78 10 80       	push   $0x80107861
80104782:	e8 d9 be ff ff       	call   80100660 <cprintf>
        else
            state = "???";
        cprintf("%d %s %s", p->pid, state, p->name);
        if (p->state == SLEEPING) {
...
8010478a:	39 f7                	cmp    %esi,%edi
8010478c:	75 e2                	jne    80104770 <procdump+0x90>
8010478e:	e9 65 ff ff ff       	jmp    801046f8 <procdump+0x18>
80104793:	90                   	nop
...
801047aa:	68 d8 7e 10 80       	push   $0x80107ed8
801047af:	8d 43 04             	lea    0x4(%ebx),%eax
801047b2:	50                   	push   %eax
801047b3:	e8 f8 00 00 00       	call   801048b0 <initlock>
  lk->name = name;
...
801047ef:	e8 bc 01 00 00       	call   801049b0 <acquire>
  while (lk->locked) {
...
80104805:	e8 76 fb ff ff       	call   80104380 <sleep>
...
80104813:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104819:	e8 c2 f3 ff ff       	call   80103be0 <myproc>
...
8010484f:	e8 5c 01 00 00       	call   801049b0 <acquire>
  lk->locked = 0;
...
80104864:	e8 87 fd ff ff       	call   801045f0 <wakeup>
  release(&lk->lk);
...
8010488b:	8d 5e 04             	lea    0x4(%esi),%ebx
8010488e:	53                   	push   %ebx
8010488f:	e8 1c 01 00 00       	call   801049b0 <acquire>
  r = lk->locked;
80104894:	8b 36                	mov    (%esi),%esi
  release(&lk->lk);
80104896:	89 1c 24             	mov    %ebx,(%esp)
80104899:	e8 32 02 00 00       	call   80104ad0 <release>
  return r;
}
8010489e:	8d 65 f8             	lea    -0x8(%ebp),%esp
801048a1:	89 f0                	mov    %esi,%eax
801048a3:	5b                   	pop    %ebx
801048a4:	5e                   	pop    %esi
801048a5:	5d                   	pop    %ebp
801048a6:	c3                   	ret    
...
8010493a:	8b 02                	mov    (%edx),%eax
8010493c:	85 c0                	test   %eax,%eax
8010493e:	75 10                	jne    80104950 <holding+0x20>
}
...
{
  return lock->locked && lock->cpu == mycpu();
80104950:	8b 5a 08             	mov    0x8(%edx),%ebx
80104953:	e8 e8 f1 ff ff       	call   80103b40 <mycpu>
80104958:	39 c3                	cmp    %eax,%ebx
8010495a:	0f 94 c0             	sete   %al
}
8010495d:	83 c4 04             	add    $0x4,%esp
...
80104979:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010497a:	e8 c1 f1 ff ff       	call   80103b40 <mycpu>
...
8010498f:	e8 ac f1 ff ff       	call   80103b40 <mycpu>
...
801049b5:	e8 b6 ff ff ff       	call   80104970 <pushcli>
  if(holding(lk))
...
801049c1:	75 7d                	jne    80104a40 <acquire+0x90>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
801049c8:	eb 09                	jmp    801049d3 <acquire+0x23>
...
801049da:	75 f4                	jne    801049d0 <acquire+0x20>
    ;
...
801049e4:	e8 57 f1 ff ff       	call   80103b40 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
801049eb:	8d 4b 0c             	lea    0xc(%ebx),%ecx
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
...
801049f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801049f8:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
801049fe:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104a04:	77 1a                	ja     80104a20 <acquire+0x70>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104a06:	8b 5a 04             	mov    0x4(%edx),%ebx
80104a09:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
{
  uint *ebp;
  int i;
...
80104a0f:	8b 12                	mov    (%edx),%edx
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104a11:	83 f8 0a             	cmp    $0xa,%eax
80104a14:	75 e2                	jne    801049f8 <acquire+0x48>
  __sync_synchronize();
...
80104a1d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(; i < 10; i++)
    pcs[i] = 0;
80104a20:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80104a2a:	83 f8 0a             	cmp    $0xa,%eax
80104a2d:	74 e7                	je     80104a16 <acquire+0x66>
    pcs[i] = 0;
80104a2f:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104a36:	83 c0 01             	add    $0x1,%eax
80104a39:	83 f8 0a             	cmp    $0xa,%eax
80104a3c:	75 e2                	jne    80104a20 <acquire+0x70>
80104a3e:	eb d6                	jmp    80104a16 <acquire+0x66>
...
{
  return lock->locked && lock->cpu == mycpu();
80104a40:	8b 73 08             	mov    0x8(%ebx),%esi
80104a43:	e8 f8 f0 ff ff       	call   80103b40 <mycpu>
80104a48:	39 c6                	cmp    %eax,%esi
80104a4a:	0f 85 73 ff ff ff    	jne    801049c3 <acquire+0x13>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
80104a53:	68 e3 7e 10 80       	push   $0x80107ee3
...
80104a6b:	75 52                	jne    80104abf <popcli+0x5f>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104a6d:	e8 ce f0 ff ff       	call   80103b40 <mycpu>
80104a72:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80104a78:	8d 51 ff             	lea    -0x1(%ecx),%edx
80104a7b:	85 d2                	test   %edx,%edx
80104a7d:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80104a83:	78 2d                	js     80104ab2 <popcli+0x52>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104a85:	e8 b6 f0 ff ff       	call   80103b40 <mycpu>
80104a8a:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80104a90:	85 d2                	test   %edx,%edx
80104a92:	74 0c                	je     80104aa0 <popcli+0x40>
    sti();
}
80104a94:	c9                   	leave  
80104a95:	c3                   	ret    
...
80104a99:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104aa0:	e8 9b f0 ff ff       	call   80103b40 <mycpu>
80104aa5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80104aab:	85 c0                	test   %eax,%eax
80104aad:	74 e5                	je     80104a94 <popcli+0x34>
}
...
80104ab5:	68 02 7f 10 80       	push   $0x80107f02
80104aba:	e8 b1 b8 ff ff       	call   80100370 <panic>
...
80104ac2:	68 eb 7e 10 80       	push   $0x80107eeb
80104ac7:	e8 a4 b8 ff ff       	call   80100370 <panic>
...
{
  return lock->locked && lock->cpu == mycpu();
80104ad8:	8b 03                	mov    (%ebx),%eax
80104ada:	85 c0                	test   %eax,%eax
80104adc:	75 12                	jne    80104af0 <release+0x20>
// Release the lock.
void
release(struct spinlock *lk)
{
...
80104ae1:	68 09 7f 10 80       	push   $0x80107f09
...
{
  return lock->locked && lock->cpu == mycpu();
80104af0:	8b 73 08             	mov    0x8(%ebx),%esi
80104af3:	e8 48 f0 ff ff       	call   80103b40 <mycpu>
80104af8:	39 c6                	cmp    %eax,%esi
80104afa:	75 e2                	jne    80104ade <release+0xe>
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
  ...
  lk->pcs[0] = 0;
80104afc:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104b03:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  // Tell the C compiler and the processor to not move loads or stores
  ...
  __sync_synchronize();
80104b0a:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
...
80104b1a:	5d                   	pop    %ebp
  ...
  popcli();
80104b1b:	e9 40 ff ff ff       	jmp    80104a60 <popcli>
...
80104d97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d9a:	e8 41 ee ff ff       	call   80103be0 <myproc>
...
80104dd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104dda:	e8 01 ee ff ff       	call   80103be0 <myproc>
...
80104e35:	e8 a6 ed ff ff       	call   80103be0 <myproc>
...
{
  struct proc *curproc = myproc();
80104e46:	e8 95 ed ff ff       	call   80103be0 <myproc>
...
80104e88:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104e8b:	e8 50 ed ff ff       	call   80103be0 <myproc>
...
80104f24:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104f25:	e8 b6 ec ff ff       	call   80103be0 <myproc>

  num = curproc->tf->eax;
80104f2a:	8b 70 18             	mov    0x18(%eax),%esi
...
80104f2d:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104f2f:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104f32:	8d 50 ff             	lea    -0x1(%eax),%edx
80104f35:	83 fa 15             	cmp    $0x15,%edx
80104f38:	77 1e                	ja     80104f58 <syscall+0x38>
80104f3a:	8b 14 85 40 7f 10 80 	mov    -0x7fef80c0(,%eax,4),%edx
80104f41:	85 d2                	test   %edx,%edx
80104f43:	74 13                	je     80104f58 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104f45:	ff d2                	call   *%edx
80104f47:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104f60:	68 11 7f 10 80       	push   $0x80107f11
...
80104f92:	e8 99 fe ff ff       	call   80104e30 <argint>
80104f97:	83 c4 10             	add    $0x10,%esp
80104f9a:	85 c0                	test   %eax,%eax
80104f9c:	78 32                	js     80104fd0 <argfd.constprop.0+0x50>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104f9e:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104fa2:	77 2c                	ja     80104fd0 <argfd.constprop.0+0x50>
80104fa4:	e8 37 ec ff ff       	call   80103be0 <myproc>
80104fa9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fac:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104fb0:	85 c0                	test   %eax,%eax
80104fb2:	74 1c                	je     80104fd0 <argfd.constprop.0+0x50>
    return -1;
  if(pfd)
80104fb4:	85 f6                	test   %esi,%esi
80104fb6:	74 02                	je     80104fba <argfd.constprop.0+0x3a>
    *pfd = fd;
80104fb8:	89 16                	mov    %edx,(%esi)
  if(pf)
80104fba:	85 db                	test   %ebx,%ebx
80104fbc:	74 22                	je     80104fe0 <argfd.constprop.0+0x60>
    *pf = f;
...
80104fe2:	eb de                	jmp    80104fc2 <argfd.constprop.0+0x42>
...
80104ffa:	83 ec 10             	sub    $0x10,%esp
  ...
  if(argfd(0, 0, &f) < 0)
80104ffd:	e8 7e ff ff ff       	call   80104f80 <argfd.constprop.0>
80105002:	85 c0                	test   %eax,%eax
80105004:	78 1a                	js     80105020 <sys_dup+0x30>
...
80105006:	31 db                	xor    %ebx,%ebx
  ...
  if(argfd(0, 0, &f) < 0)
    return -1;
  if((fd=fdalloc(f)) < 0)
80105008:	8b 75 f4             	mov    -0xc(%ebp),%esi
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
8010500b:	e8 d0 eb ff ff       	call   80103be0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
80105010:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105014:	85 d2                	test   %edx,%edx
80105016:	74 18                	je     80105030 <sys_dup+0x40>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
8010501e:	75 f0                	jne    80105010 <sys_dup+0x20>
    return -1;
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
...
8010502c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80105030:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
...
8010503a:	e8 d1 bd ff ff       	call   80100e10 <filedup>
  return fd;
...
8010505b:	e8 20 ff ff ff       	call   80104f80 <argfd.constprop.0>
...
8010506d:	e8 be fd ff ff       	call   80104e30 <argint>
...
80105085:	e8 f6 fd ff ff       	call   80104e80 <argptr>
...
8010509d:	e8 de be ff ff       	call   80100f80 <fileread>
...
801050cb:	e8 b0 fe ff ff       	call   80104f80 <argfd.constprop.0>
...
801050dd:	e8 4e fd ff ff       	call   80104e30 <argint>
...
801050f5:	e8 86 fd ff ff       	call   80104e80 <argptr>
...
8010510d:	e8 fe be ff ff       	call   80101010 <filewrite>
...
8010513c:	e8 3f fe ff ff       	call   80104f80 <argfd.constprop.0>
80105141:	85 c0                	test   %eax,%eax
80105143:	78 2b                	js     80105170 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80105145:	e8 96 ea ff ff       	call   80103be0 <myproc>
...
8010515b:	e8 00 bd ff ff       	call   80100e60 <fileclose>
  return 0;
...
8010518b:	e8 f0 fd ff ff       	call   80104f80 <argfd.constprop.0>
...
8010519f:	e8 dc fc ff ff       	call   80104e80 <argptr>
...
801051b4:	e8 77 bd ff ff       	call   80100f30 <filestat>
...
801051df:	e8 fc fc ff ff       	call   80104ee0 <argstr>
...
801051f8:	e8 e3 fc ff ff       	call   80104ee0 <argstr>
...
80105229:	e8 72 c4 ff ff       	call   801016a0 <ilock>
  if(ip->type == T_DIR){
8010522e:	83 c4 10             	add    $0x10,%esp
80105231:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105236:	0f 84 c4 00 00 00    	je     80105300 <sys_link+0x130>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105248:	e8 a3 c3 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
8010524d:	89 1c 24             	mov    %ebx,(%esp)
80105250:	e8 2b c5 ff ff       	call   80101780 <iunlock>
...
8010525b:	e8 b0 cc ff ff       	call   80101f10 <nameiparent>
...
8010526d:	e8 2e c4 ff ff       	call   801016a0 <ilock>
...
80105283:	e8 a8 cb ff ff       	call   80101e30 <dirlink>
...
80105293:	e8 98 c6 ff ff       	call   80101930 <iunlockput>
  iput(ip);
80105298:	89 1c 24             	mov    %ebx,(%esp)
8010529b:	e8 30 c5 ff ff       	call   801017d0 <iput>

  end_op();
801052a0:	e8 eb dc ff ff       	call   80102f90 <end_op>
...
801052bc:	e8 6f c6 ff ff       	call   80101930 <iunlockput>
    goto bad;
...
801052c8:	e8 d3 c3 ff ff       	call   801016a0 <ilock>
  ip->nlink--;
801052cd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801052d2:	89 1c 24             	mov    %ebx,(%esp)
801052d5:	e8 16 c3 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
801052da:	89 1c 24             	mov    %ebx,(%esp)
801052dd:	e8 4e c6 ff ff       	call   80101930 <iunlockput>
  end_op();
...
80105304:	e8 27 c6 ff ff       	call   80101930 <iunlockput>
    end_op();
80105309:	e8 82 dc ff ff       	call   80102f90 <end_op>
    return -1;
8010530e:	83 c4 10             	add    $0x10,%esp
80105311:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105316:	eb 92                	jmp    801052aa <sys_link+0xda>
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
    return -1;
  ...
  if((ip = namei(old)) == 0){
    end_op();
80105318:	e8 73 dc ff ff       	call   80102f90 <end_op>
    return -1;
8010531d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105322:	eb 86                	jmp    801052aa <sys_link+0xda>
...
80105336:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105339:	bb 20 00 00 00       	mov    $0x20,%ebx
8010533e:	83 ec 1c             	sub    $0x1c,%esp
80105341:	8b 75 08             	mov    0x8(%ebp),%esi
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105344:	83 7e 58 20          	cmpl   $0x20,0x58(%esi)
80105348:	77 0e                	ja     80105358 <isdirempty+0x28>
8010534a:	eb 34                	jmp    80105380 <isdirempty+0x50>
8010534c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105350:	83 c3 10             	add    $0x10,%ebx
80105353:	39 5e 58             	cmp    %ebx,0x58(%esi)
80105356:	76 28                	jbe    80105380 <isdirempty+0x50>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105358:	6a 10                	push   $0x10
8010535a:	53                   	push   %ebx
8010535b:	57                   	push   %edi
8010535c:	56                   	push   %esi
8010535d:	e8 1e c6 ff ff       	call   80101980 <readi>
80105362:	83 c4 10             	add    $0x10,%esp
80105365:	83 f8 10             	cmp    $0x10,%eax
80105368:	75 23                	jne    8010538d <isdirempty+0x5d>
      panic("isdirempty: readi");
    if(de.inum != 0)
8010536a:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
8010536f:	74 df                	je     80105350 <isdirempty+0x20>
      return 0;
  }
  return 1;
}
...
80105390:	68 9c 7f 10 80       	push   $0x80107f9c
80105395:	e8 d6 af ff ff       	call   80100370 <panic>
...
801053b9:	0f 88 51 01 00 00    	js     80105510 <sys_unlink+0x170>
    return -1;
...
801053bf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
801053c2:	e8 59 db ff ff       	call   80102f20 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
801053da:	0f 84 37 01 00 00    	je     80105517 <sys_unlink+0x177>
    end_op();
    return -1;
  }
...
801053e4:	e8 b7 c2 ff ff       	call   801016a0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801053e9:	58                   	pop    %eax
801053ea:	5a                   	pop    %edx
801053eb:	68 9d 79 10 80       	push   $0x8010799d
801053f0:	53                   	push   %ebx
801053f1:	e8 ba c7 ff ff       	call   80101bb0 <namecmp>
801053f6:	83 c4 10             	add    $0x10,%esp
801053f9:	85 c0                	test   %eax,%eax
801053fb:	0f 84 d3 00 00 00    	je     801054d4 <sys_unlink+0x134>
80105401:	83 ec 08             	sub    $0x8,%esp
80105404:	68 9c 79 10 80       	push   $0x8010799c
80105409:	53                   	push   %ebx
8010540a:	e8 a1 c7 ff ff       	call   80101bb0 <namecmp>
8010540f:	83 c4 10             	add    $0x10,%esp
80105412:	85 c0                	test   %eax,%eax
80105414:	0f 84 ba 00 00 00    	je     801054d4 <sys_unlink+0x134>
    goto bad;
...
80105423:	e8 a8 c7 ff ff       	call   80101bd0 <dirlookup>
80105428:	83 c4 10             	add    $0x10,%esp
8010542b:	85 c0                	test   %eax,%eax
8010542d:	89 c3                	mov    %eax,%ebx
8010542f:	0f 84 9f 00 00 00    	je     801054d4 <sys_unlink+0x134>
    goto bad;
  ilock(ip);
80105435:	83 ec 0c             	sub    $0xc,%esp
80105438:	50                   	push   %eax
80105439:	e8 62 c2 ff ff       	call   801016a0 <ilock>

  if(ip->nlink < 1)
8010543e:	83 c4 10             	add    $0x10,%esp
80105441:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80105446:	0f 8e e4 00 00 00    	jle    80105530 <sys_unlink+0x190>
    panic("unlink: nlink < 1");
  if(ip->type == T_DIR && !isdirempty(ip)){
8010544c:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105451:	74 65                	je     801054b8 <sys_unlink+0x118>
    iunlockput(ip);
    goto bad;
  }

  memset(&de, 0, sizeof(de));
80105453:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105456:	83 ec 04             	sub    $0x4,%esp
80105459:	6a 10                	push   $0x10
8010545b:	6a 00                	push   $0x0
8010545d:	57                   	push   %edi
8010545e:	e8 bd f6 ff ff       	call   80104b20 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105463:	6a 10                	push   $0x10
80105465:	ff 75 c4             	pushl  -0x3c(%ebp)
80105468:	57                   	push   %edi
80105469:	56                   	push   %esi
8010546a:	e8 11 c6 ff ff       	call   80101a80 <writei>
8010546f:	83 c4 20             	add    $0x20,%esp
80105472:	83 f8 10             	cmp    $0x10,%eax
80105475:	0f 85 a8 00 00 00    	jne    80105523 <sys_unlink+0x183>
    panic("unlink: writei");
  if(ip->type == T_DIR){
8010547b:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105480:	74 76                	je     801054f8 <sys_unlink+0x158>
    dp->nlink--;
    iupdate(dp);
  }
  iunlockput(dp);
...
80105486:	e8 a5 c4 ff ff       	call   80101930 <iunlockput>

  ip->nlink--;
8010548b:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105490:	89 1c 24             	mov    %ebx,(%esp)
80105493:	e8 58 c1 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80105498:	89 1c 24             	mov    %ebx,(%esp)
8010549b:	e8 90 c4 ff ff       	call   80101930 <iunlockput>

  end_op();
801054a0:	e8 eb da ff ff       	call   80102f90 <end_op>
...
801054bc:	e8 6f fe ff ff       	call   80105330 <isdirempty>
801054c1:	83 c4 10             	add    $0x10,%esp
801054c4:	85 c0                	test   %eax,%eax
801054c6:	75 8b                	jne    80105453 <sys_unlink+0xb3>
    iunlockput(ip);
801054c8:	83 ec 0c             	sub    $0xc,%esp
801054cb:	53                   	push   %ebx
801054cc:	e8 5f c4 ff ff       	call   80101930 <iunlockput>
    goto bad;
...
801054d8:	e8 53 c4 ff ff       	call   80101930 <iunlockput>
  end_op();
801054dd:	e8 ae da ff ff       	call   80102f90 <end_op>
  return -1;
...
801054f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  if(ip->type == T_DIR){
    dp->nlink--;
801054f8:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
801054fd:	83 ec 0c             	sub    $0xc,%esp
80105500:	56                   	push   %esi
80105501:	e8 ea c0 ff ff       	call   801015f0 <iupdate>
80105506:	83 c4 10             	add    $0x10,%esp
80105509:	e9 74 ff ff ff       	jmp    80105482 <sys_unlink+0xe2>
...
80105515:	eb 93                	jmp    801054aa <sys_unlink+0x10a>

  begin_op();
  if((dp = nameiparent(path, name)) == 0){
    end_op();
80105517:	e8 74 da ff ff       	call   80102f90 <end_op>
    return -1;
8010551c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105521:	eb 87                	jmp    801054aa <sys_unlink+0x10a>
    goto bad;
  }
...
80105526:	68 b1 79 10 80       	push   $0x801079b1
...
80105533:	68 9f 79 10 80       	push   $0x8010799f
80105538:	e8 33 ae ff ff       	call   80100370 <panic>
...
80105545:	53                   	push   %ebx
  ...
  if((dp = nameiparent(path, name)) == 0)
80105546:	8d 75 da             	lea    -0x26(%ebp),%esi
  return -1;
}
...
80105552:	8b 4d 14             	mov    0x14(%ebp),%ecx
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105556:	ff 75 08             	pushl  0x8(%ebp)
  return -1;
}
...
create(char *path, short type, short major, short minor)
{
80105559:	89 45 c4             	mov    %eax,-0x3c(%ebp)
8010555c:	89 55 c0             	mov    %edx,-0x40(%ebp)
8010555f:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105562:	e8 a9 c9 ff ff       	call   80101f10 <nameiparent>
80105567:	83 c4 10             	add    $0x10,%esp
8010556a:	85 c0                	test   %eax,%eax
8010556c:	0f 84 ee 00 00 00    	je     80105660 <create+0x120>
    return 0;
  ilock(dp);
80105572:	83 ec 0c             	sub    $0xc,%esp
80105575:	89 c7                	mov    %eax,%edi
80105577:	50                   	push   %eax
80105578:	e8 23 c1 ff ff       	call   801016a0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
8010557d:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80105580:	83 c4 0c             	add    $0xc,%esp
80105583:	50                   	push   %eax
80105584:	56                   	push   %esi
80105585:	57                   	push   %edi
80105586:	e8 45 c6 ff ff       	call   80101bd0 <dirlookup>
8010558b:	83 c4 10             	add    $0x10,%esp
8010558e:	85 c0                	test   %eax,%eax
80105590:	89 c3                	mov    %eax,%ebx
80105592:	74 4c                	je     801055e0 <create+0xa0>
    iunlockput(dp);
80105594:	83 ec 0c             	sub    $0xc,%esp
80105597:	57                   	push   %edi
80105598:	e8 93 c3 ff ff       	call   80101930 <iunlockput>
    ilock(ip);
8010559d:	89 1c 24             	mov    %ebx,(%esp)
801055a0:	e8 fb c0 ff ff       	call   801016a0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801055a5:	83 c4 10             	add    $0x10,%esp
801055a8:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
801055ad:	75 11                	jne    801055c0 <create+0x80>
801055af:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
801055b4:	89 d8                	mov    %ebx,%eax
801055b6:	75 08                	jne    801055c0 <create+0x80>
...
801055c4:	e8 67 c3 ff ff       	call   80101930 <iunlockput>
    return 0;
...
801055e0:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
801055e4:	83 ec 08             	sub    $0x8,%esp
801055e7:	50                   	push   %eax
801055e8:	ff 37                	pushl  (%edi)
801055ea:	e8 41 bf ff ff       	call   80101530 <ialloc>
801055ef:	83 c4 10             	add    $0x10,%esp
801055f2:	85 c0                	test   %eax,%eax
801055f4:	89 c3                	mov    %eax,%ebx
801055f6:	0f 84 cc 00 00 00    	je     801056c8 <create+0x188>
    panic("create: ialloc");

  ilock(ip);
801055fc:	83 ec 0c             	sub    $0xc,%esp
801055ff:	50                   	push   %eax
80105600:	e8 9b c0 ff ff       	call   801016a0 <ilock>
  ip->major = major;
80105605:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80105609:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
8010560d:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80105611:	66 89 43 54          	mov    %ax,0x54(%ebx)
  ip->nlink = 1;
80105615:	b8 01 00 00 00       	mov    $0x1,%eax
8010561a:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010561e:	89 1c 24             	mov    %ebx,(%esp)
80105621:	e8 ca bf ff ff       	call   801015f0 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105626:	83 c4 10             	add    $0x10,%esp
80105629:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
8010562e:	74 40                	je     80105670 <create+0x130>
...
80105633:	ff 73 04             	pushl  0x4(%ebx)
80105636:	56                   	push   %esi
80105637:	57                   	push   %edi
80105638:	e8 f3 c7 ff ff       	call   80101e30 <dirlink>
8010563d:	83 c4 10             	add    $0x10,%esp
80105640:	85 c0                	test   %eax,%eax
80105642:	78 77                	js     801056bb <create+0x17b>
    panic("create: dirlink");

  iunlockput(dp);
80105644:	83 ec 0c             	sub    $0xc,%esp
80105647:	57                   	push   %edi
80105648:	e8 e3 c2 ff ff       	call   80101930 <iunlockput>
...
80105662:	e9 51 ff ff ff       	jmp    801055b8 <create+0x78>
...
80105669:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  if(type == T_DIR){  // Create . and .. entries.
    dp->nlink++;  // for ".."
80105670:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80105675:	83 ec 0c             	sub    $0xc,%esp
80105678:	57                   	push   %edi
80105679:	e8 72 bf ff ff       	call   801015f0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010567e:	83 c4 0c             	add    $0xc,%esp
80105681:	ff 73 04             	pushl  0x4(%ebx)
80105684:	68 9d 79 10 80       	push   $0x8010799d
80105689:	53                   	push   %ebx
8010568a:	e8 a1 c7 ff ff       	call   80101e30 <dirlink>
8010568f:	83 c4 10             	add    $0x10,%esp
80105692:	85 c0                	test   %eax,%eax
80105694:	78 18                	js     801056ae <create+0x16e>
80105696:	83 ec 04             	sub    $0x4,%esp
80105699:	ff 77 04             	pushl  0x4(%edi)
8010569c:	68 9c 79 10 80       	push   $0x8010799c
801056a1:	53                   	push   %ebx
801056a2:	e8 89 c7 ff ff       	call   80101e30 <dirlink>
801056a7:	83 c4 10             	add    $0x10,%esp
801056aa:	85 c0                	test   %eax,%eax
801056ac:	79 82                	jns    80105630 <create+0xf0>
      panic("create dots");
801056ae:	83 ec 0c             	sub    $0xc,%esp
801056b1:	68 bd 7f 10 80       	push   $0x80107fbd
801056b6:	e8 b5 ac ff ff       	call   80100370 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801056bb:	83 ec 0c             	sub    $0xc,%esp
801056be:	68 c9 7f 10 80       	push   $0x80107fc9
801056c3:	e8 a8 ac ff ff       	call   80100370 <panic>
    iunlockput(ip);
    return 0;
  }
...
801056cb:	68 ae 7f 10 80       	push   $0x80107fae
801056d0:	e8 9b ac ff ff       	call   80100370 <panic>
801056d5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80105712:	0f 88 85 00 00 00    	js     8010579d <sys_open+0xbd>
  ...
  begin_op();
80105718:	e8 03 d8 ff ff       	call   80102f20 <begin_op>
...
8010572d:	e8 be c7 ff ff       	call   80101ef0 <namei>
80105732:	83 c4 10             	add    $0x10,%esp
80105735:	85 c0                	test   %eax,%eax
80105737:	89 c6                	mov    %eax,%esi
80105739:	0f 84 88 00 00 00    	je     801057c7 <sys_open+0xe7>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105743:	e8 58 bf ff ff       	call   801016a0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105748:	83 c4 10             	add    $0x10,%esp
8010574b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105750:	0f 84 ca 00 00 00    	je     80105820 <sys_open+0x140>
      end_op();
      return -1;
    }
  }
...
80105756:	e8 45 b6 ff ff       	call   80100da0 <filealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105763:	e8 78 e4 ff ff       	call   80103be0 <myproc>
80105768:	90                   	nop
...
80105776:	74 60                	je     801057d8 <sys_open+0xf8>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
80105784:	e8 d7 b6 ff ff       	call   80100e60 <fileclose>
80105789:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010578c:	83 ec 0c             	sub    $0xc,%esp
8010578f:	56                   	push   %esi
80105790:	e8 9b c1 ff ff       	call   80101930 <iunlockput>
    end_op();
80105795:	e8 f6 d7 ff ff       	call   80102f90 <end_op>
    return -1;
...
801057b4:	6a 02                	push   $0x2
801057b6:	ff 75 e0             	pushl  -0x20(%ebp)
801057b9:	e8 82 fd ff ff       	call   80105540 <create>
    if(ip == 0){
...
801057c3:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801057c5:	75 8f                	jne    80105756 <sys_open+0x76>
      end_op();
801057c7:	e8 c4 d7 ff ff       	call   80102f90 <end_op>
      return -1;
801057cc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057d1:	eb 41                	jmp    80105814 <sys_open+0x134>
801057d3:	90                   	nop
...
801057d8:	83 ec 0c             	sub    $0xc,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
801057db:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801057e0:	e8 9b bf ff ff       	call   80101780 <iunlock>
  end_op();
801057e5:	e8 a6 d7 ff ff       	call   80102f90 <end_op>

  f->type = FD_INODE;
801057ea:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801057f0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801057f3:	83 c4 10             	add    $0x10,%esp
  ...
  f->type = FD_INODE;
  f->ip = ip;
801057f6:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
801057f9:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105800:	89 d0                	mov    %edx,%eax
80105802:	83 e0 01             	and    $0x1,%eax
80105805:	83 f0 01             	xor    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105808:	83 e2 03             	and    $0x3,%edx
  end_op();
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
8010580b:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010580e:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
...
80105825:	0f 84 2b ff ff ff    	je     80105756 <sys_open+0x76>
8010582b:	e9 5c ff ff ff       	jmp    8010578c <sys_open+0xac>
...
80105854:	6a 01                	push   $0x1
80105856:	ff 75 f4             	pushl  -0xc(%ebp)
80105859:	e8 e2 fc ff ff       	call   80105540 <create>
8010585e:	83 c4 10             	add    $0x10,%esp
80105861:	85 c0                	test   %eax,%eax
80105863:	74 1b                	je     80105880 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105869:	e8 c2 c0 ff ff       	call   80101930 <iunlockput>
  end_op();
8010586e:	e8 1d d7 ff ff       	call   80102f90 <end_op>
  return 0;
...
8010587a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
80105880:	e8 0b d7 ff ff       	call   80102f90 <end_op>
    return -1;
...
801058b9:	e8 72 f5 ff ff       	call   80104e30 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
801058ce:	e8 5d f5 ff ff       	call   80104e30 <argint>
  char *path;
  int major, minor;
...
801058df:	0f bf 45 f0          	movswl -0x10(%ebp),%eax
801058e3:	50                   	push   %eax
801058e4:	6a 03                	push   $0x3
801058e6:	ff 75 ec             	pushl  -0x14(%ebp)
801058e9:	e8 52 fc ff ff       	call   80105540 <create>
801058ee:	83 c4 10             	add    $0x10,%esp
801058f1:	85 c0                	test   %eax,%eax
801058f3:	74 1b                	je     80105910 <sys_mknod+0x80>
...
801058f9:	e8 32 c0 ff ff       	call   80101930 <iunlockput>
  end_op();
801058fe:	e8 8d d6 ff ff       	call   80102f90 <end_op>
  return 0;
...
8010594f:	e8 9c c5 ff ff       	call   80101ef0 <namei>
...
80105961:	e8 3a bd ff ff       	call   801016a0 <ilock>
  if(ip->type != T_DIR){
...
80105974:	e8 07 be ff ff       	call   80101780 <iunlock>
  iput(curproc->cwd);
80105979:	58                   	pop    %eax
8010597a:	ff 76 68             	pushl  0x68(%esi)
8010597d:	e8 4e be ff ff       	call   801017d0 <iput>
  end_op();
80105982:	e8 09 d6 ff ff       	call   80102f90 <end_op>
  curproc->cwd = ip;
...
801059a4:	e8 87 bf ff ff       	call   80101930 <iunlockput>
    end_op();
801059a9:	e8 e2 d5 ff ff       	call   80102f90 <end_op>
    return -1;
...
801059b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
801059c0:	e8 cb d5 ff ff       	call   80102f90 <end_op>
    return -1;
...
801059e5:	e8 f6 f4 ff ff       	call   80104ee0 <argstr>
801059ea:	83 c4 10             	add    $0x10,%esp
801059ed:	85 c0                	test   %eax,%eax
801059ef:	78 7f                	js     80105a70 <sys_exec+0xa0>
801059f1:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801059f7:	83 ec 08             	sub    $0x8,%esp
801059fa:	50                   	push   %eax
801059fb:	6a 01                	push   $0x1
801059fd:	e8 2e f4 ff ff       	call   80104e30 <argint>
80105a02:	83 c4 10             	add    $0x10,%esp
80105a05:	85 c0                	test   %eax,%eax
80105a07:	78 67                	js     80105a70 <sys_exec+0xa0>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105a09:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105a0f:	83 ec 04             	sub    $0x4,%esp
80105a12:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
...
80105a28:	e8 f3 f0 ff ff       	call   80104b20 <memset>
80105a2d:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105a30:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105a36:	83 ec 08             	sub    $0x8,%esp
80105a39:	57                   	push   %edi
80105a3a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80105a3d:	50                   	push   %eax
80105a3e:	e8 4d f3 ff ff       	call   80104d90 <fetchint>
80105a43:	83 c4 10             	add    $0x10,%esp
80105a46:	85 c0                	test   %eax,%eax
80105a48:	78 26                	js     80105a70 <sys_exec+0xa0>
      return -1;
    if(uarg == 0){
80105a4a:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105a50:	85 c0                	test   %eax,%eax
80105a52:	74 2c                	je     80105a80 <sys_exec+0xb0>
      argv[i] = 0;
      break;
    }
...
80105a63:	78 0b                	js     80105a70 <sys_exec+0xa0>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80105a65:	83 c3 01             	add    $0x1,%ebx
80105a68:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
80105a6b:	83 fb 20             	cmp    $0x20,%ebx
80105a6e:	75 c0                	jne    80105a30 <sys_exec+0x60>
    }
    if(fetchstr(uarg, &argv[i]) < 0)
      return -1;
  }
...
80105a70:	8d 65 f4             	lea    -0xc(%ebp),%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;
...
80105a9b:	e8 50 af ff ff       	call   801009f0 <exec>
...
80105ae6:	8b 7d e0             	mov    -0x20(%ebp),%edi
// Takes over file reference from caller on success.
static int
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105ae9:	e8 f2 e0 ff ff       	call   80103be0 <myproc>
...
80105af6:	74 30                	je     80105b28 <sys_pipe+0x78>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
80105b03:	ff 75 e0             	pushl  -0x20(%ebp)
80105b06:	e8 55 b3 ff ff       	call   80100e60 <fileclose>
    fileclose(wf);
80105b0b:	58                   	pop    %eax
80105b0c:	ff 75 e4             	pushl  -0x1c(%ebp)
80105b0f:	e8 4c b3 ff ff       	call   80100e60 <fileclose>
    return -1;
...
80105b24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
80105b28:	8d 73 08             	lea    0x8(%ebx),%esi
80105b2b:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105b2f:	8b 7d e4             	mov    -0x1c(%ebp),%edi
// Takes over file reference from caller on success.
static int
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105b32:	e8 a9 e0 ff ff       	call   80103be0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
80105b37:	31 d2                	xor    %edx,%edx
...
80105b46:	74 18                	je     80105b60 <sys_pipe+0xb0>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
80105b4e:	75 f0                	jne    80105b40 <sys_pipe+0x90>
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105b50:	e8 8b e0 ff ff       	call   80103be0 <myproc>
80105b55:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105b5c:	00 
80105b5d:	eb a1                	jmp    80105b00 <sys_pipe+0x50>
80105b5f:	90                   	nop
  int fd;
  struct proc *curproc = myproc();
...
80105b83:	83 ec 08             	sub    $0x8,%esp
  yield(); 
80105b86:	e8 a5 e7 ff ff       	call   80104330 <yield>
  return 0;
}
...
{
  return fork();
80105b94:	e9 e7 e1 ff ff       	jmp    80103d80 <fork>
...
80105ba3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ba6:	e8 35 e6 ff ff       	call   801041e0 <exit>
...
{
  return wait();
80105bb4:	e9 87 e8 ff ff       	jmp    80104440 <wait>
...
80105bde:	e8 6d ea ff ff       	call   80104650 <kill>
...
80105c03:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c06:	e8 d5 df ff ff       	call   80103be0 <myproc>
...
80105c27:	78 27                	js     80105c50 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105c29:	e8 b2 df ff ff       	call   80103be0 <myproc>
  if(growproc(n) < 0)
...
80105c36:	e8 c5 e0 ff ff       	call   80103d00 <growproc>
...
80105c80:	68 60 61 12 80       	push   $0x80126160
80105c85:	e8 26 ed ff ff       	call   801049b0 <acquire>
  ticks0 = ticks;
...
80105c8d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105c90:	8b 1d a0 69 12 80    	mov    0x801269a0,%ebx
  while(ticks - ticks0 < n){
...
80105ca3:	68 60 61 12 80       	push   $0x80126160
80105ca8:	68 a0 69 12 80       	push   $0x801269a0
80105cad:	e8 ce e6 ff ff       	call   80104380 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cb2:	a1 a0 69 12 80       	mov    0x801269a0,%eax
...
80105cd0:	68 60 61 12 80       	push   $0x80126160
...
80105cf3:	68 60 61 12 80       	push   $0x80126160
...
80105d14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d17:	68 60 61 12 80       	push   $0x80126160
80105d1c:	e8 8f ec ff ff       	call   801049b0 <acquire>
  xticks = ticks;
80105d21:	8b 1d a0 69 12 80    	mov    0x801269a0,%ebx
  release(&tickslock);
80105d27:	c7 04 24 60 61 12 80 	movl   $0x80126160,(%esp)
...
80105d3b:	06                   	push   %es
  pushl %fs
80105d3c:	0f a0                	push   %fs
  pushl %gs
80105d3e:	0f a8                	push   %gs
  pushal
80105d40:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105d41:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105d45:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105d47:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105d49:	54                   	push   %esp
  call trap
80105d4a:	e8 e1 00 00 00       	call   80105e30 <trap>
  addl $4, %esp
80105d4f:	83 c4 04             	add    $0x4,%esp
...
80105d52:	61                   	popa   
  popl %gs
80105d53:	0f a9                	pop    %gs
  popl %fs
80105d55:	0f a1                	pop    %fs
  popl %es
80105d57:	07                   	pop    %es
  popl %ds
80105d58:	1f                   	pop    %ds
...
80105d68:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105d6f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105d74:	c6 04 c5 a4 61 12 80 	movb   $0x0,-0x7fed9e5c(,%eax,8)
80105d7b:	00 
80105d7c:	66 89 0c c5 a2 61 12 	mov    %cx,-0x7fed9e5e(,%eax,8)
80105d83:	80 
80105d84:	c6 04 c5 a5 61 12 80 	movb   $0x8e,-0x7fed9e5b(,%eax,8)
80105d8b:	8e 
80105d8c:	66 89 14 c5 a0 61 12 	mov    %dx,-0x7fed9e60(,%eax,8)
80105d93:	80 
80105d94:	c1 ea 10             	shr    $0x10,%edx
80105d97:	66 89 14 c5 a6 61 12 	mov    %dx,-0x7fed9e5a(,%eax,8)
80105d9e:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80105d9f:	83 c0 01             	add    $0x1,%eax
80105da2:	3d 00 01 00 00       	cmp    $0x100,%eax
80105da7:	75 bf                	jne    80105d68 <tvinit+0x8>
...
80105daa:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80105db1:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105db4:	a1 0c b1 10 80       	mov    0x8010b10c,%eax

  initlock(&tickslock, "time");
80105db9:	68 d9 7f 10 80       	push   $0x80107fd9
80105dbe:	68 60 61 12 80       	push   $0x80126160
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105dc3:	66 89 15 a2 63 12 80 	mov    %dx,0x801263a2
80105dca:	c6 05 a4 63 12 80 00 	movb   $0x0,0x801263a4
80105dd1:	66 a3 a0 63 12 80    	mov    %ax,0x801263a0
80105dd7:	c1 e8 10             	shr    $0x10,%eax
80105dda:	c6 05 a5 63 12 80 ef 	movb   $0xef,0x801263a5
80105de1:	66 a3 a6 63 12 80    	mov    %ax,0x801263a6

  initlock(&tickslock, "time");
80105de7:	e8 c4 ea ff ff       	call   801048b0 <initlock>
}
80105dec:	83 c4 10             	add    $0x10,%esp
80105def:	c9                   	leave  
80105df0:	c3                   	ret    
80105df1:	eb 0d                	jmp    80105e00 <idtinit>
80105df3:	90                   	nop
80105df4:	90                   	nop
80105df5:	90                   	nop
80105df6:	90                   	nop
...
80105e0b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105e0f:	b8 a0 61 12 80       	mov    $0x801261a0,%eax
...
80105e39:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(tf->trapno == T_SYSCALL){
80105e3c:	8b 47 30             	mov    0x30(%edi),%eax
80105e3f:	83 f8 40             	cmp    $0x40,%eax
80105e42:	0f 84 88 01 00 00    	je     80105fd0 <trap+0x1a0>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105e4e:	77 10                	ja     80105e60 <trap+0x30>
80105e50:	ff 24 85 80 80 10 80 	jmp    *-0x7fef7f80(,%eax,4)
...
80105e60:	e8 7b dd ff ff       	call   80103be0 <myproc>
80105e65:	85 c0                	test   %eax,%eax
80105e67:	0f 84 d7 01 00 00    	je     80106044 <trap+0x214>
80105e6d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105e71:	0f 84 cd 01 00 00    	je     80106044 <trap+0x214>
...
80105e7a:	8b 57 38             	mov    0x38(%edi),%edx
80105e7d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105e80:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105e83:	e8 38 dd ff ff       	call   80103bc0 <cpuid>
80105e88:	8b 77 34             	mov    0x34(%edi),%esi
80105e8b:	8b 5f 30             	mov    0x30(%edi),%ebx
80105e8e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105e91:	e8 4a dd ff ff       	call   80103be0 <myproc>
80105e96:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105e99:	e8 42 dd ff ff       	call   80103be0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105ea5:	52                   	push   %edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105ea6:	8b 55 e0             	mov    -0x20(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ea9:	ff 75 e4             	pushl  -0x1c(%ebp)
80105eac:	56                   	push   %esi
80105ead:	53                   	push   %ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105eae:	83 c2 6c             	add    $0x6c,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105eb1:	52                   	push   %edx
80105eb2:	ff 70 10             	pushl  0x10(%eax)
80105eb5:	68 3c 80 10 80       	push   $0x8010803c
...
80105ec2:	e8 19 dd ff ff       	call   80103be0 <myproc>
...
80105ed0:	e8 0b dd ff ff       	call   80103be0 <myproc>
80105ed5:	85 c0                	test   %eax,%eax
80105ed7:	74 0c                	je     80105ee5 <trap+0xb5>
80105ed9:	e8 02 dd ff ff       	call   80103be0 <myproc>
80105ede:	8b 50 24             	mov    0x24(%eax),%edx
80105ee1:	85 d2                	test   %edx,%edx
80105ee3:	75 4b                	jne    80105f30 <trap+0x100>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105ee5:	e8 f6 dc ff ff       	call   80103be0 <myproc>
80105eea:	85 c0                	test   %eax,%eax
80105eec:	74 0b                	je     80105ef9 <trap+0xc9>
80105eee:	e8 ed dc ff ff       	call   80103be0 <myproc>
80105ef3:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105ef7:	74 4f                	je     80105f48 <trap+0x118>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ef9:	e8 e2 dc ff ff       	call   80103be0 <myproc>
80105efe:	85 c0                	test   %eax,%eax
80105f00:	74 1d                	je     80105f1f <trap+0xef>
80105f02:	e8 d9 dc ff ff       	call   80103be0 <myproc>
80105f07:	8b 40 24             	mov    0x24(%eax),%eax
80105f0a:	85 c0                	test   %eax,%eax
80105f0c:	74 11                	je     80105f1f <trap+0xef>
80105f0e:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105f12:	83 e0 03             	and    $0x3,%eax
80105f15:	66 83 f8 03          	cmp    $0x3,%ax
80105f19:	0f 84 da 00 00 00    	je     80105ff9 <trap+0x1c9>
    exit();
}
...
80105f29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f30:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105f34:	83 e0 03             	and    $0x3,%eax
80105f37:	66 83 f8 03          	cmp    $0x3,%ax
80105f3b:	75 a8                	jne    80105ee5 <trap+0xb5>
    exit();
80105f3d:	e8 9e e2 ff ff       	call   801041e0 <exit>
80105f42:	eb a1                	jmp    80105ee5 <trap+0xb5>
80105f44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105f48:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80105f4c:	75 ab                	jne    80105ef9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105f4e:	e8 dd e3 ff ff       	call   80104330 <yield>
80105f53:	eb a4                	jmp    80105ef9 <trap+0xc9>
80105f55:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105f58:	e8 63 dc ff ff       	call   80103bc0 <cpuid>
80105f5d:	85 c0                	test   %eax,%eax
80105f5f:	0f 84 ab 00 00 00    	je     80106010 <trap+0x1e0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
...
80105f65:	e8 76 cb ff ff       	call   80102ae0 <lapiceoi>
    break;
80105f6a:	e9 61 ff ff ff       	jmp    80105ed0 <trap+0xa0>
80105f6f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105f70:	e8 2b ca ff ff       	call   801029a0 <kbdintr>
    lapiceoi();
80105f75:	e8 66 cb ff ff       	call   80102ae0 <lapiceoi>
    break;
80105f7a:	e9 51 ff ff ff       	jmp    80105ed0 <trap+0xa0>
80105f7f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105f80:	e8 5b 02 00 00       	call   801061e0 <uartintr>
    lapiceoi();
80105f85:	e8 56 cb ff ff       	call   80102ae0 <lapiceoi>
    break;
80105f8a:	e9 41 ff ff ff       	jmp    80105ed0 <trap+0xa0>
80105f8f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105f90:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105f94:	8b 77 38             	mov    0x38(%edi),%esi
80105f97:	e8 24 dc ff ff       	call   80103bc0 <cpuid>
80105f9c:	56                   	push   %esi
80105f9d:	53                   	push   %ebx
80105f9e:	50                   	push   %eax
80105f9f:	68 e4 7f 10 80       	push   $0x80107fe4
80105fa4:	e8 b7 a6 ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105fa9:	e8 32 cb ff ff       	call   80102ae0 <lapiceoi>
    break;
80105fae:	83 c4 10             	add    $0x10,%esp
80105fb1:	e9 1a ff ff ff       	jmp    80105ed0 <trap+0xa0>
...
80105fb9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105fc0:	e8 5b c4 ff ff       	call   80102420 <ideintr>
80105fc5:	eb 9e                	jmp    80105f65 <trap+0x135>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105fd0:	e8 0b dc ff ff       	call   80103be0 <myproc>
80105fd5:	8b 58 24             	mov    0x24(%eax),%ebx
80105fd8:	85 db                	test   %ebx,%ebx
80105fda:	75 2c                	jne    80106008 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105fdc:	e8 ff db ff ff       	call   80103be0 <myproc>
80105fe1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105fe4:	e8 37 ef ff ff       	call   80104f20 <syscall>
    if(myproc()->killed)
80105fe9:	e8 f2 db ff ff       	call   80103be0 <myproc>
80105fee:	8b 48 24             	mov    0x24(%eax),%ecx
80105ff1:	85 c9                	test   %ecx,%ecx
80105ff3:	0f 84 26 ff ff ff    	je     80105f1f <trap+0xef>
    yield();
...
80105fff:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80106000:	e9 db e1 ff ff       	jmp    801041e0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80106008:	e8 d3 e1 ff ff       	call   801041e0 <exit>
8010600d:	eb cd                	jmp    80105fdc <trap+0x1ac>
8010600f:	90                   	nop
  }
...
80106013:	68 60 61 12 80       	push   $0x80126160
80106018:	e8 93 e9 ff ff       	call   801049b0 <acquire>
      ticks++;
      wakeup(&ticks);
8010601d:	c7 04 24 a0 69 12 80 	movl   $0x801269a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80106024:	83 05 a0 69 12 80 01 	addl   $0x1,0x801269a0
      wakeup(&ticks);
8010602b:	e8 c0 e5 ff ff       	call   801045f0 <wakeup>
      release(&tickslock);
80106030:	c7 04 24 60 61 12 80 	movl   $0x80126160,(%esp)
80106037:	e8 94 ea ff ff       	call   80104ad0 <release>
8010603c:	83 c4 10             	add    $0x10,%esp
8010603f:	e9 21 ff ff ff       	jmp    80105f65 <trap+0x135>
80106044:	0f 20 d6             	mov    %cr2,%esi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106047:	8b 5f 38             	mov    0x38(%edi),%ebx
8010604a:	e8 71 db ff ff       	call   80103bc0 <cpuid>
8010604f:	83 ec 0c             	sub    $0xc,%esp
80106052:	56                   	push   %esi
80106053:	53                   	push   %ebx
80106054:	50                   	push   %eax
80106055:	ff 77 30             	pushl  0x30(%edi)
80106058:	68 08 80 10 80       	push   $0x80108008
8010605d:	e8 fe a5 ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106062:	83 c4 14             	add    $0x14,%esp
80106065:	68 de 7f 10 80       	push   $0x80107fde
8010606a:	e8 01 a3 ff ff       	call   80100370 <panic>
8010606f:	90                   	nop
...
{
  if(!uart)
80106070:	a1 bc b5 10 80       	mov    0x8010b5bc,%eax
  outb(COM1+0, c);
}
...
801060c5:	e8 36 ca ff ff       	call   80102b00 <microdelay>
{
  int i;
...
80106147:	74 5a                	je     801061a3 <uartinit+0xb3>
    return;
  uart = 1;
80106149:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
80106150:	00 00 00 
...
8010615f:	bb 00 81 10 80       	mov    $0x80108100,%ebx
80106164:	6a 00                	push   $0x0
80106166:	6a 04                	push   $0x4
80106168:	e8 03 c5 ff ff       	call   80102670 <ioapicenable>
8010616d:	83 c4 10             	add    $0x10,%esp
80106170:	b8 78 00 00 00       	mov    $0x78,%eax
80106175:	eb 13                	jmp    8010618a <uartinit+0x9a>
...
uartputc(int c)
{
  ...
  if(!uart)
8010618a:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
801061b0:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
    uartputc(*p);
}
...
801061f7:	6a 00                	push   $0x0
  jmp alltraps
801061f9:	e9 3c fb ff ff       	jmp    80105d3a <alltraps>
...
80106200:	6a 01                	push   $0x1
  jmp alltraps
80106202:	e9 33 fb ff ff       	jmp    80105d3a <alltraps>
...
80106209:	6a 02                	push   $0x2
  jmp alltraps
8010620b:	e9 2a fb ff ff       	jmp    80105d3a <alltraps>
...
80106212:	6a 03                	push   $0x3
  jmp alltraps
80106214:	e9 21 fb ff ff       	jmp    80105d3a <alltraps>
...
8010621b:	6a 04                	push   $0x4
  jmp alltraps
8010621d:	e9 18 fb ff ff       	jmp    80105d3a <alltraps>
...
80106224:	6a 05                	push   $0x5
  jmp alltraps
80106226:	e9 0f fb ff ff       	jmp    80105d3a <alltraps>
...
8010622d:	6a 06                	push   $0x6
  jmp alltraps
8010622f:	e9 06 fb ff ff       	jmp    80105d3a <alltraps>
...
80106236:	6a 07                	push   $0x7
  jmp alltraps
80106238:	e9 fd fa ff ff       	jmp    80105d3a <alltraps>
...
8010623d:	6a 08                	push   $0x8
  jmp alltraps
8010623f:	e9 f6 fa ff ff       	jmp    80105d3a <alltraps>
...
80106246:	6a 09                	push   $0x9
  jmp alltraps
80106248:	e9 ed fa ff ff       	jmp    80105d3a <alltraps>
...
8010624d:	6a 0a                	push   $0xa
  jmp alltraps
8010624f:	e9 e6 fa ff ff       	jmp    80105d3a <alltraps>
...
80106254:	6a 0b                	push   $0xb
  jmp alltraps
80106256:	e9 df fa ff ff       	jmp    80105d3a <alltraps>
...
8010625b:	6a 0c                	push   $0xc
  jmp alltraps
8010625d:	e9 d8 fa ff ff       	jmp    80105d3a <alltraps>
...
80106262:	6a 0d                	push   $0xd
  jmp alltraps
80106264:	e9 d1 fa ff ff       	jmp    80105d3a <alltraps>
...
80106269:	6a 0e                	push   $0xe
  jmp alltraps
8010626b:	e9 ca fa ff ff       	jmp    80105d3a <alltraps>
...
80106272:	6a 0f                	push   $0xf
  jmp alltraps
80106274:	e9 c1 fa ff ff       	jmp    80105d3a <alltraps>
...
8010627b:	6a 10                	push   $0x10
  jmp alltraps
8010627d:	e9 b8 fa ff ff       	jmp    80105d3a <alltraps>
...
80106282:	6a 11                	push   $0x11
  jmp alltraps
80106284:	e9 b1 fa ff ff       	jmp    80105d3a <alltraps>
...
8010628b:	6a 12                	push   $0x12
  jmp alltraps
8010628d:	e9 a8 fa ff ff       	jmp    80105d3a <alltraps>
...
80106294:	6a 13                	push   $0x13
  jmp alltraps
80106296:	e9 9f fa ff ff       	jmp    80105d3a <alltraps>
...
8010629d:	6a 14                	push   $0x14
  jmp alltraps
8010629f:	e9 96 fa ff ff       	jmp    80105d3a <alltraps>
...
801062a6:	6a 15                	push   $0x15
  jmp alltraps
801062a8:	e9 8d fa ff ff       	jmp    80105d3a <alltraps>
...
801062af:	6a 16                	push   $0x16
  jmp alltraps
801062b1:	e9 84 fa ff ff       	jmp    80105d3a <alltraps>
...
801062b8:	6a 17                	push   $0x17
  jmp alltraps
801062ba:	e9 7b fa ff ff       	jmp    80105d3a <alltraps>
...
801062c1:	6a 18                	push   $0x18
  jmp alltraps
801062c3:	e9 72 fa ff ff       	jmp    80105d3a <alltraps>
...
801062ca:	6a 19                	push   $0x19
  jmp alltraps
801062cc:	e9 69 fa ff ff       	jmp    80105d3a <alltraps>
...
801062d3:	6a 1a                	push   $0x1a
  jmp alltraps
801062d5:	e9 60 fa ff ff       	jmp    80105d3a <alltraps>
...
801062dc:	6a 1b                	push   $0x1b
  jmp alltraps
801062de:	e9 57 fa ff ff       	jmp    80105d3a <alltraps>
...
801062e5:	6a 1c                	push   $0x1c
  jmp alltraps
801062e7:	e9 4e fa ff ff       	jmp    80105d3a <alltraps>
...
801062ee:	6a 1d                	push   $0x1d
  jmp alltraps
801062f0:	e9 45 fa ff ff       	jmp    80105d3a <alltraps>
...
801062f7:	6a 1e                	push   $0x1e
  jmp alltraps
801062f9:	e9 3c fa ff ff       	jmp    80105d3a <alltraps>
...
80106300:	6a 1f                	push   $0x1f
  jmp alltraps
80106302:	e9 33 fa ff ff       	jmp    80105d3a <alltraps>
...
80106309:	6a 20                	push   $0x20
  jmp alltraps
8010630b:	e9 2a fa ff ff       	jmp    80105d3a <alltraps>
...
80106312:	6a 21                	push   $0x21
  jmp alltraps
80106314:	e9 21 fa ff ff       	jmp    80105d3a <alltraps>
...
8010631b:	6a 22                	push   $0x22
  jmp alltraps
8010631d:	e9 18 fa ff ff       	jmp    80105d3a <alltraps>
...
80106324:	6a 23                	push   $0x23
  jmp alltraps
80106326:	e9 0f fa ff ff       	jmp    80105d3a <alltraps>
...
8010632d:	6a 24                	push   $0x24
  jmp alltraps
8010632f:	e9 06 fa ff ff       	jmp    80105d3a <alltraps>
...
80106336:	6a 25                	push   $0x25
  jmp alltraps
80106338:	e9 fd f9 ff ff       	jmp    80105d3a <alltraps>
...
8010633f:	6a 26                	push   $0x26
  jmp alltraps
80106341:	e9 f4 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106348:	6a 27                	push   $0x27
  jmp alltraps
8010634a:	e9 eb f9 ff ff       	jmp    80105d3a <alltraps>
...
80106351:	6a 28                	push   $0x28
  jmp alltraps
80106353:	e9 e2 f9 ff ff       	jmp    80105d3a <alltraps>
...
8010635a:	6a 29                	push   $0x29
  jmp alltraps
8010635c:	e9 d9 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106363:	6a 2a                	push   $0x2a
  jmp alltraps
80106365:	e9 d0 f9 ff ff       	jmp    80105d3a <alltraps>
...
8010636c:	6a 2b                	push   $0x2b
  jmp alltraps
8010636e:	e9 c7 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106375:	6a 2c                	push   $0x2c
  jmp alltraps
80106377:	e9 be f9 ff ff       	jmp    80105d3a <alltraps>
...
8010637e:	6a 2d                	push   $0x2d
  jmp alltraps
80106380:	e9 b5 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106387:	6a 2e                	push   $0x2e
  jmp alltraps
80106389:	e9 ac f9 ff ff       	jmp    80105d3a <alltraps>
...
80106390:	6a 2f                	push   $0x2f
  jmp alltraps
80106392:	e9 a3 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106399:	6a 30                	push   $0x30
  jmp alltraps
8010639b:	e9 9a f9 ff ff       	jmp    80105d3a <alltraps>
...
801063a2:	6a 31                	push   $0x31
  jmp alltraps
801063a4:	e9 91 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063ab:	6a 32                	push   $0x32
  jmp alltraps
801063ad:	e9 88 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063b4:	6a 33                	push   $0x33
  jmp alltraps
801063b6:	e9 7f f9 ff ff       	jmp    80105d3a <alltraps>
...
801063bd:	6a 34                	push   $0x34
  jmp alltraps
801063bf:	e9 76 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063c6:	6a 35                	push   $0x35
  jmp alltraps
801063c8:	e9 6d f9 ff ff       	jmp    80105d3a <alltraps>
...
801063cf:	6a 36                	push   $0x36
  jmp alltraps
801063d1:	e9 64 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063d8:	6a 37                	push   $0x37
  jmp alltraps
801063da:	e9 5b f9 ff ff       	jmp    80105d3a <alltraps>
...
801063e1:	6a 38                	push   $0x38
  jmp alltraps
801063e3:	e9 52 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063ea:	6a 39                	push   $0x39
  jmp alltraps
801063ec:	e9 49 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063f3:	6a 3a                	push   $0x3a
  jmp alltraps
801063f5:	e9 40 f9 ff ff       	jmp    80105d3a <alltraps>
...
801063fc:	6a 3b                	push   $0x3b
  jmp alltraps
801063fe:	e9 37 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106405:	6a 3c                	push   $0x3c
  jmp alltraps
80106407:	e9 2e f9 ff ff       	jmp    80105d3a <alltraps>
...
8010640e:	6a 3d                	push   $0x3d
  jmp alltraps
80106410:	e9 25 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106417:	6a 3e                	push   $0x3e
  jmp alltraps
80106419:	e9 1c f9 ff ff       	jmp    80105d3a <alltraps>
...
80106420:	6a 3f                	push   $0x3f
  jmp alltraps
80106422:	e9 13 f9 ff ff       	jmp    80105d3a <alltraps>
...
80106429:	6a 40                	push   $0x40
  jmp alltraps
8010642b:	e9 0a f9 ff ff       	jmp    80105d3a <alltraps>
...
80106432:	6a 41                	push   $0x41
  jmp alltraps
80106434:	e9 01 f9 ff ff       	jmp    80105d3a <alltraps>
...
8010643b:	6a 42                	push   $0x42
  jmp alltraps
8010643d:	e9 f8 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106444:	6a 43                	push   $0x43
  jmp alltraps
80106446:	e9 ef f8 ff ff       	jmp    80105d3a <alltraps>
...
8010644d:	6a 44                	push   $0x44
  jmp alltraps
8010644f:	e9 e6 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106456:	6a 45                	push   $0x45
  jmp alltraps
80106458:	e9 dd f8 ff ff       	jmp    80105d3a <alltraps>
...
8010645f:	6a 46                	push   $0x46
  jmp alltraps
80106461:	e9 d4 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106468:	6a 47                	push   $0x47
  jmp alltraps
8010646a:	e9 cb f8 ff ff       	jmp    80105d3a <alltraps>
...
80106471:	6a 48                	push   $0x48
  jmp alltraps
80106473:	e9 c2 f8 ff ff       	jmp    80105d3a <alltraps>
...
8010647a:	6a 49                	push   $0x49
  jmp alltraps
8010647c:	e9 b9 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106483:	6a 4a                	push   $0x4a
  jmp alltraps
80106485:	e9 b0 f8 ff ff       	jmp    80105d3a <alltraps>
...
8010648c:	6a 4b                	push   $0x4b
  jmp alltraps
8010648e:	e9 a7 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106495:	6a 4c                	push   $0x4c
  jmp alltraps
80106497:	e9 9e f8 ff ff       	jmp    80105d3a <alltraps>
...
8010649e:	6a 4d                	push   $0x4d
  jmp alltraps
801064a0:	e9 95 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064a7:	6a 4e                	push   $0x4e
  jmp alltraps
801064a9:	e9 8c f8 ff ff       	jmp    80105d3a <alltraps>
...
801064b0:	6a 4f                	push   $0x4f
  jmp alltraps
801064b2:	e9 83 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064b9:	6a 50                	push   $0x50
  jmp alltraps
801064bb:	e9 7a f8 ff ff       	jmp    80105d3a <alltraps>
...
801064c2:	6a 51                	push   $0x51
  jmp alltraps
801064c4:	e9 71 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064cb:	6a 52                	push   $0x52
  jmp alltraps
801064cd:	e9 68 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064d4:	6a 53                	push   $0x53
  jmp alltraps
801064d6:	e9 5f f8 ff ff       	jmp    80105d3a <alltraps>
...
801064dd:	6a 54                	push   $0x54
  jmp alltraps
801064df:	e9 56 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064e6:	6a 55                	push   $0x55
  jmp alltraps
801064e8:	e9 4d f8 ff ff       	jmp    80105d3a <alltraps>
...
801064ef:	6a 56                	push   $0x56
  jmp alltraps
801064f1:	e9 44 f8 ff ff       	jmp    80105d3a <alltraps>
...
801064f8:	6a 57                	push   $0x57
  jmp alltraps
801064fa:	e9 3b f8 ff ff       	jmp    80105d3a <alltraps>
...
80106501:	6a 58                	push   $0x58
  jmp alltraps
80106503:	e9 32 f8 ff ff       	jmp    80105d3a <alltraps>
...
8010650a:	6a 59                	push   $0x59
  jmp alltraps
8010650c:	e9 29 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106513:	6a 5a                	push   $0x5a
  jmp alltraps
80106515:	e9 20 f8 ff ff       	jmp    80105d3a <alltraps>
...
8010651c:	6a 5b                	push   $0x5b
  jmp alltraps
8010651e:	e9 17 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106525:	6a 5c                	push   $0x5c
  jmp alltraps
80106527:	e9 0e f8 ff ff       	jmp    80105d3a <alltraps>
...
8010652e:	6a 5d                	push   $0x5d
  jmp alltraps
80106530:	e9 05 f8 ff ff       	jmp    80105d3a <alltraps>
...
80106537:	6a 5e                	push   $0x5e
  jmp alltraps
80106539:	e9 fc f7 ff ff       	jmp    80105d3a <alltraps>
...
80106540:	6a 5f                	push   $0x5f
  jmp alltraps
80106542:	e9 f3 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106549:	6a 60                	push   $0x60
  jmp alltraps
8010654b:	e9 ea f7 ff ff       	jmp    80105d3a <alltraps>
...
80106552:	6a 61                	push   $0x61
  jmp alltraps
80106554:	e9 e1 f7 ff ff       	jmp    80105d3a <alltraps>
...
8010655b:	6a 62                	push   $0x62
  jmp alltraps
8010655d:	e9 d8 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106564:	6a 63                	push   $0x63
  jmp alltraps
80106566:	e9 cf f7 ff ff       	jmp    80105d3a <alltraps>
...
8010656d:	6a 64                	push   $0x64
  jmp alltraps
8010656f:	e9 c6 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106576:	6a 65                	push   $0x65
  jmp alltraps
80106578:	e9 bd f7 ff ff       	jmp    80105d3a <alltraps>
...
8010657f:	6a 66                	push   $0x66
  jmp alltraps
80106581:	e9 b4 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106588:	6a 67                	push   $0x67
  jmp alltraps
8010658a:	e9 ab f7 ff ff       	jmp    80105d3a <alltraps>
...
80106591:	6a 68                	push   $0x68
  jmp alltraps
80106593:	e9 a2 f7 ff ff       	jmp    80105d3a <alltraps>
...
8010659a:	6a 69                	push   $0x69
  jmp alltraps
8010659c:	e9 99 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065a3:	6a 6a                	push   $0x6a
  jmp alltraps
801065a5:	e9 90 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065ac:	6a 6b                	push   $0x6b
  jmp alltraps
801065ae:	e9 87 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065b5:	6a 6c                	push   $0x6c
  jmp alltraps
801065b7:	e9 7e f7 ff ff       	jmp    80105d3a <alltraps>
...
801065be:	6a 6d                	push   $0x6d
  jmp alltraps
801065c0:	e9 75 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065c7:	6a 6e                	push   $0x6e
  jmp alltraps
801065c9:	e9 6c f7 ff ff       	jmp    80105d3a <alltraps>
...
801065d0:	6a 6f                	push   $0x6f
  jmp alltraps
801065d2:	e9 63 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065d9:	6a 70                	push   $0x70
  jmp alltraps
801065db:	e9 5a f7 ff ff       	jmp    80105d3a <alltraps>
...
801065e2:	6a 71                	push   $0x71
  jmp alltraps
801065e4:	e9 51 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065eb:	6a 72                	push   $0x72
  jmp alltraps
801065ed:	e9 48 f7 ff ff       	jmp    80105d3a <alltraps>
...
801065f4:	6a 73                	push   $0x73
  jmp alltraps
801065f6:	e9 3f f7 ff ff       	jmp    80105d3a <alltraps>
...
801065fd:	6a 74                	push   $0x74
  jmp alltraps
801065ff:	e9 36 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106606:	6a 75                	push   $0x75
  jmp alltraps
80106608:	e9 2d f7 ff ff       	jmp    80105d3a <alltraps>
...
8010660f:	6a 76                	push   $0x76
  jmp alltraps
80106611:	e9 24 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106618:	6a 77                	push   $0x77
  jmp alltraps
8010661a:	e9 1b f7 ff ff       	jmp    80105d3a <alltraps>
...
80106621:	6a 78                	push   $0x78
  jmp alltraps
80106623:	e9 12 f7 ff ff       	jmp    80105d3a <alltraps>
...
8010662a:	6a 79                	push   $0x79
  jmp alltraps
8010662c:	e9 09 f7 ff ff       	jmp    80105d3a <alltraps>
...
80106633:	6a 7a                	push   $0x7a
  jmp alltraps
80106635:	e9 00 f7 ff ff       	jmp    80105d3a <alltraps>
...
8010663c:	6a 7b                	push   $0x7b
  jmp alltraps
8010663e:	e9 f7 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106645:	6a 7c                	push   $0x7c
  jmp alltraps
80106647:	e9 ee f6 ff ff       	jmp    80105d3a <alltraps>
...
8010664e:	6a 7d                	push   $0x7d
  jmp alltraps
80106650:	e9 e5 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106657:	6a 7e                	push   $0x7e
  jmp alltraps
80106659:	e9 dc f6 ff ff       	jmp    80105d3a <alltraps>
...
80106660:	6a 7f                	push   $0x7f
  jmp alltraps
80106662:	e9 d3 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106669:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010666e:	e9 c7 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106675:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010667a:	e9 bb f6 ff ff       	jmp    80105d3a <alltraps>
...
80106681:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106686:	e9 af f6 ff ff       	jmp    80105d3a <alltraps>
...
8010668d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106692:	e9 a3 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106699:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010669e:	e9 97 f6 ff ff       	jmp    80105d3a <alltraps>
...
801066a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801066aa:	e9 8b f6 ff ff       	jmp    80105d3a <alltraps>
...
801066b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801066b6:	e9 7f f6 ff ff       	jmp    80105d3a <alltraps>
...
801066bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801066c2:	e9 73 f6 ff ff       	jmp    80105d3a <alltraps>
...
801066c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801066ce:	e9 67 f6 ff ff       	jmp    80105d3a <alltraps>
...
801066d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801066da:	e9 5b f6 ff ff       	jmp    80105d3a <alltraps>
...
801066e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801066e6:	e9 4f f6 ff ff       	jmp    80105d3a <alltraps>
...
801066ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801066f2:	e9 43 f6 ff ff       	jmp    80105d3a <alltraps>
...
801066f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801066fe:	e9 37 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106705:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010670a:	e9 2b f6 ff ff       	jmp    80105d3a <alltraps>
...
80106711:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106716:	e9 1f f6 ff ff       	jmp    80105d3a <alltraps>
...
8010671d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106722:	e9 13 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106729:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010672e:	e9 07 f6 ff ff       	jmp    80105d3a <alltraps>
...
80106735:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010673a:	e9 fb f5 ff ff       	jmp    80105d3a <alltraps>
...
80106741:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106746:	e9 ef f5 ff ff       	jmp    80105d3a <alltraps>
...
8010674d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106752:	e9 e3 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106759:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010675e:	e9 d7 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106765:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010676a:	e9 cb f5 ff ff       	jmp    80105d3a <alltraps>
...
80106771:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106776:	e9 bf f5 ff ff       	jmp    80105d3a <alltraps>
...
8010677d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106782:	e9 b3 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106789:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010678e:	e9 a7 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106795:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010679a:	e9 9b f5 ff ff       	jmp    80105d3a <alltraps>
...
801067a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801067a6:	e9 8f f5 ff ff       	jmp    80105d3a <alltraps>
...
801067ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801067b2:	e9 83 f5 ff ff       	jmp    80105d3a <alltraps>
...
801067b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801067be:	e9 77 f5 ff ff       	jmp    80105d3a <alltraps>
...
801067c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801067ca:	e9 6b f5 ff ff       	jmp    80105d3a <alltraps>
...
801067d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801067d6:	e9 5f f5 ff ff       	jmp    80105d3a <alltraps>
...
801067dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801067e2:	e9 53 f5 ff ff       	jmp    80105d3a <alltraps>
...
801067e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801067ee:	e9 47 f5 ff ff       	jmp    80105d3a <alltraps>
...
801067f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801067fa:	e9 3b f5 ff ff       	jmp    80105d3a <alltraps>
...
80106801:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106806:	e9 2f f5 ff ff       	jmp    80105d3a <alltraps>
...
8010680d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106812:	e9 23 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106819:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010681e:	e9 17 f5 ff ff       	jmp    80105d3a <alltraps>
...
80106825:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010682a:	e9 0b f5 ff ff       	jmp    80105d3a <alltraps>
...
80106831:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106836:	e9 ff f4 ff ff       	jmp    80105d3a <alltraps>
...
8010683d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106842:	e9 f3 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106849:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010684e:	e9 e7 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106855:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010685a:	e9 db f4 ff ff       	jmp    80105d3a <alltraps>
...
80106861:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106866:	e9 cf f4 ff ff       	jmp    80105d3a <alltraps>
...
8010686d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106872:	e9 c3 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106879:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010687e:	e9 b7 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106885:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010688a:	e9 ab f4 ff ff       	jmp    80105d3a <alltraps>
...
80106891:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106896:	e9 9f f4 ff ff       	jmp    80105d3a <alltraps>
...
8010689d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801068a2:	e9 93 f4 ff ff       	jmp    80105d3a <alltraps>
...
801068a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801068ae:	e9 87 f4 ff ff       	jmp    80105d3a <alltraps>
...
801068b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801068ba:	e9 7b f4 ff ff       	jmp    80105d3a <alltraps>
...
801068c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801068c6:	e9 6f f4 ff ff       	jmp    80105d3a <alltraps>
...
801068cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801068d2:	e9 63 f4 ff ff       	jmp    80105d3a <alltraps>
...
801068d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801068de:	e9 57 f4 ff ff       	jmp    80105d3a <alltraps>
...
801068e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801068ea:	e9 4b f4 ff ff       	jmp    80105d3a <alltraps>
...
801068f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801068f6:	e9 3f f4 ff ff       	jmp    80105d3a <alltraps>
...
801068fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106902:	e9 33 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106909:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010690e:	e9 27 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106915:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010691a:	e9 1b f4 ff ff       	jmp    80105d3a <alltraps>
...
80106921:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106926:	e9 0f f4 ff ff       	jmp    80105d3a <alltraps>
...
8010692d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106932:	e9 03 f4 ff ff       	jmp    80105d3a <alltraps>
...
80106939:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010693e:	e9 f7 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106945:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010694a:	e9 eb f3 ff ff       	jmp    80105d3a <alltraps>
...
80106951:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106956:	e9 df f3 ff ff       	jmp    80105d3a <alltraps>
...
8010695d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106962:	e9 d3 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106969:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010696e:	e9 c7 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106975:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010697a:	e9 bb f3 ff ff       	jmp    80105d3a <alltraps>
...
80106981:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106986:	e9 af f3 ff ff       	jmp    80105d3a <alltraps>
...
8010698d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106992:	e9 a3 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106999:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010699e:	e9 97 f3 ff ff       	jmp    80105d3a <alltraps>
...
801069a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801069aa:	e9 8b f3 ff ff       	jmp    80105d3a <alltraps>
...
801069b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801069b6:	e9 7f f3 ff ff       	jmp    80105d3a <alltraps>
...
801069bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801069c2:	e9 73 f3 ff ff       	jmp    80105d3a <alltraps>
...
801069c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801069ce:	e9 67 f3 ff ff       	jmp    80105d3a <alltraps>
...
801069d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801069da:	e9 5b f3 ff ff       	jmp    80105d3a <alltraps>
...
801069e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801069e6:	e9 4f f3 ff ff       	jmp    80105d3a <alltraps>
...
801069ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801069f2:	e9 43 f3 ff ff       	jmp    80105d3a <alltraps>
...
801069f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801069fe:	e9 37 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106a05:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106a0a:	e9 2b f3 ff ff       	jmp    80105d3a <alltraps>
...
80106a11:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106a16:	e9 1f f3 ff ff       	jmp    80105d3a <alltraps>
...
80106a1d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106a22:	e9 13 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106a29:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106a2e:	e9 07 f3 ff ff       	jmp    80105d3a <alltraps>
...
80106a35:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106a3a:	e9 fb f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a41:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106a46:	e9 ef f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a4d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106a52:	e9 e3 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a59:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106a5e:	e9 d7 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a65:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a6a:	e9 cb f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a71:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a76:	e9 bf f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a7d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a82:	e9 b3 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a89:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a8e:	e9 a7 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106a95:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a9a:	e9 9b f2 ff ff       	jmp    80105d3a <alltraps>
...
80106aa1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106aa6:	e9 8f f2 ff ff       	jmp    80105d3a <alltraps>
...
80106aad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ab2:	e9 83 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106ab9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106abe:	e9 77 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106ac5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106aca:	e9 6b f2 ff ff       	jmp    80105d3a <alltraps>
...
80106ad1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106ad6:	e9 5f f2 ff ff       	jmp    80105d3a <alltraps>
...
80106add:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106ae2:	e9 53 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106ae9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106aee:	e9 47 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106af5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106afa:	e9 3b f2 ff ff       	jmp    80105d3a <alltraps>
...
80106b01:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106b06:	e9 2f f2 ff ff       	jmp    80105d3a <alltraps>
...
80106b0d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106b12:	e9 23 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106b19:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106b1e:	e9 17 f2 ff ff       	jmp    80105d3a <alltraps>
...
80106b25:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106b2a:	e9 0b f2 ff ff       	jmp    80105d3a <alltraps>
...
80106b31:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106b36:	e9 ff f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b3d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106b42:	e9 f3 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b49:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106b4e:	e9 e7 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b55:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106b5a:	e9 db f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b61:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b66:	e9 cf f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b6d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b72:	e9 c3 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b79:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b7e:	e9 b7 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b85:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b8a:	e9 ab f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b91:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b96:	e9 9f f1 ff ff       	jmp    80105d3a <alltraps>
...
80106b9d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106ba2:	e9 93 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106ba9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106bae:	e9 87 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bb5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106bba:	e9 7b f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bc1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106bc6:	e9 6f f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bcd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106bd2:	e9 63 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bd9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106bde:	e9 57 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106be5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106bea:	e9 4b f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bf1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106bf6:	e9 3f f1 ff ff       	jmp    80105d3a <alltraps>
...
80106bfd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106c02:	e9 33 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106c09:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106c0e:	e9 27 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106c15:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106c1a:	e9 1b f1 ff ff       	jmp    80105d3a <alltraps>
...
80106c21:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106c26:	e9 0f f1 ff ff       	jmp    80105d3a <alltraps>
...
80106c2d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106c32:	e9 03 f1 ff ff       	jmp    80105d3a <alltraps>
...
80106c39:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106c3e:	e9 f7 f0 ff ff       	jmp    80105d3a <alltraps>
...
80106c45:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106c4a:	e9 eb f0 ff ff       	jmp    80105d3a <alltraps>
...
80106c51:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106c56:	e9 df f0 ff ff       	jmp    80105d3a <alltraps>
...
80106c5d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c62:	e9 d3 f0 ff ff       	jmp    80105d3a <alltraps>
...
80106c76:	89 d3                	mov    %edx,%ebx
    ...
    pde = &pgdir[PDX(va)];
80106c78:	c1 ea 16             	shr    $0x16,%edx
...
80106c7e:	83 ec 0c             	sub    $0xc,%esp
    ...
    pde = &pgdir[PDX(va)];
    if (*pde & PTE_P) {
80106c81:	8b 07                	mov    (%edi),%eax
80106c83:	a8 01                	test   $0x1,%al
80106c85:	74 29                	je     80106cb0 <walkpgdir+0x40>
        pgtab = (pte_t *) P2V(PTE_ADDR(*pde));
80106c87:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106c8c:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
...
80106c92:	8d 65 f4             	lea    -0xc(%ebp),%esp
    ...
    return &pgtab[PTX(va)];
80106c95:	c1 eb 0a             	shr    $0xa,%ebx
80106c98:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
80106c9e:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
80106ca1:	5b                   	pop    %ebx
80106ca2:	5e                   	pop    %esi
80106ca3:	5f                   	pop    %edi
...
80106cb4:	e8 a7 bb ff ff       	call   80102860 <kalloc>
80106cb9:	85 c0                	test   %eax,%eax
80106cbb:	89 c6                	mov    %eax,%esi
...
80106cca:	e8 51 de ff ff       	call   80104b20 <memset>
        // The permissions here are overly generous, but they can
        // be further restricted by the permissions in the page table
        // entries, if necessary.
        *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106ccf:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106cd5:	83 c4 10             	add    $0x10,%esp
80106cd8:	83 c8 07             	or     $0x7,%eax
80106cdb:	89 07                	mov    %eax,(%edi)
80106cdd:	eb b3                	jmp    80106c92 <walkpgdir+0x22>
80106cdf:	90                   	nop
    }
    return &pgtab[PTX(va)];
}
...
80106d1e:	eb 15                	jmp    80106d35 <mappages+0x45>
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
...
80106d23:	75 45                	jne    80106d6a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106d25:	0b 75 dc             	or     -0x24(%ebp),%esi
    if(a == last)
80106d28:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106d2b:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106d2d:	74 31                	je     80106d60 <mappages+0x70>
      break;
    a += PGSIZE;
80106d2f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  pte_t *pte;
...
80106d38:	b9 01 00 00 00       	mov    $0x1,%ecx
80106d3d:	89 da                	mov    %ebx,%edx
80106d3f:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106d42:	e8 29 ff ff ff       	call   80106c70 <walkpgdir>
80106d47:	85 c0                	test   %eax,%eax
80106d49:	75 d5                	jne    80106d20 <mappages+0x30>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
80106d4b:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80106d6d:	68 08 81 10 80       	push   $0x80108108
...
80106d8c:	89 c7                	mov    %eax,%edi
  ...
  a = PGROUNDUP(newsz);
80106d8e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
...
80106d9a:	39 d3                	cmp    %edx,%ebx
80106d9c:	73 66                	jae    80106e04 <deallocuvm.part.0+0x84>
80106d9e:	89 d6                	mov    %edx,%esi
80106da0:	eb 3d                	jmp    80106ddf <deallocuvm.part.0+0x5f>
80106da2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106da8:	8b 10                	mov    (%eax),%edx
80106daa:	f6 c2 01             	test   $0x1,%dl
80106dad:	74 26                	je     80106dd5 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106daf:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106db5:	74 58                	je     80106e0f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106db7:	83 ec 0c             	sub    $0xc,%esp
80106dba:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106dc0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dc3:	52                   	push   %edx
80106dc4:	e8 e7 b8 ff ff       	call   801026b0 <kfree>
      *pte = 0;
...
80106dcf:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106dd5:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ddb:	39 f3                	cmp    %esi,%ebx
80106ddd:	73 25                	jae    80106e04 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106ddf:	31 c9                	xor    %ecx,%ecx
80106de1:	89 da                	mov    %ebx,%edx
80106de3:	89 f8                	mov    %edi,%eax
80106de5:	e8 86 fe ff ff       	call   80106c70 <walkpgdir>
    if(!pte)
80106dea:	85 c0                	test   %eax,%eax
80106dec:	75 ba                	jne    80106da8 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106dee:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106df4:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106dfa:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e00:	39 f3                	cmp    %esi,%ebx
80106e02:	72 db                	jb     80106ddf <deallocuvm.part.0+0x5f>
      kfree(v);
      *pte = 0;
    }
  }
...
80106e04:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106e12:	68 ca 7a 10 80       	push   $0x80107aca
...
80106e23:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106e26:	e8 95 cd ff ff       	call   80103bc0 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e2b:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106e31:	31 c9                	xor    %ecx,%ecx
80106e33:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106e38:	66 89 90 f8 37 11 80 	mov    %dx,-0x7feec808(%eax)
80106e3f:	66 89 88 fa 37 11 80 	mov    %cx,-0x7feec806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e46:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106e4b:	31 c9                	xor    %ecx,%ecx
80106e4d:	66 89 90 00 38 11 80 	mov    %dx,-0x7feec800(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e54:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e59:	66 89 88 02 38 11 80 	mov    %cx,-0x7feec7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e60:	31 c9                	xor    %ecx,%ecx
80106e62:	66 89 90 08 38 11 80 	mov    %dx,-0x7feec7f8(%eax)
80106e69:	66 89 88 0a 38 11 80 	mov    %cx,-0x7feec7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106e70:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106e75:	31 c9                	xor    %ecx,%ecx
80106e77:	66 89 90 10 38 11 80 	mov    %dx,-0x7feec7f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106e7e:	c6 80 fc 37 11 80 00 	movb   $0x0,-0x7feec804(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106e85:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106e8a:	c6 80 fd 37 11 80 9a 	movb   $0x9a,-0x7feec803(%eax)
80106e91:	c6 80 fe 37 11 80 cf 	movb   $0xcf,-0x7feec802(%eax)
80106e98:	c6 80 ff 37 11 80 00 	movb   $0x0,-0x7feec801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e9f:	c6 80 04 38 11 80 00 	movb   $0x0,-0x7feec7fc(%eax)
80106ea6:	c6 80 05 38 11 80 92 	movb   $0x92,-0x7feec7fb(%eax)
80106ead:	c6 80 06 38 11 80 cf 	movb   $0xcf,-0x7feec7fa(%eax)
80106eb4:	c6 80 07 38 11 80 00 	movb   $0x0,-0x7feec7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ebb:	c6 80 0c 38 11 80 00 	movb   $0x0,-0x7feec7f4(%eax)
80106ec2:	c6 80 0d 38 11 80 fa 	movb   $0xfa,-0x7feec7f3(%eax)
80106ec9:	c6 80 0e 38 11 80 cf 	movb   $0xcf,-0x7feec7f2(%eax)
80106ed0:	c6 80 0f 38 11 80 00 	movb   $0x0,-0x7feec7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ed7:	66 89 88 12 38 11 80 	mov    %cx,-0x7feec7ee(%eax)
80106ede:	c6 80 14 38 11 80 00 	movb   $0x0,-0x7feec7ec(%eax)
80106ee5:	c6 80 15 38 11 80 f2 	movb   $0xf2,-0x7feec7eb(%eax)
80106eec:	c6 80 16 38 11 80 cf 	movb   $0xcf,-0x7feec7ea(%eax)
80106ef3:	c6 80 17 38 11 80 00 	movb   $0x0,-0x7feec7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80106efa:	05 f0 37 11 80       	add    $0x801137f0,%eax
80106eff:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106f03:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106f07:	c1 e8 10             	shr    $0x10,%eax
80106f0a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106f0e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106f11:	0f 01 10             	lgdtl  (%eax)
}
80106f14:	c9                   	leave  
80106f15:	c3                   	ret    
...
80106f20:	a1 a4 69 12 80       	mov    0x801269a4,%eax
...
80106f4e:	0f 84 cd 00 00 00    	je     80107021 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106f54:	8b 46 08             	mov    0x8(%esi),%eax
80106f57:	85 c0                	test   %eax,%eax
80106f59:	0f 84 dc 00 00 00    	je     8010703b <switchuvm+0xfb>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106f5f:	8b 7e 04             	mov    0x4(%esi),%edi
80106f62:	85 ff                	test   %edi,%edi
80106f64:	0f 84 c4 00 00 00    	je     8010702e <switchuvm+0xee>
    panic("switchuvm: no pgdir");

  pushcli();
80106f6a:	e8 01 da ff ff       	call   80104970 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106f6f:	e8 cc cb ff ff       	call   80103b40 <mycpu>
80106f74:	89 c3                	mov    %eax,%ebx
80106f76:	e8 c5 cb ff ff       	call   80103b40 <mycpu>
80106f7b:	89 c7                	mov    %eax,%edi
80106f7d:	e8 be cb ff ff       	call   80103b40 <mycpu>
80106f82:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106f85:	83 c7 08             	add    $0x8,%edi
80106f88:	e8 b3 cb ff ff       	call   80103b40 <mycpu>
80106f8d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106f90:	83 c0 08             	add    $0x8,%eax
80106f93:	ba 67 00 00 00       	mov    $0x67,%edx
80106f98:	c1 e8 18             	shr    $0x18,%eax
80106f9b:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80106fa2:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106fa9:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80106fb0:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106fb7:	83 c1 08             	add    $0x8,%ecx
80106fba:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106fc0:	c1 e9 10             	shr    $0x10,%ecx
80106fc3:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
...
80106fc9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106fce:	e8 6d cb ff ff       	call   80103b40 <mycpu>
80106fd3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106fda:	e8 61 cb ff ff       	call   80103b40 <mycpu>
80106fdf:	b9 10 00 00 00       	mov    $0x10,%ecx
80106fe4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106fe8:	e8 53 cb ff ff       	call   80103b40 <mycpu>
80106fed:	8b 56 08             	mov    0x8(%esi),%edx
80106ff0:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106ff6:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ff9:	e8 42 cb ff ff       	call   80103b40 <mycpu>
80106ffe:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80107002:	b8 28 00 00 00       	mov    $0x28,%eax
80107007:	0f 00 d8             	ltr    %ax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010700a:	8b 46 04             	mov    0x4(%esi),%eax
8010700d:	05 00 00 00 80       	add    $0x80000000,%eax
80107012:	0f 22 d8             	mov    %eax,%cr3
  ltr(SEG_TSS << 3);
...
8010701b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010701c:	e9 3f da ff ff       	jmp    80104a60 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80107024:	68 0e 81 10 80       	push   $0x8010810e
80107029:	e8 42 93 ff ff       	call   80100370 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010702e:	83 ec 0c             	sub    $0xc,%esp
80107031:	68 39 81 10 80       	push   $0x80108139
80107036:	e8 35 93 ff ff       	call   80100370 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
...
8010703e:	68 24 81 10 80       	push   $0x80108124
80107043:	e8 28 93 ff ff       	call   80100370 <panic>
80107048:	90                   	nop
...
80107059:	8b 75 10             	mov    0x10(%ebp),%esi
8010705c:	8b 45 08             	mov    0x8(%ebp),%eax
8010705f:	8b 7d 0c             	mov    0xc(%ebp),%edi
  char *mem;

  if(sz >= PGSIZE)
80107062:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
80107068:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  char *mem;

  if(sz >= PGSIZE)
8010706b:	77 49                	ja     801070b6 <inituvm+0x66>
    panic("inituvm: more than a page");
  mem = kalloc();
8010706d:	e8 ee b7 ff ff       	call   80102860 <kalloc>
  memset(mem, 0, PGSIZE);
...
80107094:	31 d2                	xor    %edx,%edx
80107096:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107099:	e8 52 fc ff ff       	call   80106cf0 <mappages>
  memmove(mem, init, sz);
8010709e:	89 75 10             	mov    %esi,0x10(%ebp)
801070a1:	89 7d 0c             	mov    %edi,0xc(%ebp)
801070a4:	83 c4 10             	add    $0x10,%esp
801070a7:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
801070b0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801070b1:	e9 1a db ff ff       	jmp    80104bd0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
801070b9:	68 4d 81 10 80       	push   $0x8010814d
801070be:	e8 ad 92 ff ff       	call   80100370 <panic>
801070c3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
801070d9:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
801070e0:	0f 85 91 00 00 00    	jne    80107177 <loaduvm+0xa7>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801070e6:	8b 75 18             	mov    0x18(%ebp),%esi
801070e9:	31 db                	xor    %ebx,%ebx
801070eb:	85 f6                	test   %esi,%esi
801070ed:	75 1a                	jne    80107109 <loaduvm+0x39>
801070ef:	eb 6f                	jmp    80107160 <loaduvm+0x90>
801070f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801070f8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801070fe:	81 ee 00 10 00 00    	sub    $0x1000,%esi
80107104:	39 5d 18             	cmp    %ebx,0x18(%ebp)
80107107:	76 57                	jbe    80107160 <loaduvm+0x90>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107109:	8b 55 0c             	mov    0xc(%ebp),%edx
8010710c:	8b 45 08             	mov    0x8(%ebp),%eax
8010710f:	31 c9                	xor    %ecx,%ecx
80107111:	01 da                	add    %ebx,%edx
80107113:	e8 58 fb ff ff       	call   80106c70 <walkpgdir>
80107118:	85 c0                	test   %eax,%eax
8010711a:	74 4e                	je     8010716a <loaduvm+0x9a>
...
8010711e:	8b 4d 14             	mov    0x14(%ebp),%ecx
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE)
80107121:	bf 00 10 00 00       	mov    $0x1000,%edi
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
80107126:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
8010712b:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80107131:	0f 46 fe             	cmovbe %esi,%edi
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107134:	01 d9                	add    %ebx,%ecx
80107136:	05 00 00 00 80       	add    $0x80000000,%eax
8010713b:	57                   	push   %edi
8010713c:	51                   	push   %ecx
8010713d:	50                   	push   %eax
8010713e:	ff 75 10             	pushl  0x10(%ebp)
80107141:	e8 3a a8 ff ff       	call   80101980 <readi>
80107146:	83 c4 10             	add    $0x10,%esp
80107149:	39 c7                	cmp    %eax,%edi
8010714b:	74 ab                	je     801070f8 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
...
8010716d:	68 67 81 10 80       	push   $0x80108167
...
8010717a:	68 34 82 10 80       	push   $0x80108234
8010717f:	e8 ec 91 ff ff       	call   80100370 <panic>
80107184:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010718a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80107190 <findFreeEntryInSwapFile>:
  }
  return 0;
}
...
80107195:	8b 55 08             	mov    0x8(%ebp),%edx
80107198:	90                   	nop
80107199:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(int i=0; i<MAX_PSYC_PAGES; i++){
    if(!p->swapFileEntries[i])
801071a0:	8b 8c 82 00 04 00 00 	mov    0x400(%edx,%eax,4),%ecx
801071a7:	85 c9                	test   %ecx,%ecx
801071a9:	74 0d                	je     801071b8 <findFreeEntryInSwapFile+0x28>
  return 0;
}
...
findFreeEntryInSwapFile(struct proc *p){
  for(int i=0; i<MAX_PSYC_PAGES; i++){
801071ab:	83 c0 01             	add    $0x1,%eax
801071ae:	83 f8 10             	cmp    $0x10,%eax
801071b1:	75 ed                	jne    801071a0 <findFreeEntryInSwapFile+0x10>
    if(!p->swapFileEntries[i])
      return i;
  }
  return -1;
...
801071c6:	83 ec 1c             	sub    $0x1c,%esp
  ...
  struct proc *p = myproc();
801071c9:	e8 12 ca ff ff       	call   80103be0 <myproc>
  struct page *pg=0, *cg=0;
  pde_t *pgtble;

  if (newsz >= KERNBASE)
801071ce:	8b 5d 10             	mov    0x10(%ebp),%ebx
801071d1:	85 db                	test   %ebx,%ebx
801071d3:	0f 88 c0 02 00 00    	js     80107499 <allocuvm+0x2d9>
801071d9:	89 c6                	mov    %eax,%esi
    return 0;
  if (newsz < oldsz)
801071db:	8b 45 0c             	mov    0xc(%ebp),%eax
801071de:	39 45 10             	cmp    %eax,0x10(%ebp)
801071e1:	0f 82 e4 00 00 00    	jb     801072cb <allocuvm+0x10b>
    return oldsz;

  a = PGROUNDUP(oldsz);
801071e7:	8b 45 0c             	mov    0xc(%ebp),%eax
801071ea:	05 ff 0f 00 00       	add    $0xfff,%eax
801071ef:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  for (; a < newsz; a += PGSIZE) {
801071f4:	39 45 10             	cmp    %eax,0x10(%ebp)
  if (newsz >= KERNBASE)
    return 0;
  if (newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
801071f7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for (; a < newsz; a += PGSIZE) {
801071fa:	0f 86 a3 02 00 00    	jbe    801074a3 <allocuvm+0x2e3>
      // TODO HERE WE CREATE PYSYC MEMORY;
      // TODO HERE WE SHOULD CHECK NUM OF PAGES AND IF NOT MAX PAGES.
      // TODO DEAL WITH MOVING PAGES TO SWAP FILE USING FS FUNCTIONS.

    if(p->pagesCounter == MAX_TOTAL_PAGES)
80107200:	8b 86 44 04 00 00    	mov    0x444(%esi),%eax
80107206:	83 f8 20             	cmp    $0x20,%eax
80107209:	0f 84 45 02 00 00    	je     80107454 <allocuvm+0x294>
...
8010720f:	8d 8e 00 04 00 00    	lea    0x400(%esi),%ecx
  for (; a < newsz; a += PGSIZE) {
      // TODO HERE WE CREATE PYSYC MEMORY;
      // TODO HERE WE SHOULD CHECK NUM OF PAGES AND IF NOT MAX PAGES.
      // TODO DEAL WITH MOVING PAGES TO SWAP FILE USING FS FUNCTIONS.
    ...
    if(p->pagesCounter == MAX_TOTAL_PAGES)
80107215:	31 db                	xor    %ebx,%ebx
80107217:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
      panic("got 32 pages and requested for another page!");
    ...
    if (p->pagesCounter - p->pagesinSwap >= MAX_PSYC_PAGES && p->pid > 2 ) {
      //find the page to swap out - by LIFO
      for (cg = p->pages; cg < &p->pages[MAX_TOTAL_PAGES]; cg++) {
8010721e:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80107221:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    // if number of pages overall minus pages in swap is more than 16 we have prob
    if (p->pagesCounter - p->pagesinSwap >= MAX_PSYC_PAGES && p->pid > 2 ) {
80107228:	2b 86 48 04 00 00    	sub    0x448(%esi),%eax
8010722e:	83 f8 0f             	cmp    $0xf,%eax
80107231:	0f 8e 02 01 00 00    	jle    80107339 <allocuvm+0x179>
80107237:	83 7e 10 02          	cmpl   $0x2,0x10(%esi)
8010723b:	0f 8e f8 00 00 00    	jle    80107339 <allocuvm+0x179>
      //find the page to swap out - by LIFO
      for (cg = p->pages; cg < &p->pages[MAX_TOTAL_PAGES]; cg++) {
80107241:	8b 7d dc             	mov    -0x24(%ebp),%edi
80107244:	8b 55 e0             	mov    -0x20(%ebp),%edx
80107247:	8d 86 80 00 00 00    	lea    0x80(%esi),%eax
8010724d:	8d 76 00             	lea    0x0(%esi),%esi
          if (cg->active && cg->present && cg->sequel > maxSeq) {
80107250:	8b 08                	mov    (%eax),%ecx
80107252:	85 c9                	test   %ecx,%ecx
80107254:	74 1a                	je     80107270 <allocuvm+0xb0>
80107256:	8b 48 0c             	mov    0xc(%eax),%ecx
80107259:	85 c9                	test   %ecx,%ecx
8010725b:	74 13                	je     80107270 <allocuvm+0xb0>
8010725d:	8b 48 08             	mov    0x8(%eax),%ecx
80107260:	39 f9                	cmp    %edi,%ecx
80107262:	7e 0c                	jle    80107270 <allocuvm+0xb0>
80107264:	89 c3                	mov    %eax,%ebx
80107266:	89 cf                	mov    %ecx,%edi
80107268:	90                   	nop
80107269:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if (p->pagesCounter - p->pagesinSwap >= MAX_PSYC_PAGES && p->pid > 2 ) {
      //find the page to swap out - by LIFO
      for (cg = p->pages; cg < &p->pages[MAX_TOTAL_PAGES]; cg++) {
80107270:	83 c0 1c             	add    $0x1c,%eax
80107273:	39 d0                	cmp    %edx,%eax
80107275:	72 d9                	jb     80107250 <allocuvm+0x90>
80107277:	89 7d dc             	mov    %edi,-0x24(%ebp)
8010727a:	31 ff                	xor    %edi,%edi
...
findFreeEntryInSwapFile(struct proc *p){
  for(int i=0; i<MAX_PSYC_PAGES; i++){
    if(!p->swapFileEntries[i])
80107280:	8b 8c be 00 04 00 00 	mov    0x400(%esi,%edi,4),%ecx
80107287:	85 c9                	test   %ecx,%ecx
80107289:	74 4d                	je     801072d8 <allocuvm+0x118>
  return 0;
}
...
findFreeEntryInSwapFile(struct proc *p){
  for(int i=0; i<MAX_PSYC_PAGES; i++){
8010728b:	83 c7 01             	add    $0x1,%edi
8010728e:	83 ff 10             	cmp    $0x10,%edi
80107291:	75 ed                	jne    80107280 <allocuvm+0xc0>
          }
      }
...
80107296:	68 88 82 10 80       	push   $0x80108288
8010729b:	e8 d0 90 ff ff       	call   80100370 <panic>
...
801072a3:	68 85 81 10 80       	push   $0x80108185
...
801072b0:	8b 45 0c             	mov    0xc(%ebp),%eax
801072b3:	39 45 10             	cmp    %eax,0x10(%ebp)
801072b6:	0f 86 dd 01 00 00    	jbe    80107499 <allocuvm+0x2d9>
801072bc:	89 c1                	mov    %eax,%ecx
801072be:	8b 55 10             	mov    0x10(%ebp),%edx
801072c1:	8b 45 08             	mov    0x8(%ebp),%eax
801072c4:	e8 b7 fa ff ff       	call   80106d80 <deallocuvm.part.0>
...
801072db:	68 c9 81 10 80       	push   $0x801081c9
801072e0:	e8 7b 93 ff ff       	call   80100660 <cprintf>
        writeToSwapFile(p ,pg->physAdress, (uint) swapWriteOffset, PGSIZE);
801072e5:	89 fa                	mov    %edi,%edx
801072e7:	68 00 10 00 00       	push   $0x1000
801072ec:	c1 e2 0c             	shl    $0xc,%edx
801072ef:	52                   	push   %edx
801072f0:	ff 73 14             	pushl  0x14(%ebx)
801072f3:	56                   	push   %esi
801072f4:	89 55 d8             	mov    %edx,-0x28(%ebp)
801072f7:	e8 74 af ff ff       	call   80102270 <writeToSwapFile>
      //update page
        cprintf( "FUCK YOU 2!\n");
801072fc:	83 c4 14             	add    $0x14,%esp
801072ff:	68 d5 81 10 80       	push   $0x801081d5
80107304:	e8 57 93 ff ff       	call   80100660 <cprintf>
      pg->present = 0;
      pg->offset = (uint) swapWriteOffset;
80107309:	8b 55 d8             	mov    -0x28(%ebp),%edx
        //write the page to swapFile
        cprintf( "FUCK YOU !\n");
        writeToSwapFile(p ,pg->physAdress, (uint) swapWriteOffset, PGSIZE);
      //update page
        cprintf( "FUCK YOU 2!\n");
      pg->present = 0;
8010730c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
      pg->physAdress = 0;
      pg->sequel = 0;
...
80107313:	83 c4 10             	add    $0x10,%esp
      ...
      pg->offset = (uint) swapWriteOffset;
      pg->physAdress = 0;
80107316:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
      pg->sequel = 0;
8010731d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        cprintf( "FUCK YOU !\n");
        writeToSwapFile(p ,pg->physAdress, (uint) swapWriteOffset, PGSIZE);
      //update page
        cprintf( "FUCK YOU 2!\n");
      pg->present = 0;
      pg->offset = (uint) swapWriteOffset;
80107324:	89 53 10             	mov    %edx,0x10(%ebx)
      pg->physAdress = 0;
      pg->sequel = 0;

      //update proc
      p->swapFileEntries[tmpOffset] = 1; //update that this entry is taken
80107327:	c7 84 be 00 04 00 00 	movl   $0x1,0x400(%esi,%edi,4)
8010732e:	01 00 00 00 
      p->pagesinSwap++;
80107332:	83 86 48 04 00 00 01 	addl   $0x1,0x448(%esi)
    ...
    mem = kalloc();
80107339:	e8 22 b5 ff ff       	call   80102860 <kalloc>
    if (mem == 0) {
8010733e:	85 c0                	test   %eax,%eax
    ...
    mem = kalloc();
80107340:	89 c7                	mov    %eax,%edi
    if (mem == 0) {
80107342:	0f 84 58 ff ff ff    	je     801072a0 <allocuvm+0xe0>
      cprintf("allocuvm out of memory\n");
      deallocuvm(pgdir, newsz, oldsz);
      return 0;
    }
...
8010734b:	68 00 10 00 00       	push   $0x1000
80107350:	6a 00                	push   $0x0
80107352:	50                   	push   %eax
80107353:	e8 c8 d7 ff ff       	call   80104b20 <memset>
    if (mappages(pgdir, (char *) a, PGSIZE, V2P(mem), PTE_W | PTE_U) < 0) {
80107358:	58                   	pop    %eax
80107359:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
8010735f:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107364:	5a                   	pop    %edx
80107365:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107368:	6a 06                	push   $0x6
8010736a:	50                   	push   %eax
8010736b:	8b 45 08             	mov    0x8(%ebp),%eax
8010736e:	e8 7d f9 ff ff       	call   80106cf0 <mappages>
80107373:	83 c4 10             	add    $0x10,%esp
80107376:	85 c0                	test   %eax,%eax
80107378:	0f 88 ea 00 00 00    	js     80107468 <allocuvm+0x2a8>
    ...
    if(p->pid > 2) {
8010737e:	83 7e 10 02          	cmpl   $0x2,0x10(%esi)
80107382:	0f 8e ae 00 00 00    	jle    80107436 <allocuvm+0x276>
      //TODO INIT PAGE STRUCT
      for (pg = p->pages; pg < &p->pages[MAX_TOTAL_PAGES]; pg++) {
        if (!pg->active)
80107388:	8b 8e 80 00 00 00    	mov    0x80(%esi),%ecx
      kfree(mem);
      return 0;
    }
    if(p->pid > 2) {
      //TODO INIT PAGE STRUCT
      for (pg = p->pages; pg < &p->pages[MAX_TOTAL_PAGES]; pg++) {
8010738e:	8d 9e 80 00 00 00    	lea    0x80(%esi),%ebx
80107394:	8b 45 e0             	mov    -0x20(%ebp),%eax
        if (!pg->active)
80107397:	85 c9                	test   %ecx,%ecx
80107399:	74 16                	je     801073b1 <allocuvm+0x1f1>
8010739b:	90                   	nop
8010739c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p->pid > 2) {
      //TODO INIT PAGE STRUCT
      for (pg = p->pages; pg < &p->pages[MAX_TOTAL_PAGES]; pg++) {
801073a0:	83 c3 1c             	add    $0x1c,%ebx
801073a3:	39 c3                	cmp    %eax,%ebx
801073a5:	0f 83 03 01 00 00    	jae    801074ae <allocuvm+0x2ee>
        if (!pg->active)
801073ab:	8b 13                	mov    (%ebx),%edx
801073ad:	85 d2                	test   %edx,%edx
801073af:	75 ef                	jne    801073a0 <allocuvm+0x1e0>
      }
      ...
      panic("no page in proc");
        ...
        foundpage:
      p->pagesCounter++;
801073b1:	83 86 44 04 00 00 01 	addl   $0x1,0x444(%esi)
      pg->active = 1;
801073b8:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
...
801073c1:	8b 86 40 04 00 00    	mov    0x440(%esi),%eax
801073c7:	8d 50 01             	lea    0x1(%eax),%edx
801073ca:	89 96 40 04 00 00    	mov    %edx,0x440(%esi)
801073d0:	89 43 04             	mov    %eax,0x4(%ebx)
      pg->present = 1;
801073d3:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
      pg->offset = 0;
801073da:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
      pg->sequel = p->pagesequel++;
801073e1:	8b 86 4c 04 00 00    	mov    0x44c(%esi),%eax
801073e7:	8d 50 01             	lea    0x1(%eax),%edx
801073ea:	89 96 4c 04 00 00    	mov    %edx,0x44c(%esi)
      pg->physAdress = mem;
801073f0:	89 7b 14             	mov    %edi,0x14(%ebx)
      pg->virtAdress = (char *)a;
801073f3:	8b 7d e4             	mov    -0x1c(%ebp),%edi
      p->pagesCounter++;
      pg->active = 1;
      pg->pageid = p->nextpageid++;
      pg->present = 1;
      pg->offset = 0;
      pg->sequel = p->pagesequel++;
801073f6:	89 43 08             	mov    %eax,0x8(%ebx)
      pg->physAdress = mem;
      pg->virtAdress = (char *)a;
801073f9:	89 7b 18             	mov    %edi,0x18(%ebx)


        cprintf( "FUCK YOU !\n");
801073fc:	68 c9 81 10 80       	push   $0x801081c9
80107401:	e8 5a 92 ff ff       	call   80100660 <cprintf>
      pgtble = walkpgdir(pgdir, (char *)a, 0);
80107406:	8b 45 08             	mov    0x8(%ebp),%eax
80107409:	89 fa                	mov    %edi,%edx
8010740b:	31 c9                	xor    %ecx,%ecx
8010740d:	e8 5e f8 ff ff       	call   80106c70 <walkpgdir>
80107412:	89 c7                	mov    %eax,%edi
        cprintf( "FUCK YOU 2!\n");
80107414:	c7 04 24 d5 81 10 80 	movl   $0x801081d5,(%esp)
8010741b:	e8 40 92 ff ff       	call   80100660 <cprintf>
      *pgtble = PTE_P_1(pgtble);  // Present
      *pgtble = PTE_PG_0(pgtble); // Not Paged out to secondary storage
80107420:	89 f8                	mov    %edi,%eax
80107422:	80 e4 fd             	and    $0xfd,%ah
80107425:	89 07                	mov    %eax,(%edi)
        cprintf( "FUCK YOU !\n");
80107427:	c7 04 24 c9 81 10 80 	movl   $0x801081c9,(%esp)
8010742e:	e8 2d 92 ff ff       	call   80100660 <cprintf>
80107433:	83 c4 10             	add    $0x10,%esp
  ...
  a = PGROUNDUP(oldsz);
  for (; a < newsz; a += PGSIZE) {
80107436:	81 45 e4 00 10 00 00 	addl   $0x1000,-0x1c(%ebp)
8010743d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107440:	39 45 10             	cmp    %eax,0x10(%ebp)
80107443:	76 5e                	jbe    801074a3 <allocuvm+0x2e3>
      // TODO HERE WE CREATE PYSYC MEMORY;
      // TODO HERE WE SHOULD CHECK NUM OF PAGES AND IF NOT MAX PAGES.
      // TODO DEAL WITH MOVING PAGES TO SWAP FILE USING FS FUNCTIONS.

    if(p->pagesCounter == MAX_TOTAL_PAGES)
80107445:	8b 86 44 04 00 00    	mov    0x444(%esi),%eax
8010744b:	83 f8 20             	cmp    $0x20,%eax
8010744e:	0f 85 d4 fd ff ff    	jne    80107228 <allocuvm+0x68>
      panic("got 32 pages and requested for another page!");
80107454:	83 ec 0c             	sub    $0xc,%esp
80107457:	68 58 82 10 80       	push   $0x80108258
...
8010746b:	68 9d 81 10 80       	push   $0x8010819d
80107470:	e8 eb 91 ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80107478:	8b 45 0c             	mov    0xc(%ebp),%eax
8010747b:	39 45 10             	cmp    %eax,0x10(%ebp)
8010747e:	76 0d                	jbe    8010748d <allocuvm+0x2cd>
80107480:	89 c1                	mov    %eax,%ecx
80107482:	8b 55 10             	mov    0x10(%ebp),%edx
80107485:	8b 45 08             	mov    0x8(%ebp),%eax
80107488:	e8 f3 f8 ff ff       	call   80106d80 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if (mappages(pgdir, (char *) a, PGSIZE, V2P(mem), PTE_W | PTE_U) < 0) {
      cprintf("allocuvm out of memory (2)\n");
...
80107490:	57                   	push   %edi
80107491:	e8 1a b2 ff ff       	call   801026b0 <kfree>
      return 0;
...
801074a2:	c3                   	ret    
  ...
  a = PGROUNDUP(oldsz);
  for (; a < newsz; a += PGSIZE) {
801074a3:	8b 45 10             	mov    0x10(%ebp),%eax
        cprintf( "FUCK YOU !\n");
    }
...
801074b1:	68 b9 81 10 80       	push   $0x801081b9
801074b6:	e8 b5 8e ff ff       	call   80100370 <panic>
801074bb:	90                   	nop
...
801074d0:	5d                   	pop    %ebp
801074d1:	e9 aa f8 ff ff       	jmp    80106d80 <deallocuvm.part.0>
...
80107509:	e8 72 f8 ff ff       	call   80106d80 <deallocuvm.part.0>
...
8010753e:	e8 6d b1 ff ff       	call   801026b0 <kfree>
...
80107553:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80107554:	e9 57 b1 ff ff       	jmp    801026b0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
8010755c:	68 e2 81 10 80       	push   $0x801081e2
...
80107575:	e8 e6 b2 ff ff       	call   80102860 <kalloc>
...
80107590:	e8 8b d5 ff ff       	call   80104b20 <memset>
...
801075ab:	e8 40 f7 ff ff       	call   80106cf0 <mappages>
...
801075fb:	a3 a4 69 12 80       	mov    %eax,0x801269a4
...
8010761e:	e8 4d f6 ff ff       	call   80106c70 <walkpgdir>
  if(pte == 0)
...
8010762f:	68 f3 81 10 80       	push   $0x801081f3
...
80107653:	0f 84 b2 00 00 00    	je     8010770b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107680:	e8 4b d5 ff ff       	call   80104bd0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80107685:	58                   	pop    %eax
80107686:	5a                   	pop    %edx
80107687:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
8010768d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107690:	ff 75 e4             	pushl  -0x1c(%ebp)
80107693:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107698:	52                   	push   %edx
80107699:	89 f2                	mov    %esi,%edx
8010769b:	e8 50 f6 ff ff       	call   80106cf0 <mappages>
801076a0:	83 c4 10             	add    $0x10,%esp
801076a3:	85 c0                	test   %eax,%eax
801076a5:	78 3e                	js     801076e5 <copyuvm+0xa5>
  uint pa, i, flags;
  char *mem;
...
801076b7:	89 f2                	mov    %esi,%edx
801076b9:	e8 b2 f5 ff ff       	call   80106c70 <walkpgdir>
801076be:	85 c0                	test   %eax,%eax
801076c0:	74 5a                	je     8010771c <copyuvm+0xdc>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801076c2:	8b 18                	mov    (%eax),%ebx
801076c4:	f6 c3 01             	test   $0x1,%bl
801076c7:	74 46                	je     8010770f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801076c9:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
801076cb:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
801076d1:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801076d4:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
801076da:	e8 81 b1 ff ff       	call   80102860 <kalloc>
801076df:	85 c0                	test   %eax,%eax
801076e1:	89 c3                	mov    %eax,%ebx
801076e3:	75 8b                	jne    80107670 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
801076e8:	ff 75 e0             	pushl  -0x20(%ebp)
801076eb:	e8 00 fe ff ff       	call   801074f0 <freevm>
  return 0;
...
8010770d:	eb e6                	jmp    801076f5 <copyuvm+0xb5>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80107712:	68 17 82 10 80       	push   $0x80108217
80107717:	e8 54 8c ff ff       	call   80100370 <panic>
...
8010771f:	68 fd 81 10 80       	push   $0x801081fd
...
8010773e:	e8 2d f5 ff ff       	call   80106c70 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801077af:	e8 1c d4 ff ff       	call   80104bd0 <memmove>
    len -= n;
    buf += n;
